...
|-----------|-------------|-----------|----------|-------|
| `model` | O modelo HappyHorse a ser usado para a geração de vídeos. | DYNAMIC_COMBO | Sim | `"happyhorse-1.1-i2v"`<br>`"happyhorse-1.0-i2v"` |
...
| `watermark` | Indica se deve adicionar uma marca d'água gerada por IA ao resultado. (opção avançada; padrão: False) | BOOLEAN | Sim | True / False |
