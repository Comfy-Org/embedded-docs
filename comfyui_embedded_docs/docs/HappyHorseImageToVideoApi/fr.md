...
Ce nœud génère une courte vidéo à partir d'une image de départ unique en utilisant le modèle HappyHorse. Vous fournissez une première image et une description textuelle du mouvement et de la scène souhaités, et le nœud crée une vidéo qui se poursuit à partir de cette image.
...
| `first_frame` | IMAGE | Oui | N/A | Image de la première image. Le rapport hauteur/largeur de sortie est dérivé de cette image. |
