...
| پارامتر | توضیحات | نوع داده |
| --- | --- | --- |
| `خروجی` | 'output' نتیجه اصلی فرآیند نمونه‌گیری را نشان می‌دهد و شامل نمونه‌های تولید شده است. | `LATENT` |
| `خروجی بدون نویز` | 'denoised_output' نمونه‌ها را پس از اعمال فرآیند نویززدایی نشان می‌دهد که به طور بالقوه وضوح و کیفیت نمونه‌های تولید شده را افزایش می‌دهد. | `LATENT` |
