...
| Parâmetro | Tipo de Dados | Descrição |
|-----------|-------------|-------------|
| `latent`  | `LATENT`    | A representação latente resultante após a composição da origem sobre o destino, potencialmente utilizando uma máscara para mesclagem seletiva. |