...
|-----------|--------------|-------------|-------|-------------|
| `input_*` | Varía | Sí | Cualquiera | Un número variable de ranuras de entrada. Puedes agregar más entradas haciendo clic en el icono de suma (+). Todas las entradas deben ser del mismo tipo de datos (por ejemplo, todas IMAGE o todas STRING). |
...
|------------------|--------------|-------------|
| `list` | Varía | Una única lista que contiene todos los elementos de las entradas conectadas, concatenados en el orden en que fueron proporcionados. El tipo de dato de salida coincide con el tipo de dato de entrada. |
