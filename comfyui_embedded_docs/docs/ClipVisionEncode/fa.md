...
| ----------- | ------------ | ------------------------------------------------------------ |
| `clip_vision` | CLIP_VISION  | مدل CLIP Vision که معمولاً از طریق گره CLIPVisionLoader بارگذاری می‌شود |
| `image`       | IMAGE        | تصویر ورودی که باید رمزگذاری شود                             |
| `crop`        | Dropdown     | روش برش تصویر، گزینه‌ها: center (برش مرکزی)، none (بدون برش) |

## خروجی‌ها

| نام خروجی            | نوع داده            | توضیحات                |
| -------------------- | ------------------- | ----------------------- |
| CLIP_VISION_OUTPUT   | CLIP_VISION_OUTPUT  | ویژگی‌های بصری رمزگذاری‌شده |
