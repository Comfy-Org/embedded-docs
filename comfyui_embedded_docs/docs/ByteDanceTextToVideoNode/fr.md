...
|-----------|-----------------|--------|-------|-------------|
| `model` | STRING | Oui | `"seedance-1-5-pro-251215"`<br>`"seedance-1-0-pro-250528"`<br>`"seedance-1-0-lite-t2v-250428"`<br>`"seedance-1-0-pro-fast-251015"` | Le modèle ByteDance à utiliser pour la génération (par défaut : `"seedance-1-0-pro-fast-251015"`). |
...
| `aspect_ratio` | STRING | Oui | `"16:9"`<br>`"4:3"`<br>`"1:1"`<br>`"3:4"`<br>`"9:16"`<br>`"21:9"` | Le rapport hauteur/largeur de la vidéo de sortie. |
