...
| `weight_dtype` | 모델 가중치의 숫자 정밀도(데이터 타입)입니다. "default"는 모델의 원래 정밀도를 사용하고, "fp16"은 16비트 부동소수점, "bf16"은 bfloat16, "fp32"는 32비트 부동소수점을 사용합니다. (기본값: "default") | STRING | 아니요 | `"default"`<br>`"fp16"`<br>`"bf16"`<br>`"fp32"` |
