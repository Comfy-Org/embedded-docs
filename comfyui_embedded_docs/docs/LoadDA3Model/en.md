...
| `weight_dtype` | The numerical precision (data type) for the model weights. The “default” option uses the model’s original precision. (default: “default”) | STRING | No | `"default"`<br>`"fp16"`<br>`"bf16"`<br>`"fp32"` |
