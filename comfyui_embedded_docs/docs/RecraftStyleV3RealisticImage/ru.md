...
|-----------|-----------|----------|-------|-------------|
| `substyle` | STRING | Да | Доступно несколько опций | Конкретный подстиль, применяемый к стилю `realistic_image`. Если установлено значение "None", подстиль применяться не будет. |
