...
| `clip_görü_çıktısı` | CLIP_VISION_OUTPUT | Evet | - | Görsel bağlam sağlayan bir CLIP görüş modelinden gelen görsel yerleştirmeler |
| `istem` | STRING | Evet | - | Video oluşturmayı yönlendiren metin açıklaması; çok satırlı giriş ve dinamik istemleri destekler |
| `görüntü_serpiştirme` | INT | Evet | 1-512 | Görselin metin istemine kıyasla sonuçları ne kadar etkilediği. Daha yüksek değer, metin isteminin daha fazla etkisi olduğu anlamına gelir. (varsayılan: 2) |
