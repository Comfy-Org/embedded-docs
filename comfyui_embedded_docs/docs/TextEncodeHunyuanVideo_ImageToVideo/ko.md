...
| `prompt` | STRING | 예 | - | 비디오 생성을 안내하는 텍스트 설명, 다중 줄 입력 및 동적 프롬프트 지원 |
| `image_interleave` | INT | 예 | 1-512 | 이미지가 텍스트 프롬프트 대비 얼마나 영향을 미치는지 설정합니다. 숫자가 높을수록 텍스트 프롬프트의 영향이 더 커집니다. (기본값: 2) |
