...
| `clip_vision_output` | CLIP_VISION_OUTPUT | بله | - | جاسازی‌های بصری حاصل از مدل CLIP vision که زمینه تصویری را فراهم می‌کند |
| `prompt` | STRING | بله | - | توضیحات متنی برای هدایت تولید ویدئو، از ورودی چندخطی و پرامپت‌های پویا پشتیبانی می‌کند |
| `image_interleave` | INT | بله | 1-512 | میزان تأثیر تصویر در مقابل پرامپت متنی. عدد بالاتر به معنای تأثیر بیشتر پرامپت متنی است. (پیش‌فرض: 2) |
