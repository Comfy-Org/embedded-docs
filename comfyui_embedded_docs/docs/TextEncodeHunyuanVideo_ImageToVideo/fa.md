...
| `خروجی بینایی clip` | CLIP_VISION_OUTPUT | بله | - | جاسازی‌های بصری حاصل از مدل CLIP vision که زمینه تصویری را فراهم می‌کند |
| `پرامپت` | STRING | بله | - | توضیحات متنی برای هدایت تولید ویدئو، از ورودی چندخطی و پرامپت‌های پویا پشتیبانی می‌کند |
| `درهم‌تنیدگی تصویر` | INT | بله | 1-512 | میزان تأثیر تصویر در مقابل پرامپت متنی. عدد بالاتر به معنای تأثیر بیشتر پرامپت متنی است. (پیش‌فرض: 2) |

## خروجی‌ها

| نام خروجی | نوع داده | توضیحات |
|-----------|----------|---------|
| `CONDITIONING` | CONDITIONING | داده‌های شرطی‌سازی که اطلاعات متن و تصویر را برای تولید ویدئو ترکیب می‌کند |
