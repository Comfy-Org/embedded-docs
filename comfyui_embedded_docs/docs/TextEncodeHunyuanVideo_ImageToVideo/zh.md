...
| `clip_vision_output` | CLIP_VISION_OUTPUT | 是 | - | 来自 CLIP 视觉模型的视觉嵌入，提供图像上下文 |
| `prompt` | STRING | 是 | - | 用于指导视频生成的文本描述，支持多行输入和动态提示 |
| `image_interleave` | INT | 是 | 1-512 | 图像相对于文本提示的影响程度。数值越大，文本提示的影响越大。（默认值：2） |
