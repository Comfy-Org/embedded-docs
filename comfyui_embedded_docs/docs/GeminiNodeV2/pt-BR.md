...
|-----------|-------------|-----------|----------|-------|
| `model` | O modelo Gemini usado para gerar a resposta. | DYNAMIC_COMBO | Sim | `"Gemini 3.8 Flash"`<br>`"Gemini 3.7 Flash"`<br>`"Gemini 3.5 Flash"`<br>`"Gemini 3.1 Pro"`<br>`"Gemini 3.1 Flash-Lite"` |
...
| `system_prompt` | Instruções fundamentais que ditam o comportamento do modelo. (padrão: "") | STRING | Não |  |
