...
|-----------|-----------|----------|--------|----------|
| `latentler` | LATENT | Evet | Yok | Çözünürlüğe göre gruplanacak gizli sözlüklerin listesi. |
| `koşullandırma` | CONDITIONING | Evet | Yok | Koşullandırma listelerinin listesi (`latentler` uzunluğuyla eşleşmelidir). |
...
|-----------|-----------|----------|
| `latentler` | LATENT | Çözünürlük grubu başına bir tane olmak üzere gruplanmış gizli sözlüklerin listesi. |
| `koşullandırma` | CONDITIONING | Çözünürlük grubu başına bir tane olmak üzere koşullandırma listelerinin listesi. |
