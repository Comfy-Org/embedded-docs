...
|-----------|-----------|----------|-------|-------------|
| `latentes` | LATENT | Sim | N/A | Lista de dicionários latentes para agrupar por resolução. |
| `condicionamento` | CONDITIONING | Sim | N/A | Lista de listas de condicionamento (deve corresponder ao comprimento dos latentes). |
...
|-------------|-----------|-------------|
| `latentes` | LATENT | Lista de dicionários latentes em lote, um por grupo de resolução. |
| `condicionamento` | CONDITIONING | Lista de listas de condicionamento, uma por grupo de resolução. |
