...
| --- | --- | --- |
| `latents` | لیستی از دیکشنری‌های نهفته دسته‌بندی‌شده، یکی برای هر سطل وضوح (resolution bucket). | LATENT |
| `conditioning` | لیستی از لیست‌های شرطی‌سازی، یکی برای هر سطل وضوح. | CONDITIONING |
