...
|---------|----------|-------|--------|---------|
| `فضاهای نهفته` | LATENT | بله | N/A | لیستی از دیکشنری‌های نهفته (latent dicts) برای دسته‌بندی بر اساس وضوح. |
| `شرایط‌دهی` | CONDITIONING | بله | N/A | لیستی از لیست‌های شرطی‌سازی (باید با طول `فضاهای نهفته` مطابقت داشته باشد). |
...
|-----------|----------|---------|
| `فضاهای نهفته` | LATENT | لیستی از دیکشنری‌های نهفته دسته‌بندی‌شده، یکی برای هر سطل وضوح (resolution bucket). |
| `شرایط‌دهی` | CONDITIONING | لیستی از لیست‌های شرطی‌سازی، یکی برای هر سطل وضوح. |
