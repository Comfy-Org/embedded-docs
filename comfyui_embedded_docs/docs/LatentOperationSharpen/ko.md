...
|-----------|-----------|----------|-------|-------------|
| `sharpen_radius` | INT | 아니요 | 1-31 | 선명화 커널의 반경입니다 (기본값: 9) |
| `sigma` | FLOAT | 아니요 | 0.1-10.0 | 가우시안 커널의 표준 편차입니다 (기본값: 1.0) |
| `alpha` | FLOAT | 아니요 | 0.0-5.0 | 선명화 강도 계수입니다 (기본값: 0.1) |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `operation` | LATENT_OPERATION | 잠재 데이터에 적용할 수 있는 선명화 연산을 반환합니다 |
