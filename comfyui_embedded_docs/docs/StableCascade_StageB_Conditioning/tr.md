...
|-----------|-----------|----------|-------|-------------|
| `conditioning` | CONDITIONING | Evet | - | Stage C önceki bilgileri ile değiştirilecek koşullandırma verisi |
| `stage_c` | LATENT | Evet | - | Koşullandırma için önceki örnekleri içeren Stage C'den gelen gizli temsil |
