...
| --- | --- | --- | --- | --- |
| `شرط‌گذاری` | داده‌های conditioning که باید با اطلاعات پیشین Stage C اصلاح شوند. هر ورودی در فهرست کپی شده و نمونه‌های Stage C به آن داده می‌شود. | CONDITIONING | بله | - |
