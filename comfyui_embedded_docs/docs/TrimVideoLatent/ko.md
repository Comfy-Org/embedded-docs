...
|-----------|-----------|----------|-------|-------------|
| `samples` | LATENT | 예 | - | 자를 프레임이 포함된 입력 잠재 비디오 표현입니다 |
| `trim_amount` | INT | 예 | 0 ~ 99999 | 비디오 시작 부분에서 제거할 프레임 수입니다 (기본값: 0) |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `output` | LATENT | 지정된 수의 프레임이 시작 부분에서 제거된, 잘린 잠재 비디오 표현입니다 |
