...
|-----------|-----------------|--------|-------|-------------|
| `samples` | LATENT | Oui | - | La représentation vidéo latente d'entrée contenant les images vidéo à rogner |
| `trim_amount` | INT | Oui | 0 à 99999 | Le nombre d'images à supprimer du début de la vidéo (par défaut : 0) |
