...
|-----------|------------|-------------|
| `CONDITIONING` | CONDITIONING | La structure de données de conditionnement à modifier. Ce nœud met à zéro les éléments 'pooled_output' dans chaque entrée de conditionnement, le cas échéant. |

## Sorties

| Paramètre | Type Comfy | Description |
|-----------|------------|-------------|
| `CONDITIONING` | CONDITIONING | La structure de données de conditionnement modifiée, avec les éléments 'pooled_output' mis à zéro lorsque applicable. |