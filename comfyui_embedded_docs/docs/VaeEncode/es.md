...
|-----------|-------------|-------------|
| `píxeles`  | `IMAGE`     | El parámetro 'pixels' representa los datos de la imagen que se codificarán en el espacio latente. Desempeña un papel crucial en la determinación de la representación latente de salida al servir como entrada directa para el proceso de codificación. |
