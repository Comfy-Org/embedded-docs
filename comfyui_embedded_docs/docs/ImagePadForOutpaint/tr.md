...
|-----------|-------------|-------------|
| `image`   | `IMAGE`     | 'image' girdisi, dışa boyama için hazırlanacak ana görüntüdür ve dolgu işlemleri için temel oluşturur. |
...
| `feathering` | `INT` | Orijinal görüntü ile eklenen dolgu arasındaki geçişin yumuşaklığını kontrol eder ve dışa boyama için görsel entegrasyonu geliştirir. |

## Çıktılar

| Parametre | Veri Tipi | Açıklama |
|-----------|-------------|-------------|
| `image`   | `IMAGE`     | Çıktı 'image', dışa boyama süreci için hazır olan dolgulu görüntüyü temsil eder. |
