...
| --- | --- | --- | --- | --- |
| `aspect_ratio` | The aspect ratio for the output dimensions (default: `"1:1 (Square)"`). | COMBO | Yes | `"1:1 (Square)"`<br>`"3:2 (Photo)"`<br>`"4:3 (Standard)"`<br>`"16:9 (Widescreen)"`<br>`"21:9 (Ultrawide)"`<br>`"2:3 (Portrait Photo)"`<br>`"3:4 (Portrait Standard)"`<br>`"9:16 (Portrait Widescreen)"` |
