...
|-----------|-----------|----------|-------|-------------|
| `종횡비` | COMBO | 예 | `"SQUARE"`<br>`"PORTRAIT_2_3"`<br>`"PORTRAIT_3_4"`<br>`"PORTRAIT_9_16"`<br>`"LANDSCAPE_3_2"`<br>`"LANDSCAPE_4_3"`<br>`"LANDSCAPE_16_9"` | 출력 크기의 종횡비입니다 (기본값: `"SQUARE"`). |
| `메가픽셀` | FLOAT | 예 | 0.1 - 16.0 | 목표 총 메가픽셀 수입니다. 정사각형 종횡비에서 1.0 MP는 약 1024×1024에 해당합니다 (기본값: 1.0). |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `높이` | INT | 계산된 픽셀 너비로, 8의 배수입니다. |
