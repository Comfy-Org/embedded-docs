...
| 参数 | 数据类型 | 是否必填 | 范围 | 描述 |
|-----------|-----------|----------|-------|-------------|
| `aspect_ratio` | COMBO | 是 | `"SQUARE"`<br>`"PORTRAIT_2_3"`<br>`"PORTRAIT_3_4"`<br>`"PORTRAIT_9_16"`<br>`"LANDSCAPE_3_2"`<br>`"LANDSCAPE_4_3"`<br>`"LANDSCAPE_16_9"` | 输出尺寸的宽高比（默认值：`"SQUARE"`）。 |
| `megapixels` | FLOAT | 是 | 0.1 - 16.0 | 目标总百万像素数。对于正方形宽高比，1.0 MP ≈ 1024×1024（默认值：1.0）。 |
