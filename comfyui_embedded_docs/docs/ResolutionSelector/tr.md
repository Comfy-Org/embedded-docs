...
| `megapiksel` | Hedef toplam megapiksel. Kare için 1.0 MP ≈ 1024x1024 (varsayılan: 1.0). | FLOAT | Evet | 0.1 - 16.0 (adım: 0.1) |
...
| `kat` | Seçilen çözünürlüğün ayarlanacağı en yakın kat (varsayılan: 8). | INT | Hayır | 8 - 128 (adım: 4) |
