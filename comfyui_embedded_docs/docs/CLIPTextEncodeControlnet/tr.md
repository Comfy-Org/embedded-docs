...
| `conditioning` | CONDITIONING | Gerekli | - | - | Controlnet parametreleriyle geliştirilecek mevcut koşullandırma verisi |
| `text` | STRING | Çok Satırlı, Dinamik İstemler | - | - | CLIP modeli tarafından işlenecek metin girdisi |
