...
| `conditioning` | CONDITIONING | Requerido | - | - | Datos de condicionamiento existentes que se mejorarán con parámetros de controlnet |
| `text` | STRING | Multilínea, Prompts Dinámicos | - | - | Texto de entrada que será procesado por el modelo CLIP |
