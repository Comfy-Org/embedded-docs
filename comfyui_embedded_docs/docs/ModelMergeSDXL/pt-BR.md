...
| `time_embed.` | Peso de mistura para camadas de embedding de tempo (padrão: 1.0) | FLOAT | Sim | 0.0 - 1.0 |
| `label_emb.` | Peso de mistura para camadas de embedding de rótulo (padrão: 1.0) | FLOAT | Sim | 0.0 - 1.0 |
...
| `out.` | Peso de mistura para camadas de saída (padrão: 1.0) | FLOAT | Sim | 0.0 - 1.0 |
