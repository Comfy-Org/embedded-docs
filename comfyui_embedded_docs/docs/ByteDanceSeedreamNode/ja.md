...
| パラメータ | 説明 | データ型 | 必須 | 範囲 |
| --- | --- | --- | --- | --- |
| `model` | 生成に使用するSeedreamモデル。利用可能なモデルには、seedream-4-0、seedream-4-5、seedream-5-0の各バリアントが含まれます。 | STRING | はい | "seedream 5.0 pro"<br>"seedream 5.0 lite"<br>"seedream-4-5-251128"<br>"seedream-4-0-250828" |
