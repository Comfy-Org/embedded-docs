...
| `lyrics` | Müziği üretmek için kullanılacak şarkı sözü metni. Çok satırlı metin ve dinamik istemleri destekler. | STRING | Evet | - |
| `seed` | Üretim süreci için yeniden üretilebilir rastgele tohum. Varsayılan: 0. Üretim sonrası kontrol widget'ı sağlanır. | INT | Evet | 0 ile 18446744073709551615 (0xffffffffffffffff) arası |
