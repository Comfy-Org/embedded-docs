...
**Nota:** Os pontos de rastreamento são desenhados com um conjunto limitado de cores que se repetem, e um ponto é ignorado em um quadro quando seu indicador de visibilidade é zero nesse quadro.

## Saídas

| Nome da Saída | Descrição | Tipo de Dados |
|-------------|-------------|-----------|
| `IMAGE` | A sequência de imagens com os dados de rastreamento de movimento visualizados como sobreposições. Se nenhum `tracks` foi fornecido, as imagens de entrada originais são retornadas. | IMAGE |
