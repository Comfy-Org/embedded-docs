...
|-----------|-----------|----------|-------|-------------|
| `مدل` | MODEL | بله | - | مدل UNet که با فاکتورهای مقیاس‌دهی توجه اصلاح می‌شود |
...
| `خروجی` | FLOAT | خیر | 0.0 - 10.0 | فاکتور مقیاس‌دهی برای مؤلفه‌های خروجی در توجه متقاطع (پیش‌فرض: 1.0) |

## خروجی‌ها

| نام خروجی | نوع داده | توضیحات |
|-------------|-----------|-------------|
| `مدل` | MODEL | مدل UNet اصلاح‌شده با مؤلفه‌های توجه متقاطع مقیاس‌دهی‌شده |
