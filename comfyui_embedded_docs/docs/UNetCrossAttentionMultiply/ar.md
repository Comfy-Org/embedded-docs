...
| `الناتج` | FLOAT | لا | 0.0 - 10.0 | عامل تغيير المقياس لمكونات المخرجات في الانتباه المتقاطع (القيمة الافتراضية: 1.0) |

## المخرجات

| اسم المخرج | نوع البيانات | الوصف |
|-------------|---------------|---------|
| `النموذج` | MODEL | نموذج UNet المعدل بمكونات انتباه متقاطع ذات مقياس مُغيّر |
