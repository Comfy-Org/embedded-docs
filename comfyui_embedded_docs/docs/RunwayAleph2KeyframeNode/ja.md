...
| パラメータ | 説明 | データ型 | 必須 | 範囲 |
|-----------|-------------|-----------|----------|-------|
| `image` | 入力動画の選択した瞬間に適用するガイダンス画像です。 | IMAGE | はい | - |
| `timing` | この画像を入力動画のタイムライン上に配置する方法です。 | COMBO | はい | 下記参照 |
| `keyframes` | このキーフレームとチェーン接続する、オプションの先行キーフレームです。 | KEYFRAME | いいえ | - |
...
| 出力名 | 説明 | データ型 |
|-------------|-------------|-----------|
| `keyframes` | このキーフレームと、以前に接続されたキーフレームを含むキーフレームのチェーンです。 | KEYFRAME |
