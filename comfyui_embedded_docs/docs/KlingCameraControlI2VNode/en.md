...
| `prompt` | STRING | Yes | - | Positive text prompt describing the desired video content |
| `negative_prompt` | STRING | Yes | - | Negative text prompt describing what to avoid in the generated video |
