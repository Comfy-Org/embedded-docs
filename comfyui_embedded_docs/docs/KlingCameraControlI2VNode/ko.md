...
| `cfg_scale` | FLOAT | 아니오 | 0.0-1.0 | 텍스트 지침의 강도를 제어합니다 (기본값: 0.75) |
| `aspect_ratio` | COMBO | 아니오 | 여러 옵션 사용 가능 | 동영상 화면비 선택 (기본값: 16:9) |
| `camera_control` | CAMERA_CONTROL | 예 | - | Kling Camera Controls 노드를 사용하여 생성할 수 있습니다. 동영상 생성 중 카메라 이동과 모션을 제어합니다. |
