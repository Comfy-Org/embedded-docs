# Fusionner les maillages

MergeMeshes combine plusieurs entrées de maillage en un seul maillage en empilant leurs sommets, faces, coordonnées UV et couleurs de sommets, et en décalant les indices de faces afin que toutes les parties s'assemblent correctement en un seul maillage continu.
