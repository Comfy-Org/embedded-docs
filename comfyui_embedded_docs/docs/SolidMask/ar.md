...
|-----------|-------------|-------------|
| `value`   | FLOAT       | يحدد قيمة الكثافة للقناع، مما يؤثر على مظهره العام وفائدته في العمليات اللاحقة. |
| `width`   | INT         | يحدد عرض القناع المُنشأ، مما يؤثر بشكل مباشر على حجمه ونسبة أبعاده. |
| `height`  | INT         | يضبط ارتفاع القناع المُنشأ، مما يؤثر على حجمه ونسبة أبعاده. |
