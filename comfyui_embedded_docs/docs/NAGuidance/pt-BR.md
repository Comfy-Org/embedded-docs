...
|-----------|--------------|-------------|-------|-----------|
| `model` | MODEL | Sim | - | O modelo ao qual aplicar a Orientação de Atenção Normalizada. |
| `nag_scale` | FLOAT | Sim | 0.0 - 50.0 | O fator de escala da orientação. Valores mais altos afastam ainda mais a geração do prompt negativo. (padrão: 5.0) |
...
|---------------|--------------|-----------|
| `model` | MODEL | O modelo modificado com a Orientação de Atenção Normalizada ativada. |
