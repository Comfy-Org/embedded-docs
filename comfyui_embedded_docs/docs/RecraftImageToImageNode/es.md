...
| `intensidad` | FLOAT | Sí | 0.0-1.0 | Define la diferencia con la imagen original; debe estar en [0, 1], donde 0 significa casi idéntica y 1 significa similitud mínima (valor predeterminado: 0.5) |
| `semilla` | INT | Sí | 0-18446744073709551615 | Semilla para determinar si el nodo debe reejecutarse; los resultados reales son no deterministas independientemente de la semilla (valor predeterminado: 0) |
...
|------------------|--------------|-------------|
| `imagen` | IMAGE | La(s) imagen(es) generada(s) basada(s) en la imagen de entrada y la instrucción |
