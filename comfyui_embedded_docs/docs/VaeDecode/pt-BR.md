...
|-----------|-------------|-------------|
| `amostras` | `LATENT`    | O parâmetro 'samples' representa as representações latentes a serem decodificadas em imagens. É crucial para o processo de decodificação, pois fornece os dados comprimidos a partir dos quais as imagens são reconstruídas. |
