...
|-----------|-------------|-------------|
| `samples` | `LATENT` | پارامتر 'samples' نشان‌دهنده بازنمایی‌های نهفته‌ای است که باید به تصاویر رمزگشایی شوند. این پارامتر برای فرآیند رمزگشایی حیاتی است زیرا داده‌های فشرده‌ای را فراهم می‌کند که تصاویر از آن بازسازی می‌شوند. |
