...
| `resolution` | COMBO | Да | Доступно несколько вариантов | Выходное разрешение для сгенерированного видео (по умолчанию: 540p) |
| `duration` | COMBO | Да | Доступно несколько вариантов | Длительность сгенерированного видео |
| `loop` | BOOLEAN | Да | - | Должно ли сгенерированное видео зацикливаться (по умолчанию: False) |
