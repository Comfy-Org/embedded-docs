...
| --- | --- | --- |
| `condicionamiento` | Las embeddings de condicionamiento precomputadas para el modelo Lotus, que contienen embeddings de prompt fijas y un diccionario vacío. | CONDITIONING |
