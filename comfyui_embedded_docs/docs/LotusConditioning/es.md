...
|------------------|--------------|-------------|
| `conditioning` | CONDITIONING | Los embeddings de condicionamiento precalculados para el modelo Lotus, que contienen embeddings de prompt fijos y un diccionario vacío. |
