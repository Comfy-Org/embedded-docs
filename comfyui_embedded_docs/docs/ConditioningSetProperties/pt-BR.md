...
|-----------|--------------|-----------------|--------|-------|-----------|
| `cond_NOVO` | CONDITIONING | Obrigatório | - | - | Os dados de condicionamento a serem modificados |
| `força` | FLOAT | Obrigatório | 1.0 | 0.0 - 10.0 (passo: 0.01) | Controla a intensidade do efeito de condicionamento |
| `definir_área_cond` | STRING | Obrigatório | default | ["default", "mask bounds"] | Determina como a área de condicionamento é aplicada. Escolha "default" para comportamento padrão ou "mask bounds" para restringir à região da máscara |
| `mask` | MASK | Opcional | - | - | Máscara opcional para restringir onde o condicionamento é aplicado |
| `ganchos` | HOOKS | Opcional | - | - | Funções de gancho opcionais para processamento personalizado |
| `etapas_de_tempo` | TIMESTEPS_RANGE | Opcional | - | - | Intervalo de timestep opcional para limitar quando o condicionamento está ativo |
