...
|-----------|--------------|-------------|-------|-------------|
| `audio` | AUDIO | Sí | Todos los archivos de audio y video compatibles en el directorio de entrada | El archivo de audio a cargar desde el directorio de entrada |
...
|------------------|--------------|-------------|
| `AUDIO` | AUDIO | Datos de audio que contienen información de forma de onda y frecuencia de muestreo |
