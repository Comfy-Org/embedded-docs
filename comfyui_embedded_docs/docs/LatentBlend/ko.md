...
|-----------|-----------|----------|-------|-------------|
| `samples1` | LATENT | 예 | - | 혼합할 첫 번째 잠재 샘플 |
| `samples2` | LATENT | 예 | - | 혼합할 두 번째 잠재 샘플 |
| `blend_factor` | FLOAT | 예 | 0 ~ 1 | 두 샘플 간의 혼합 비율을 제어합니다 (기본값: 0.5) |
...
| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `latent` | LATENT | 두 입력 샘플이 결합된 혼합 잠재 샘플 |
