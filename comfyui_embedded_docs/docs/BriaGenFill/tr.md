...
| `seed` | Üretim süreci için tohum. (varsayılan: 42) | INT | Evet | 1 ile 2147483647 arası |
...
Not: `prompt` boş olmamalıdır ve `mask`, `image` ile aynı en-boy oranına sahip olmalıdır. Maske %50 opaklıkta ikili hale getirilir; bu nedenle yarı opaklıktan daha az boyanmış alanlar yok sayılır. İkili hale getirme sonrasında maske hiçbir beyaz alan içermiyorsa düğüm bir hata verir.
...
- `visual_output_moderation` (varsayılan: false): Çıkış görüntüsüne içerik moderasyonu uygular.

## Çıktılar

| Çıktı Adı | Açıklama | Veri Türü |
|-------------|-------------|-----------|
| `image` | Maskeli bölgesi oluşturulan içerikle doldurulmuş sonuç görüntüsü. | IMAGE |
