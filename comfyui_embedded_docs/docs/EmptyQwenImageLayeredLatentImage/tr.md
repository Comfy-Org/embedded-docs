...
|-----------|-----------|----------|-------|-------------|
| `width` | INT | Evet | 16 ile MAX_RESOLUTION arası | Oluşturulacak gizli görüntünün genişliği. Değer 16'ya bölünebilir olmalıdır. (varsayılan: 640) |
| `height` | INT | Evet | 16 ile MAX_RESOLUTION arası | Oluşturulacak gizli görüntünün yüksekliği. Değer 16'ya bölünebilir olmalıdır. (varsayılan: 640) |
| `layers` | INT | Evet | 0 ile MAX_RESOLUTION arası | Gizli yapıya eklenecek ek katman sayısı. Bu, gizli temsilin derinliğini tanımlar. (varsayılan: 3) |
