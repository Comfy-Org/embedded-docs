...
| `recraft_style` | STYLEV3 | Não | - | Seleção opcional de estilo para o fundo gerado. Se não for fornecido, o padrão é o estilo "realistic_image" |
| `prompt_negativo` | STRING | Não | - | Uma descrição textual opcional de elementos indesejados na imagem (padrão: vazio) |
