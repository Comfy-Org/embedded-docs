...
| `prompt` | STRING | Oui | - | Inspiration pour la génération d'image (par défaut : vide) |
...
| `negative_prompt` | STRING | Non | - | Une description textuelle optionnelle des éléments indésirables sur une image (par défaut : vide) |
