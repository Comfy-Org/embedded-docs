...
|-----------|-----------|----------|-------|-------------|
| `inputs` | IMAGE, MASK o LATENT | Sí | 1 a 50 entradas | Una lista dinámica de entradas que se combinarán en un lote. Puedes agregar entre 1 y 50 elementos. Todos los elementos deben ser del mismo tipo (todas imágenes, todas máscaras o todos latentes). |
...
|-------------|-----------|-------------|
| `output` | IMAGE, MASK o LATENT | Una única salida agrupada en lote. El tipo de dato coincide con el tipo de entrada (IMAGE agrupada, MASK agrupada o LATENT agrupado). |
