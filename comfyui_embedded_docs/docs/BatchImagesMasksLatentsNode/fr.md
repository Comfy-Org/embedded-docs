...
|-----------|-----------------|--------|-------|-------------|
| `inputs` | IMAGE, MASK ou LATENT | Oui | 1 à 50 entrées | Une liste dynamique d'entrées à combiner en un lot. Vous pouvez ajouter entre 1 et 50 éléments. Tous les éléments doivent être du même type (toutes des images, tous des masques ou toutes des représentations latentes). |
...
|------------------|-----------------|-------------|
| `output` | IMAGE, MASK ou LATENT | Une seule sortie groupée. Le type de données correspond au type d'entrée (IMAGE groupée, MASK groupé ou LATENT groupé). |
