...
|-----------|-----------------|--------|-------|-------------|
| `latents` | LATENT | Oui | 2 à 50 entrées | Un ensemble d'échantillons latents à combiner en un seul lot. Vous devez fournir au moins deux latents, et vous pouvez en ajouter jusqu'à 50. Le nœud crée automatiquement des emplacements d'entrée à mesure que vous connectez davantage de latents. |
