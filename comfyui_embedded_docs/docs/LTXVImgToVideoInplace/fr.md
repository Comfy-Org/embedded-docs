...
|---------------|-----------------|-------------|
| `latent` | LATENT | La représentation latente vidéo modifiée. Elle contient les échantillons mis à jour et un `noise_mask` qui applique la force de conditionnement aux trames initiales. |
