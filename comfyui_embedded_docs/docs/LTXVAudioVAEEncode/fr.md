...
|---------------|-------------|-----------------|
| `Audio Latent` | La représentation latente compressée de l'audio d'entrée. La sortie inclut les échantillons latents, la fréquence d'échantillonnage du modèle VAE et un identifiant de type. | LATENT |
