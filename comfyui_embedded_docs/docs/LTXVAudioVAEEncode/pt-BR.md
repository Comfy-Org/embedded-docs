...
O nó LTXV Audio VAE Encode recebe uma entrada de áudio e a compacta em uma representação latente menor, usando um modelo Audio VAE específico. Esse processo é essencial para gerar ou manipular áudio em um fluxo de trabalho de espaço latente, pois converte dados brutos de áudio em um formato que outros nós do pipeline podem compreender e processar.
