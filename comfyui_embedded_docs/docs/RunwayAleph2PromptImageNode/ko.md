...
| `position` | 출력 비디오 타임라인에 이 이미지를 배치하는 방법입니다. 절대 시간(시작부터 초 단위) 또는 분수 시간(비디오 길이 대비 비율) 중에서 선택합니다. 옵션을 선택하면 해당 하위 매개변수가 표시됩니다. | COMBO | 예 | `Absolute (seconds)`<br>`Fraction (0.0 to 1.0)` |
