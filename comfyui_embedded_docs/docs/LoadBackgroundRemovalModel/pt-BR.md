...
Carrega um modelo de remoção de fundo a partir de um arquivo. Este nó prepara o modelo para que possa ser usado por outros nós para remover fundos de imagens.
