...
| --- | --- | --- | --- | --- |
| `nome_remoção_fundo` | O modelo usado para remover fundos de imagens. Selecione na lista de arquivos de modelo de remoção de fundo disponíveis. | STRING | Sim | Lista de arquivos de modelo disponíveis |
