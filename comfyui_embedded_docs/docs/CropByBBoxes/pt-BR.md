...
|-----------|--------------|-------------|-----------|-----------|
| `image` | IMAGE | Sim | - | O lote de imagens de entrada a ser recortado. |
| `bboxes` | BOUNDINGBOX | Sim | - | A lista de caixas delimitadoras que definem as regiões a serem recortadas. Esta entrada é forçada, ou seja, deve estar conectada. |
