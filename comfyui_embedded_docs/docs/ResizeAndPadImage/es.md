...
|-----------|---------------|-------------|-------|-------------|
| `imagen` | IMAGE | Sí | - | La imagen de entrada que se redimensionará y rellenará |
| `ancho_objetivo` | INT | Sí | 1 a MAX_RESOLUTION | El ancho deseado de la imagen de salida (predeterminado: 512) |
| `alto_objetivo` | INT | Sí | 1 a MAX_RESOLUTION | La altura deseada de la imagen de salida (predeterminado: 512) |
| `color_relleno` | COMBO | Sí | "white"<br>"black" | El color que se usará para las áreas de relleno alrededor de la imagen redimensionada (predeterminado: "white") |
| `interpolación` | COMBO | Sí | "area"<br>"bicubic"<br>"nearest-exact"<br>"bilinear"<br>"lanczos" | El método de interpolación utilizado para redimensionar la imagen (predeterminado: "area") |

## Salidas

| Nombre de Salida | Tipo de Dato | Descripción |
|------------------|---------------|-------------|
| `imagen` | IMAGE | La imagen de salida redimensionada y rellenada |
