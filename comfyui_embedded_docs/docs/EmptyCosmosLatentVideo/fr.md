...
| `longueur` | INT | Oui | 1 à MAX_RESOLUTION | Le nombre d'images dans la vidéo latente (par défaut : 121, doit être divisible par 8) |
...
|---------------|-----------------|-------------|
| `samples` | LATENT | Le tenseur vidéo latent vide généré avec des valeurs nulles |
