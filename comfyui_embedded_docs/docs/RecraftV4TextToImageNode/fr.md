...
Génère des images à partir de prompts textuels à l’aide des modèles Recraft V4 et V4.1. Il envoie le prompt et les paramètres sélectionnés à l’API Recraft et renvoie l’image ou les images générées. Si des images de référence de style sont utilisées, l’ID de style créé est également renvoyé.
