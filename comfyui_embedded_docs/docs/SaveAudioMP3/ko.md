...
| `filename_prefix` | STRING | 아니요 | - | 출력 파일 이름의 접두사 (기본값: "audio/ComfyUI") |
| `quality` | STRING | 아니요 | "V0"<br>"128k"<br>"320k" | MP3 파일의 오디오 품질 설정 (기본값: "V0") |
| `prompt` | PROMPT | 아니요 | - | 내부 프롬프트 데이터 (시스템에서 자동 제공) |
| `extra_pnginfo` | EXTRA_PNGINFO | 아니요 | - | 추가 PNG 정보 (시스템에서 자동 제공) |
