...
| `start_percent` | O ponto inicial do intervalo de substituição como uma porcentagem do processo de amostragem (padrão: 0.0) | FLOAT | Sim | 0.0 a 1.0 |
| `end_percent` | O ponto final do intervalo de substituição como uma porcentagem do processo de amostragem (padrão: 1.0) | FLOAT | Sim | 0.0 a 1.0 |
