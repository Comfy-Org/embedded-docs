...
|-----------|--------------|-------------|-------|-------------|
| `folder` | STRING | Sí | *Múltiples opciones disponibles* | La carpeta desde la cual cargar imágenes. Las opciones son las subcarpetas presentes en el directorio de entrada principal de ComfyUI. |
