...
| 出力名 | 説明 | データ型 |
| --- | --- | --- |
| `positive` | 画像が提供された場合に時間次元の連結が行われた、修正済みポジティブ条件付け | CONDITIONING |
| `negative_text` | 画像が提供された場合に時間次元の連結が行われた、修正済みネガティブ条件付け | CONDITIONING |
| `negative_img_text` | 画像が提供された場合に時間次元の連結がゼロに設定された、ネガティブ条件付け | CONDITIONING |
