...
|-----------|-----------------|--------|-------|-------------|
| `positif` | CONDITIONING | Oui | - | Entrée de conditionnement positive pour guider la génération vidéo |
| `négatif` | CONDITIONING | Oui | - | Entrée de conditionnement négative pour éviter certaines caractéristiques |
...
| `longueur` | INT | Oui | 1 à MAX_RESOLUTION | Nombre d’images dans la vidéo générée (par défaut : 81, doit être divisible par 4) |
...
|---------------|-----------------|-------------|
| `texte_négatif` | CONDITIONING | Conditionnement positif modifié avec concaténation temporelle lorsque des images sont fournies |
| `texte_img_négative` | CONDITIONING | Conditionnement négatif modifié avec concaténation temporelle lorsque des images sont fournies |
| `latent` | CONDITIONING | Conditionnement négatif avec concaténation temporelle mise à zéro lorsque des images sont fournies |
