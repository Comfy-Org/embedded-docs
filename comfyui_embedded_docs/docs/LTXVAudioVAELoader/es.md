...
|-----------|--------------|-------------|-------|-------------|
| `ckpt_name` | STRING | Sí | Todos los archivos en la carpeta `checkpoints`.<br>*Ejemplo: `"audio_vae.safetensors"`* | Punto de control de VAE de audio a cargar. Esta es una lista desplegable que se completa con todos los archivos encontrados en tu directorio `checkpoints` de ComfyUI. |

## Salidas

| Nombre de Salida | Tipo de Dato | Descripción |
|------------------|--------------|-------------|
| `Audio VAE` | VAE | El modelo de Autoencoder Variacional de audio cargado, listo para conectarse a otros nodos de procesamiento de audio. |
