...
|-----------|-----------|----------|-------|-------------|
| `ckpt_name` | STRING | نعم | جميع الملفات في مجلد `checkpoints`.<br>*مثال: `"audio_vae.safetensors"`* | نقطة تفتيش مشفر الصوت المتغير التلقائي المراد تحميلها. هذه قائمة منسدلة تحتوي على جميع الملفات الموجودة في دليل `checkpoints` الخاص بـ ComfyUI. |

## المخرجات

| اسم المخرج | نوع البيانات | الوصف |
|-------------|-----------|-------------|
| مشفر الصوت المتغير التلقائي (Audio VAE) | VAE | نموذج المشفر الصوتي المتغير التلقائي المُحمّل، الجاهز للاتصال بعُقد معالجة الصوت الأخرى. |
