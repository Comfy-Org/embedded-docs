...
| `créativité` | FLOAT | Oui | 0.2-0.5 | Contrôle la probabilité de créer des détails supplémentaires qui ne sont pas fortement conditionnés par l'image initiale. (par défaut : 0.35) |
