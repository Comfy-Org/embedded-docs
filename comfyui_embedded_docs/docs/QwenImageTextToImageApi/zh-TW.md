...
| `width` | 總像素面積必須介於 512x512 與 2560x2560 之間；長寬比必須介於 1:8 至 8:1 之間。（預設：1024） | INT | 否 | 256 至 2560 (步長 16) |
| `height` | 總像素面積必須介於 512x512 與 2560x2560 之間；長寬比必須介於 1:8 至 8:1 之間。（預設：1024） | INT | 否 | 256 至 2560 (步長 16) |
