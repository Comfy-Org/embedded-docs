...
|-----------|--------------|-------------|-------|-----------|
| `source` | ANY | Sim | Qualquer tipo de dado | Aceita qualquer tipo de dado de entrada para exibição de prévia |

## Saídas

| Nome da Saída | Tipo de Dado | Descrição |
|---------------|--------------|-----------|
| `Exibição de Texto na Interface` | STRING | Exibe os dados de entrada convertidos em formato de texto na interface do usuário. Também retorna o texto como uma saída de string para processamento adicional. |
