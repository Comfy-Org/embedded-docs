...
O nó ImageOnlyCheckpointSave salva um arquivo de checkpoint contendo um modelo, um codificador de visão CLIP e uma VAE. Ele cria um arquivo safetensors com o prefixo de nome de arquivo especificado e o armazena no diretório de saída. Este nó é projetado especificamente para salvar componentes de modelo relacionados a imagens juntos em um único arquivo de checkpoint.
...
| `extra_pnginfo` | Parâmetro oculto para metadados adicionais de PNG | EXTRA_PNGINFO | Não | - |
