...
گره ImageOnlyCheckpointSave یک فایل checkpoint شامل یک مدل، رمزگذار بینایی CLIP و VAE ذخیره می‌کند. این گره یک فایل safetensors با پیشوند نام فایل مشخص‌شده ایجاد کرده و آن را در دایرکتوری خروجی ذخیره می‌کند. این گره به‌طور خاص برای ذخیره‌سازی اجزای مدل مرتبط با تصویر در یک فایل checkpoint واحد طراحی شده است.
...
| `extra_pnginfo` | فراداده‌های اضافی PNG | EXTRA_PNGINFO | خیر | - |
