...
|-----------|-----------|----------|-------|-------------|
| `model` | MODEL | Sí | - | El modelo que se guardará en el checkpoint |
...
| `filename_prefix` | STRING | Sí | - | El prefijo para el nombre del archivo de salida (predeterminado: "checkpoints/ComfyUI") |
