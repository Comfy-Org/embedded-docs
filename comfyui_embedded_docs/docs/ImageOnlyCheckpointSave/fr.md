...
|-----------|-----------------|--------|-------|-------------|
| `modèle` | MODEL | Oui | - | Le modèle à enregistrer dans le point de contrôle |
...
| `préfixe_de_nom_de_fichier` | STRING | Oui | - | Le préfixe pour le nom du fichier de sortie (par défaut : "checkpoints/ComfyUI") |
