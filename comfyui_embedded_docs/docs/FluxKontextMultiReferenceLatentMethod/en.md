...
| `reference_latents_method` | The method to use for reference latents processing. If "uxo" or "uso" is selected, it will be converted to "uxo". This parameter is marked as advanced. | COMBO | Yes | `"offset"`<br>`"index"`<br>`"uxo/uno"`<br>`"index_timestep_zero"` |
