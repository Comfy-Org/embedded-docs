...
|-----------|-----------|------------|---------|-------|-------------|
| `prompt` | STRING | 必填 | "" | - | DALL·E 的文本提示 |
| `seed` | INT | 可选 | 0 | 0 到 2147483647 | 后端尚未实现 |
| `size` | COMBO | 可选 | "1024x1024" | "256x256", "512x512", "1024x1024" | 图像尺寸 |
| `n` | INT | 可选 | 1 | 1 到 8 | 要生成的图像数量 |
| `image` | IMAGE | 可选 | None | - | 用于图像编辑的可选参考图像。 |
| `mask` | MASK | 可选 | None | - | 用于修复的可选蒙版（白色区域将被替换） |
