...
| `ingredients_mode` | STRING | Non | "creative"<br>"precise" | Mode de combinaison des ingrédients (par défaut : "creative") |
| `aspect_ratio` | FLOAT | Non | 0,4 - 2,5 | Rapport hauteur/largeur (largeur / hauteur) (par défaut : 1,778) |
