...
|-----------|--------------|-------------|-------|-------------|
| `prompt_text` | STRING | Sí | - | Descripción textual de lo que se desea generar |
...
| `resolution` | STRING | Sí | - | Resolución de salida del video |
| `duration` | INT | Sí | - | Duración del video generado |
| `ingredients_mode` | STRING | No | "creative"<br>"precise" | Modo para combinar ingredientes (predeterminado: "creative") |
| `aspect_ratio` | FLOAT | No | 0.4 - 2.5 | Relación de aspecto (ancho / alto) (predeterminado: 1.778) |
| `image_ingredient_1` | IMAGE | No | - | Imagen que se usará como ingrediente para crear un video |
| `image_ingredient_2` | IMAGE | No | - | Imagen que se usará como ingrediente para crear un video |
| `image_ingredient_3` | IMAGE | No | - | Imagen que se usará como ingrediente para crear un video |
| `image_ingredient_4` | IMAGE | No | - | Imagen que se usará como ingrediente para crear un video |
| `image_ingredient_5` | IMAGE | No | - | Imagen que se usará como ingrediente para crear un video |
