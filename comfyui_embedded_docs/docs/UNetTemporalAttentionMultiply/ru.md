...
| `самовременный` | FLOAT | Нет | 0.0 - 10.0 | Множитель для временных компонентов самовнимания (по умолчанию: 1.0) |
| `кросс-структурный` | FLOAT | Нет | 0.0 - 10.0 | Множитель для структурных компонентов перекрестного внимания (по умолчанию: 1.0) |
| `кросс-временной` | FLOAT | Нет | 0.0 - 10.0 | Множитель для временных компонентов перекрестного внимания (по умолчанию: 1.0) |

## Выходные параметры

| Имя выходного параметра | Тип данных | Описание |
|-------------|-----------|-------------|
| `модель` | MODEL | Модифицированная модель с отрегулированными весами внимания |
