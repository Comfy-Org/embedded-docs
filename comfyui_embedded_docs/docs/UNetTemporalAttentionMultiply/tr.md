...
| `self_structural` | FLOAT | Hayır | 0.0 - 10.0 | Kendi kendine dikkat yapısal bileşenleri için çarpan (varsayılan: 1.0) |
| `self_temporal` | FLOAT | Hayır | 0.0 - 10.0 | Kendi kendine dikkat zamansal bileşenleri için çarpan (varsayılan: 1.0) |
