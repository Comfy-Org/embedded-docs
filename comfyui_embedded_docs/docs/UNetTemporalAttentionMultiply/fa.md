...
|---------|----------|--------|--------|---------|
| `مدل` | MODEL | بله | - | مدل ورودی برای اعمال ضرایب ضربی توجه |
| `ساختاری خود` | FLOAT | خیر | 0.0 - 10.0 | ضریب ضرب برای مؤلفه‌های ساختاری خودتوجهی (پیش‌فرض: 1.0) |
| `زمانی خود` | FLOAT | خیر | 0.0 - 10.0 | ضریب ضرب برای مؤلفه‌های زمانی خودتوجهی (پیش‌فرض: 1.0) |
| `ساختاری متقاطع` | FLOAT | خیر | 0.0 - 10.0 | ضریب ضرب برای مؤلفه‌های ساختاری توجه متقاطع (پیش‌فرض: 1.0) |
| `زمانی متقاطع` | FLOAT | خیر | 0.0 - 10.0 | ضریب ضرب برای مؤلفه‌های زمانی توجه متقاطع (پیش‌فرض: 1.0) |

## خروجی‌ها

| نام خروجی | نوع داده | توضیحات |
|-----------|----------|---------|
| `مدل` | MODEL | مدل اصلاح‌شده با وزن‌های توجه تنظیم‌شده |
