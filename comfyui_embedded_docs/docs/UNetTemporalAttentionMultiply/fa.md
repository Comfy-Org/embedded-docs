...
|---------|----------|--------|--------|---------|
| `model` | MODEL | بله | - | مدل ورودی برای اعمال ضرایب ضربی توجه |
| `self_structural` | FLOAT | خیر | 0.0 - 10.0 | ضریب ضرب برای مؤلفه‌های ساختاری خودتوجهی (پیش‌فرض: 1.0) |
| `self_temporal` | FLOAT | خیر | 0.0 - 10.0 | ضریب ضرب برای مؤلفه‌های زمانی خودتوجهی (پیش‌فرض: 1.0) |
| `cross_structural` | FLOAT | خیر | 0.0 - 10.0 | ضریب ضرب برای مؤلفه‌های ساختاری توجه متقاطع (پیش‌فرض: 1.0) |
| `cross_temporal` | FLOAT | خیر | 0.0 - 10.0 | ضریب ضرب برای مؤلفه‌های زمانی توجه متقاطع (پیش‌فرض: 1.0) |

## خروجی‌ها

| نام خروجی | نوع داده | توضیحات |
|-----------|----------|---------|
| `model` | MODEL | مدل اصلاح‌شده با وزن‌های توجه تنظیم‌شده |
