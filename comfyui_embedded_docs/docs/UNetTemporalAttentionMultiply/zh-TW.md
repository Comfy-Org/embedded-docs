...
| `自我結構` | FLOAT | 否 | 0.0 - 10.0 | 自注意力結構性元件的乘數（預設值：1.0） |
| `自我時間` | FLOAT | 否 | 0.0 - 10.0 | 自注意力時間性元件的乘數（預設值：1.0） |
| `交叉結構` | FLOAT | 否 | 0.0 - 10.0 | 交叉注意力結構性元件的乘數（預設值：1.0） |
| `交叉時間` | FLOAT | 否 | 0.0 - 10.0 | 交叉注意力時間性元件的乘數（預設值：1.0） |
