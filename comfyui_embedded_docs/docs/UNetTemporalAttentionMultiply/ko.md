...
| `구조적 셀프` | FLOAT | 아니요 | 0.0 - 10.0 | 자기 어텐션 구조적 구성 요소의 승수 (기본값: 1.0) |
| `시간적 셀프` | FLOAT | 아니요 | 0.0 - 10.0 | 자기 어텐션 시간적 구성 요소의 승수 (기본값: 1.0) |
| `구조적 크로스` | FLOAT | 아니요 | 0.0 - 10.0 | 교차 어텐션 구조적 구성 요소의 승수 (기본값: 1.0) |
| `시간적 크로스` | FLOAT | 아니요 | 0.0 - 10.0 | 교차 어텐션 시간적 구성 요소의 승수 (기본값: 1.0) |
