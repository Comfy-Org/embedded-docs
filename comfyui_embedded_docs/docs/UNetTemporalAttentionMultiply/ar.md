...
| `التركيب الذاتي` | FLOAT | لا | 0.0 - 10.0 | مضاعف لمكونات الانتباه الذاتي الهيكلية (الافتراضي: 1.0) |
| `الزمن الذاتي` | FLOAT | لا | 0.0 - 10.0 | مضاعف لمكونات الانتباه الذاتي الزمنية (الافتراضي: 1.0) |
| `التركيب المتقاطع` | FLOAT | لا | 0.0 - 10.0 | مضاعف لمكونات الانتباه المتبادل الهيكلية (الافتراضي: 1.0) |
| `الزمن المتقاطع` | FLOAT | لا | 0.0 - 10.0 | مضاعف لمكونات الانتباه المتبادل الزمنية (الافتراضي: 1.0) |

## المخرجات

| اسم المخرج | نوع البيانات | الوصف |
|-------------|---------------|-------------|
| `النموذج` | MODEL | النموذج المعدل بأوزان انتباه مضبوطة |
