...
|-----------|--------------|-------------|-------|-----------|
| `áudio` | AUDIO | Sim | - | A entrada de áudio a ser cortada |
| `índice_inicial` | FLOAT | Sim | -0xffffffffffffffff a 0xffffffffffffffff | Tempo inicial em segundos, pode ser negativo para contar a partir do final (suporta subsegundos). Padrão: 0.0 |
| `duração` | FLOAT | Sim | 0.0 a 0xffffffffffffffff | Duração em segundos. Padrão: 60.0 |
...
|---------------|--------------|-----------|
| `áudio` | AUDIO | O segmento de áudio cortado com o tempo inicial e duração especificados |
