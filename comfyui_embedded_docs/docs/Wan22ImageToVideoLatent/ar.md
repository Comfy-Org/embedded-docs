...
| `العرض` | INT | نعم | 32 إلى MAX_RESOLUTION | عرض الفيديو الناتج بالبكسل (الافتراضي: 1280، الخطوة: 32) |
| `الارتفاع` | INT | نعم | 32 إلى MAX_RESOLUTION | ارتفاع الفيديو الناتج بالبكسل (الافتراضي: 704، الخطوة: 32) |
| `الطول` | INT | نعم | 1 إلى MAX_RESOLUTION | عدد الإطارات في تسلسل الفيديو (الافتراضي: 49، الخطوة: 4) |
| `حجم_الدفعة` | INT | نعم | 1 إلى 4096 | عدد الدُفعات المراد توليدها (الافتراضي: 1) |
| `صورة_البداية` | IMAGE | لا | - | سلسلة صور بداية اختيارية لترميزها في الفيديو الكامن |
