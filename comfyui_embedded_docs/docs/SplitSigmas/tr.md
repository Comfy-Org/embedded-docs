...
| Parametre | Açıklama | Veri Türü |
| --- | --- | --- |
| `sigmas` | Düğüm, her biri belirtilen adımda bölünmüş orijinal dizinin bir parçasını temsil eden iki sigma değerleri dizisi çıktısı verir. Bu çıktılar, sigma değerlerinin farklılaştırılmış şekilde ele alınmasını gerektiren sonraki işlemler için çok önemlidir. | `SIGMAS` |
