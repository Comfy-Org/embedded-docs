...
Le nœud Seed fournit une valeur entière pouvant être utilisée comme graine pour contrôler la reproductibilité des opérations aléatoires dans d'autres nœuds. En fournissant une valeur de départ cohérente, il aide à maintenir la répétabilité des résultats générés lorsque cela est nécessaire.
...
|---------------|-------------|-----------------|
| `seed` | La valeur de graine générée. | INT |
