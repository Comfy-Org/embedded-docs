...
|---------------------|-------------------|---------------------------------------------------------------------------------|
| `control_net_name`  | `COMBO[STRING]`   | Указывает имя модели ControlNet для загрузки. Используется для поиска файла модели в предопределённой структуре каталогов. |
