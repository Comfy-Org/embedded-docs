...
| `set_cond_area` | STRING | Oui | "default"<br>"mask bounds" | Contrôle la manière dont la zone de conditionnement est appliquée (par défaut : "default") |
...
|---------------|-----------------|-------------|
| `positive` | CONDITIONING | La sortie de conditionnement positif combinée |
| `negative` | CONDITIONING | La sortie de conditionnement négatif combinée |
