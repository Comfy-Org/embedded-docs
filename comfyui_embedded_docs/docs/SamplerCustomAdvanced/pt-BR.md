...
|---------------|--------------|-----------|
| `output` | LATENT | A representação latente final amostrada após concluir o processo de amostragem |
| `denoised_output` | LATENT | Uma versão com redução de ruído da saída, quando disponível; caso contrário, retorna o mesmo que a saída |
