...
| `seed` | INT | No | 0 a 2147483647 | Un valor de semilla (predeterminado: 0). El nodo se volverá a ejecutar si este valor cambia, pero los resultados no son deterministas independientemente de la semilla. |
| `watermark` | BOOLEAN | No | Verdadero / Falso | Si se debe agregar una marca de agua al video (predeterminado: Falso). Esta es una configuración avanzada. |
