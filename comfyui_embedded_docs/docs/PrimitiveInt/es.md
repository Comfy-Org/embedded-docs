...
| --- | --- | --- | --- | --- |
| `valor` | El valor entero a generar (predeterminado: 0) | INT | Sí | -9223372036854775807 a 9223372036854775807 |

## Salidas

| Nombre de salida | Descripción | Tipo de dato |
| --- | --- | --- |
| `output` | El valor entero de entrada pasado sin cambios | INT |
