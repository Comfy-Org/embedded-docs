...
|-----------|--------------|-------------|-------|-----------|
| `modelo` | COMBO | Sim | `"viduq3-pro"`<br>`"viduq3-turbo"` | Modelo a ser usado para a geração do vídeo. |
...
| `imagem` | IMAGE | Sim | - | Uma imagem a ser usada como quadro inicial do vídeo gerado. |
