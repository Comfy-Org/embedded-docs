...
| Parametre | Açıklama | Veri Türü | Gerekli | Aralık |
|-----------|-------------|-----------|----------|-------|
| `çözünürlük` | Çıktı videosunun çözünürlüğü. | COMBO | Evet | `"720p"`<br>`"1080p"`<br>`"2K"` |
| `süre` | Çıktı videosunun saniye cinsinden süresi (varsayılan: 5). | INT | Evet | 1 ile 16 |
| `ses` | Etkinleştirildiğinde, videoyu sesle (diyalog ve ses efektleri dahil) çıkarır (varsayılan: False). | BOOLEAN | Evet | `True`<br>`False` |
