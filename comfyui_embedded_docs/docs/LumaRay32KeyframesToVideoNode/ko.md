...
| `duration` | 생성된 비디오의 길이입니다(기본값: "5s"). | COMBO | 예 | `"5s"`<br>`"10s"` |
| `seed` | 재현성 제어를 위한 난수 생성 시드입니다. | INT | 예 | 0~4294967295 |
| `keyframes` | Luma Ray 3.2 키프레임 노드의 키프레임 시퀀스입니다(최소 2개). | LUMA_RAY32_KEYFRAME | 예 | 2~64개 키프레임 |
