...
|-----------|-----------|----------|-------|-------------|
| `positive` | CONDITIONING | 예 | - | 프레임 속도 정보를 받을 양성 조건화 입력입니다 |
| `negative` | CONDITIONING | 예 | - | 프레임 속도 정보를 받을 음성 조건화 입력입니다 |
| `frame_rate` | FLOAT | 예 | 0.0 - 1000.0 | 두 조건화 세트에 적용할 프레임 속도 값입니다 (기본값: 25.0) |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `positive` | CONDITIONING | 프레임 속도 정보가 적용된 양성 조건화입니다 |
| `negative` | CONDITIONING | 프레임 속도 정보가 적용된 음성 조건화입니다 |
