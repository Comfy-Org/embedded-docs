...
|-----------|-----------|----------|-------|-------------|
| `positive` | CONDITIONING | 예 | - | 프레임 속도 정보가 추가될 양수 조건 입력 |
| `negative` | CONDITIONING | 예 | - | 프레임 속도 정보가 추가될 음수 조건 입력 |
| `frame_rate` | FLOAT | 아니오 | 0.0 - 1000.0 | 두 조건 세트에 적용할 프레임 속도 값 (기본값: 25.0) |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `positive` | CONDITIONING | 프레임 속도 정보가 적용된 양수 조건 |
| `negative` | CONDITIONING | 프레임 속도 정보가 적용된 음수 조건 |