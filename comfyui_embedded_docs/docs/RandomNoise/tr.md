...
|-----------|-----------|----------|-------|-------------|
| `gürültü_tohumu` | INT | Evet | 0 ile 18446744073709551615 arası | Rastgele gürültü desenini oluşturmak için kullanılan tohum değeri (varsayılan: 0). Aynı tohum değeri her zaman aynı gürültü çıktısını üretir. |
