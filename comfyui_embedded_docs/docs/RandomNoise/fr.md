...
|-----------|-----------------|--------|-------|-------------|
| `noise_seed` | INT | Oui | 0 à 18446744073709551615 | La valeur de graine utilisée pour générer le motif de bruit aléatoire (par défaut : 0). La même graine produira toujours la même sortie de bruit. |
