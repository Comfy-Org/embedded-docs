...
|-----------|--------------|-------------|-------|-------------|
| `semilla_ruido` | INT | Sí | 0 a 18446744073709551615 | El valor de semilla utilizado para generar el patrón de ruido aleatorio (predeterminado: 0). La misma semilla siempre producirá la misma salida de ruido. |
