...
|---------|----------|-------|--------|---------|
| `video_latent` | LATENT | بله | | نمایش نهفته داده‌های ویدئویی. |
| `audio_latent` | LATENT | بله | | نمایش نهفته داده‌های صوتی. |
...
|-----------|----------|---------|
| `latent` | LATENT | یک دیکشنری نهفته تکی شامل `samples` به‌هم‌پیوسته و در صورت وجود، `noise_mask` به‌هم‌پیوسته از ورودی‌های ویدئو و صدا. |
