...
| --- | --- | --- | --- | --- |
| `imagem` | A imagem de entrada a ser ampliada. Aceita um lote de imagens. | IMAGE | Sim | - |

## Saídas

| Nome da Saída | Descrição | Tipo de Dado |
| --- | --- | --- |
| `imagem` | A imagem ampliada com resolução e clareza aprimoradas. Retorna um lote de imagens se um lote foi fornecido como entrada. | IMAGE |
