...
| `tracks` | STRING | Sim | - | Dados de rastreamento em formato JSON como uma string multilinha (padrão: "[]") |
...
| `temperature` | FLOAT | Sim | 1.0 a 1000.0 | Parâmetro de temperatura para correção de movimento (padrão: 220.0, passo: 0.1) |
