...
Kling Lip Sync Audio to Video Node 可將影片檔案中的嘴部動作與音訊檔案的內容進行同步。此節點會分析音訊中的語音模式，並調整影片中的臉部動作，以創造出逼真的唇形同步效果。此處理過程需要一個包含清晰臉部的影片檔案，以及一個具有明顯可辨識人聲的音訊檔案。

## 輸入參數

| 參數名稱 | 資料類型 | 必填 | 數值範圍 | 參數說明 |
|-----------|-----------|----------|-------|-------------|
| `影片` | VIDEO | 是 | - | 包含待進行唇形同步臉部的影片檔案 |
| `音訊` | AUDIO | 是 | - | 包含需與影片同步之人聲的音訊檔案 |
...
- 音訊檔案大小不應超過 5MB
- 影片檔案大小不應超過 100MB
- 影片尺寸的高度/寬度應介於 720px 至 1920px 之間
- 影片長度應介於 2 秒至 10 秒之間
- 音訊必須包含清晰可辨的人聲
- 影片必須包含清晰的臉部
