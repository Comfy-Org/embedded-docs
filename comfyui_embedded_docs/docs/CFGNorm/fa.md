...
|---------|----------|-----------|---------|--------|---------|
| `مدل` | MODEL | اجباری | - | - | مدل انتشار که نرمال‌سازی CFG روی آن اعمال می‌شود |
| `شدت` | FLOAT | اجباری | 1.0 | 0.0 - 100.0 | شدت اثر نرمال‌سازی اعمال‌شده بر مقیاس‌گذاری CFG را کنترل می‌کند |
