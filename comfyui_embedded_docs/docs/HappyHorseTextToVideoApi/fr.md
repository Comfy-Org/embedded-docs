...
| `watermark` | Indique s'il faut ajouter un filigrane généré par IA au résultat. (défaut : False). | BOOLEAN | Non | True / False |

### happyhorse-1.1-t2v Entrées

| Paramètre | Description | Type de données | Requis | Plage |
|-----------|-------------|-----------------|--------|-------|
| `model.prompt` | Invite décrivant les éléments et les caractéristiques visuelles. Prend en charge l'anglais et le chinois. (défaut : ""). | STRING | Oui | - |
| `model.resolution` | La résolution de la vidéo de sortie. | COMBO | Oui | "720P"<br>"1080P" |
| `model.ratio` | Le rapport hauteur/largeur de la vidéo de sortie. | COMBO | Oui | "16:9"<br>"9:16"<br>"1:1"<br>"4:3"<br>"3:4"<br>"21:9"<br>"9:21"<br>"5:4"<br>"4:5" |
| `model.duration` | La durée de la vidéo en secondes. (défaut : 5, min : 3, max : 15, pas : 1). | INT | Oui | 3 à 15 |
