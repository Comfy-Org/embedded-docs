...
| `tohum` | INT | Evet | 0 ile 2147483647 arası | Oluşturma için kullanılacak tohum değeri. Aynı girdilerle aynı tohum değerini kullanmak aynı sonucu üretecektir. (varsayılan: 0). |
