...
| `seed` | INT | Sí | 0 a 2147483647 | Semilla a utilizar para la generación. Usar la misma semilla con las mismas entradas producirá el mismo resultado. (predeterminado: 0). |
| `watermark` | BOOLEAN | No | True / False | Si se debe agregar una marca de agua de IA generada al resultado. (predeterminado: False). |
