...
El nodo DisableNoise proporciona una configuración de ruido vacía que puede utilizarse para desactivar la generación de ruido en los procesos de muestreo. Devuelve un objeto de ruido especial que no contiene datos de ruido, lo que permite que otros nodos omitan las operaciones relacionadas con el ruido cuando se conectan a esta salida.
