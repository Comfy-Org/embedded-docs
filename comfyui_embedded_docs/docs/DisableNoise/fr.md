...
|---------------|-----------------|-------------|
| `NOISE` | NOISE | Renvoie une configuration de bruit vide qui peut être utilisée pour désactiver la génération de bruit dans les processus d'échantillonnage. |
