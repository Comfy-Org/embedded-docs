...
| Parâmetro | Tipo de Dados | Descrição |
|-----------|-------------|-------------|
| `mask`    | `MASK`      | Este nó gera a máscara criada a partir da imagem e do canal especificados, preparada em um formato padronizado adequado para processamento adicional em tarefas de manipulação de imagem. |