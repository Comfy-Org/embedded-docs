...
Este nó cria uma estrutura latente vazia para o modelo Trellis2, onde todos os valores são definidos como zero. Ele produz um tensor latente 3D em branco com 32 canais em uma resolução de 16×16×16, dimensionado para o número especificado de itens no lote.
...
|-------------|-------------|-----------|
| `LATENT` | Uma estrutura latente Trellis2 vazia. As amostras são um tensor preenchido com zeros com a forma (batch_size, 32, 16, 16, 16), e o tipo latente é definido como "trellis2". | LATENT |
