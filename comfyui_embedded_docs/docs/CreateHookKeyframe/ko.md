...
|-----------|-----------|----------|-------|-------------|
| `strength_mult` | FLOAT | 예 | -20.0 ~ 20.0 | 이 키프레임에서 후크 강도에 적용할 배수 (기본값: 1.0) |
| `start_percent` | FLOAT | 예 | 0.0 ~ 1.0 | 이 키프레임이 적용되는 생성 과정의 백분율 지점 (기본값: 0.0) |
| `prev_hook_kf` | HOOK_KEYFRAMES | 아니요 | - | 이 키프레임을 추가할 이전 후크 키프레임 그룹 (선택 사항) |
