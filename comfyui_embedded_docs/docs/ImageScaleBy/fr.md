...
| Paramètre | Type de données | Description                                                   |
|-----------|-----------------|---------------------------------------------------------------|
| `image`   | `IMAGE`         | L'image agrandie, dont la taille est supérieure à celle de l'image d'entrée selon le facteur d'échelle et la méthode d'interpolation spécifiés. |