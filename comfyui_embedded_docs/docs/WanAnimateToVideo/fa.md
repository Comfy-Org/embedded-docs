...
| --- | --- | --- |
| `positive` | شرطی‌سازی مثبت اصلاح‌شده با زمینه ویدئویی اضافی شامل خروجی بینایی CLIP، نهان ویدئوی حالت، پیکسل‌های ویدئوی چهره، تصویر نهان الحاق‌شده و ماسک الحاق‌شده | CONDITIONING |
| `negative` | شرطی‌سازی منفی اصلاح‌شده با زمینه ویدئویی اضافی شامل خروجی بینایی CLIP، نهان ویدئوی حالت، پیکسل‌های ویدئوی چهره (معکوس)، تصویر نهان الحاق‌شده و ماسک الحاق‌شده | CONDITIONING |
...
| `video_frame_offset` | جابجایی فریم به‌روز شده برای ادامه تولید ویدئو به صورت تکه‌ای، که به‌صورت جابجایی قبلی به‌علاوه طول تولیدشده محاسبه می‌شود | INT |
