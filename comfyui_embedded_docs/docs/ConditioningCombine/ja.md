...
| パラメータ名        | データ型          | 説明 |
|----------------------|--------------------|-------------|
| `conditioning_1`     | `CONDITIONING`     | 結合される最初の条件付け入力です。結合プロセスにおいて、`conditioning_2` と同等の重要度を持ちます。 |
| `conditioning_2`     | `CONDITIONING`     | 結合される2番目の条件付け入力です。結合プロセスにおいて、`conditioning_1` と同等の重要度を持ちます。 |

## 出力

| パラメータ名        | データ型          | 説明 |
|----------------------|--------------------|-------------|
| `conditioning`       | `CONDITIONING`     | `conditioning_1` と `conditioning_2` を結合した結果であり、マージされた情報を内包します。 |
