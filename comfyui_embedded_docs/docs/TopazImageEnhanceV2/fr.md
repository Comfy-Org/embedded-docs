...
| `modèle` | Le modèle d'amélioration Topaz à utiliser. Le modèle sélectionné détermine quels paramètres spécifiques au modèle apparaissent. | DYNAMIC_COMBO | Oui | `"Reimagine"`<br>`"Bloom 2"`<br>`"Wonder 3.5"` |
