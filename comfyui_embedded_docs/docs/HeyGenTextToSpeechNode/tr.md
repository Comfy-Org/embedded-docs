...
| `özel_ses_id` | İsteğe bağlı HeyGen ses kimliği. Ayarlandığında, yukarıda seçilen sesi geçersiz kılar. Sesin Starfish motorunu desteklemesi gerekir (varsayılan: boş). | STRING | Hayır | Geçerli herhangi bir HeyGen ses kimliği |
