...
| `model` | COMBO | requis | gemini_2_5_flash_image_preview | `gemini_2_5_flash_image_preview`<br>`gemini_2_5_pro_exp_03_25`<br>`gemini_2_0_flash_exp_image_generation` | Le modèle Gemini à utiliser pour générer les réponses. |
...
|------------------|-----------------|-------------|
| `IMAGE` | IMAGE | La réponse visuelle générée par le modèle Gemini |
