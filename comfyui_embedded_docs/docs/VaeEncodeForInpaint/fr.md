...
| Paramètre | Type de données | Description |
|-----------|-----------------|-------------|
| `latent`  | `LATENT`        | La sortie inclut la représentation latente encodée de l'image ainsi qu'un masque de bruit, tous deux essentiels pour les tâches d'infilling ultérieures. |