...
|-----------|-----------|----------|-------|-------------|
| `model_3d` | FILE3D | 예 | FBX, 모든 형식 | FBX 형식의 3D 모델입니다. 모델은 100,000개 미만의 면을 가져야 합니다. |
...
| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `OBJ` | FILE3D | GLB 형식으로 처리된 3D 모델입니다. |
| `texture_image` | FILE3D | OBJ 형식으로 처리된 3D 모델입니다. |
| `texture_image` | IMAGE | 3D 모델에 대해 새로 생성된 텍스처 이미지입니다. |
