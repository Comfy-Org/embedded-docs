...
| `prompt` | STRING | Sim | | Descreve a edição da textura. Suporta até 1024 caracteres UTF-8. |
...
| `OBJ` | FILE3D | O modelo 3D processado no formato OBJ. |
| `texture_image` | IMAGE | A imagem de textura recém-gerada para o modelo 3D. |
