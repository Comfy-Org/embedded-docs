...
|-----------|-----------|----------|-------|-------------|
| `scale_ratio` | FLOAT | 아니요 | 0.1 - 20.0 | 업스케일링 중 적용할 배율입니다 (기본값: 1.0) |
| `scale_steps` | INT | 아니요 | -1 - 1000 | 업스케일링 과정에 사용할 단계 수입니다. 자동 계산을 위해 -1을 사용합니다 (기본값: -1) |
| `upscale_method` | COMBO | 예 | "bislerp"<br>"nearest-exact"<br>"bilinear"<br>"area"<br>"bicubic" | 이미지 업스케일링에 사용되는 보간 방법입니다 |
