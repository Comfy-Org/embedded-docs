...
| `ratio` | FLOAT | ОБЯЗАТЕЛЬНЫЙ | 1.0 | 0.0 - 1.0 (шаг: 0.01) | Определяет долю признаков второй модели, смешиваемых с первой моделью. Коэффициент 1.0 означает полное применение признаков второй модели, а 0.0 оставляет только признаки первой модели. |
