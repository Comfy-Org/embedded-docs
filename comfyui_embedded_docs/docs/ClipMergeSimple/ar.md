...
|---|---|---|---|---|---|
| `CLIP 1` | CLIP | إلزامي | - | - | نموذج CLIP الأول المراد دمجه. يعمل كنموذج أساسي لعملية الدمج. |
| `CLIP 2` | CLIP | إلزامي | - | - | نموذج CLIP الثاني المراد دمجه. يتم تطبيق تصحيحات المفاتيح الخاصة به، باستثناء معرفات المواضع ومقياس اللوغاريتم، على النموذج الأول بناءً على النسبة المحددة. |
| `النسبة` | FLOAT | إلزامي | 1.0 | 0.0 - 1.0 (الخطوة: 0.01) | يحدد نسبة ميزات النموذج الثاني التي سيتم دمجها في النموذج الأول. تعني النسبة 1.0 الاعتماد الكامل على ميزات النموذج الثاني، بينما تحتفظ النسبة 0.0 بميزات النموذج الأول فقط. |

## المخرجات

| اسم المخرج | نوع البيانات | الوصف |
|---|---|---|
| `clip` | CLIP | نموذج CLIP الناتج عن الدمج، والذي يتضمن ميزات من كلا النموذجين المدخلين وفقًا للنسبة المحددة. |
