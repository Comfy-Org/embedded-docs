...
Codifica texto y establece el condicionamiento de resolución para PixArt Alpha. Este nodo procesa la entrada de texto y añade información de ancho y alto para crear datos de condicionamiento específicamente para los modelos PixArt Alpha. No se aplica a los modelos PixArt Sigma.
