...
|-----------|-----------|------------|---------|-------|-------------|
| `width` | INT | Input | 1024 | 0 до MAX_RESOLUTION | Размер ширины для условия разрешения |
| `height` | INT | Input | 1024 | 0 до MAX_RESOLUTION | Размер высоты для условия разрешения |
| `text` | STRING | Input | - | - | Текстовый ввод для кодирования, поддерживает многострочный ввод и динамические промпты |
