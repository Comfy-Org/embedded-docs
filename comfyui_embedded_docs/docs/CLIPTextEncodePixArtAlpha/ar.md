...
|---------|--------------|-------|--------|-------|
| `العرض` | INT | نعم | 0 إلى MAX_RESOLUTION | بُعد العرض لشرطية الدقة (الافتراضي: 1024) |
| `الارتفاع` | INT | نعم | 0 إلى MAX_RESOLUTION | بُعد الارتفاع لشرطية الدقة (الافتراضي: 1024) |
| `النص` | STRING | نعم | - | إدخال النص المراد تشفيره، يدعم الإدخال متعدد الأسطر والمحفزات الديناميكية |
