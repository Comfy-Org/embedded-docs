...
|-----------|-----------|------------|---------|-------|-------------|
| `width` | INT | Giriş | 1024 | 0 - MAX_RESOLUTION | Çözünürlük koşullandırması için genişlik boyutu |
| `height` | INT | Giriş | 1024 | 0 - MAX_RESOLUTION | Çözünürlük koşullandırması için yükseklik boyutu |
| `text` | STRING | Giriş | - | - | Kodlanacak metin girişi, çok satırlı giriş ve dinamik istemleri destekler |
