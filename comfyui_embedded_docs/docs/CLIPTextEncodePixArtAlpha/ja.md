...
|-----------|-----------|------------|---------|-------|-------------|
| `width` | INT | 入力 | 1024 | 0 ～ MAX_RESOLUTION | 解像度条件付けのための幅の次元 |
| `height` | INT | 入力 | 1024 | 0 ～ MAX_RESOLUTION | 解像度条件付けのための高さの次元 |
| `text` | STRING | 入力 | - | - | エンコードされるテキスト入力。複数行入力と動的プロンプトをサポートします |
