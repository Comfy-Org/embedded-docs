...
| `resolution_level` | Controls the processing resolution. 0 = fastest, 9 = most detail. (default: 9) | INT | Yes | 0 to 9 |
| `fov_x_degrees` | (Advanced) Horizontal field of view of the source camera. Sets the focal length used to unproject the depth map into 3D. 0 = auto-recover from the predicted points. (default: 0.0) | FLOAT | Yes | 0.0 to 170.0 (step 0.1) |
