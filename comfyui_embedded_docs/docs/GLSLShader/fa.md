> این مستندات توسط هوش مصنوعی تولید شده است. اگر خطایی یافتید یا پیشنهادی برای بهبود دارید، لطفاً مشارکت کنید! [ویرایش در GitHub](https://github.com/Comfy-Org/embedded-docs/blob/main/comfyui_embedded_docs/docs/GLSLShader/fa.md)
