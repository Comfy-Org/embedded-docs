...
| `cfg 스케일` | FLOAT | 아니요 | 0.0-1.0 | 출력이 프롬프트를 얼마나 밀접하게 따르는지 제어합니다 (기본값: 0.75) |
| `종횡비` | COMBO | 아니요 | "16:9"<br>"9:16"<br>"1:1"<br>"21:9"<br>"3:4"<br>"4:3" | 생성된 비디오의 화면 비율입니다 (기본값: "16:9") |
| `카메라 제어` | CAMERA_CONTROL | 아니요 | - | Kling 카메라 제어 노드를 사용하여 생성할 수 있습니다. 비디오 생성 중 카메라 움직임과 모션을 제어합니다. |
