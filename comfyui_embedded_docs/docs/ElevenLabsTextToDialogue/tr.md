...
| `girdiler` | Diyalog girişi sayısı. Bir sayı seçmek, o kadar sayıda metin ve ses giriş alanı oluşturacaktır. | DYNAMIC_COMBO | Evet | `"1"`<br>`"2"`<br>`"3"`<br>`"4"`<br>`"5"`<br>`"6"`<br>`"7"`<br>`"8"`<br>`"9"`<br>`"10"` |
