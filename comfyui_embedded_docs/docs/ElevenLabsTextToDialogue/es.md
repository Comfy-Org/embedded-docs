...
|-----------|-------------|---------------|-----------|-------|
| `estabilidad` | Estabilidad de la voz. Los valores más bajos ofrecen un rango emocional más amplio; los valores más altos producen un habla más consistente pero potencialmente monótona. (predeterminado: 0.5) | FLOAT | Sí | 0.0 - 1.0 |
...
| `modelo` | Modelo a utilizar para la generación de diálogos. | COMBO | Sí | `"eleven_v3"` |
...
| `código_de_idioma` | Código de idioma ISO-639-1 o ISO-639-3 (p. ej., 'en', 'es', 'fra'). Déjelo vacío para detección automática. (predeterminado: vacío) | STRING | Sí | - |
| `semilla` | Semilla para reproducibilidad. (predeterminado: 1) | INT | Sí | 0 - 4294967295 |
