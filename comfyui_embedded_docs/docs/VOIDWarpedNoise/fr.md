...
| `length` | INT | Oui | 1 à MAX_RESOLUTION (pas de 1) | Nombre d'images pixels. Arrondi à l'inférieur pour que latent_t soit pair (exigence patch_size_t=2), ex. 49 → 45 (par défaut : 45). |
