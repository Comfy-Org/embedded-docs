...
| `text` | STRING | 是 | - | 唇形同步视频生成的文本内容。在模式为 text2video 时必需。最大长度为 120 个字符。 |
| `voice` | COMBO | 否 | "Melody"<br>"Bella"<br>"Aria"<br>"Ethan"<br>"Ryan"<br>"Dorothy"<br>"Nathan"<br>"Lily"<br>"Aaron"<br>"Emma"<br>"Grace"<br>"Henry"<br>"Isabella"<br>"James"<br>"Katherine"<br>"Liam"<br>"Mia"<br>"Noah"<br>"Olivia"<br>"Sophia" | 唇形同步音频的语音选择（默认："Melody"） |
| `voice_speed` | FLOAT | 否 | 0.8-2.0 | 语速。有效范围：0.8~2.0，精确到小数点后一位（默认：1） |
