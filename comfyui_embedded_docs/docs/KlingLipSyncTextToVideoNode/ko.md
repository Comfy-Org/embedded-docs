...
|-----------|-----------|----------|-------|-------------|
| `video` | VIDEO | 예 | - | 입 모양 동기화를 위한 입력 비디오 파일 |
| `text` | STRING | 예 | - | 입 모양 동기화 비디오 생성을 위한 텍스트 콘텐츠. mode가 text2video일 때 필수입니다. 최대 길이는 120자입니다. |
| `voice` | COMBO | 아니오 | "Melody"<br>"Bella"<br>"Aria"<br>"Ethan"<br>"Ryan"<br>"Dorothy"<br>"Nathan"<br>"Lily"<br>"Aaron"<br>"Emma"<br>"Grace"<br>"Henry"<br>"Isabella"<br>"James"<br>"Katherine"<br>"Liam"<br>"Mia"<br>"Noah"<br>"Olivia"<br>"Sophia" | 입 모양 동기화 오디오용 음성 선택 (기본값: "Melody") |
| `voice_speed` | FLOAT | 아니오 | 0.8-2.0 | 음성 속도. 유효 범위: 0.8~2.0, 소수점 첫째 자리까지 정확함. (기본값: 1) |
...
| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `output` | VIDEO | 입 모양이 동기화된 오디오가 포함된 생성된 비디오 |
