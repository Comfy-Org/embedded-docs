...
|-----------|-----------|----------|-------|-------------|
| `비디오` | VIDEO | 예 | - | 립싱크를 위한 입력 비디오 파일 |
| `텍스트` | STRING | 예 | - | 립싱크 비디오 생성을 위한 텍스트 내용. 모드가 text2video일 때 필수입니다. 최대 길이는 120자입니다. |
| `음성` | COMBO | 아니요 | "Melody"<br>"Bella"<br>"Aria"<br>"Ethan"<br>"Ryan"<br>"Dorothy"<br>"Nathan"<br>"Lily"<br>"Aaron"<br>"Emma"<br>"Grace"<br>"Henry"<br>"Isabella"<br>"James"<br>"Katherine"<br>"Liam"<br>"Mia"<br>"Noah"<br>"Olivia"<br>"Sophia" | 립싱크 오디오를 위한 음성 선택 (기본값: "Melody") |
| `음성 속도` | FLOAT | 아니요 | 0.8-2.0 | 말하기 속도. 유효 범위: 0.8~2.0, 소수점 첫째 자리까지 정확합니다. (기본값: 1) |
...
| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `비디오 ID` | VIDEO | 립싱크 오디오가 적용된 생성된 비디오 |
