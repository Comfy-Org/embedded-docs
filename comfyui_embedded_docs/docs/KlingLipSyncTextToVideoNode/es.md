...
| `text` | STRING | Sí | - | Contenido de texto para la generación de video con sincronización labial. Requerido cuando el modo es text2video. Longitud máxima: 120 caracteres. |
...
| `voice_speed` | FLOAT | No | 0.8-2.0 | Velocidad del habla. Rango válido: 0.8~2.0, preciso a un decimal. (por defecto: 1) |
...
|-------------|-----------|-------------|
| `output` | VIDEO | Video generado con audio sincronizado labialmente |
