...
The Recraft V4 Text to Vector node generates Scalable Vector Graphics (SVG) illustrations from a text description. It connects to the Recraft API to generate images using Recraft V4 and V4.1 models, and outputs one or more SVG files based on your prompt.
