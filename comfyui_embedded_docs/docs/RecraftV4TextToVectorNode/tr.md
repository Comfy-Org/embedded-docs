...
|-----------|-----------|----------|-------|-------------|
| `prompt` | STRING | Evet | Yok | Görüntü oluşturma için istem. Maksimum 10.000 karakter. |
| `negative_prompt` | STRING | Hayır | Yok | Görüntüde istenmeyen öğelerin isteğe bağlı metin açıklaması. |
...
| `size` | COMBO | Evet | `recraftv4` için: `"1024x1024"`, `"1152x896"`, `"896x1152"`, `"1216x832"`, `"832x1216"`, `"1344x768"`, `"768x1344"`, `"1536x640"`, `"640x1536"`<br>`recraftv4_pro` için: `"2048x2048"`, `"2304x1792"`, `"1792x2304"`, `"2432x1664"`, `"1664x2432"`, `"2688x1536"`, `"1536x2688"`, `"3072x1280"`, `"1280x3072"` | Oluşturulan görüntünün boyutu. Mevcut seçenekler seçilen `model`'e bağlıdır. `recraftv4` için varsayılan `"1024x1024"`, `recraftv4_pro` için varsayılan `"2048x2048"`'dir. |
| `n` | INT | Evet | 1 ila 6 | Oluşturulacak görüntü sayısı (varsayılan: 1). |
| `seed` | INT | Evet | 0 ila 18446744073709551615 | Düğümün yeniden çalıştırılıp çalıştırılmayacağını belirleyen tohum değeri; gerçek sonuçlar tohum değerinden bağımsız olarak deterministik değildir. |
