...
|-----------|-----------|----------|--------|----------|
| `ön` | CLIP_VISION_OUTPUT | Hayır | - | Ön görünüm için CLIP görsel çıktısı |
| `sol` | CLIP_VISION_OUTPUT | Hayır | - | Sol görünüm için CLIP görsel çıktısı |
| `arka` | CLIP_VISION_OUTPUT | Hayır | - | Arka görünüm için CLIP görsel çıktısı |
| `sağ` | CLIP_VISION_OUTPUT | Hayır | - | Sağ görünüm için CLIP görsel çıktısı |
...
|-----------|-----------|----------|
| `negative` | CONDITIONING | Konumsal kodlama ile birleştirilmiş çoklu görünüm yerleştirmelerini içeren pozitif koşullandırma |
