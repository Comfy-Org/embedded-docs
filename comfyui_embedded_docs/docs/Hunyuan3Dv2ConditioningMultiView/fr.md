...
|-----------|-----------------|--------|-------|-------------|
| `front` | CLIP_VISION_OUTPUT | Non | - | Sortie visuelle CLIP pour la vue avant |
| `left` | CLIP_VISION_OUTPUT | Non | - | Sortie visuelle CLIP pour la vue gauche |
| `back` | CLIP_VISION_OUTPUT | Non | - | Sortie visuelle CLIP pour la vue arrière |
| `right` | CLIP_VISION_OUTPUT | Non | - | Sortie visuelle CLIP pour la vue droite |
