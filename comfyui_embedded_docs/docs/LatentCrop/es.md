...
|-----------|-------------|-------------|
| `samples` | `LATENT`    | El parámetro 'samples' representa las representaciones latentes que se recortarán. Es fundamental para definir los datos sobre los cuales se realizará la operación de recorte. |
