...
| `reference_images` | IMAGE | Sim | 1 a 9 | Uma ou mais imagens de referência da pessoa ou objeto a ser apresentado no vídeo. Você deve fornecer pelo menos uma imagem. |
