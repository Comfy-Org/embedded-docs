...
|-----------|-----------|----------|-------|-------------|
| `images` | IMAGE | Evet | Görüntü grubu | Ana kareler olarak dağıtılacak girdi görüntüleri. |
...
| `audio` | AUDIO | Evet | Ses verisi | Toplam çıktı karelerini hesaplamak ve bölüm sesini çıkarmak için kullanılacak ses. |
