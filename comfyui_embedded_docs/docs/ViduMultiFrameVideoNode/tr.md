...
| `başlangıç_görüntüsü` | IMAGE | Evet | - | Başlangıç karesi görüntüsü. En-boy oranı 1:4 ile 4:1 arasında olmalıdır. |
...
| `çözünürlük` | COMBO | Evet | `"720p"`<br>`"1080p"` | Çıktı videosunun çözünürlüğü. |
| `kareler` | DYNAMICCOMBO | Evet | `"2"`<br>`"3"`<br>`"4"`<br>`"5"`<br>`"6"`<br>`"7"`<br>`"8"`<br>`"9"` | Ana kare geçiş sayısı (2-9). Bir değer seçmek, her kare için gerekli girdileri dinamik olarak ortaya çıkarır. |
