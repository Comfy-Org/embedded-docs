...
| `frames` | Number of keyframe transitions (2-9). Selecting a value dynamically reveals the required inputs for each frame. | DYNAMIC COMBO | Yes | `"2"`<br>`"3"`<br>`"4"`<br>`"5"`<br>`"6"`<br>`"7"`<br>`"8"`<br>`"9"` |
