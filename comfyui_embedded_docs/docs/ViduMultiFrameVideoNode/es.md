...
| `seed` | Un valor de semilla para la generación de números aleatorios que garantiza resultados reproducibles (valor predeterminado: 1). | INT | Sí | 0 a 2147483647 |
| `resolution` | La resolución del video de salida. | COMBO | Sí | "720p"<br>"1080p" |
| `frames` | Número de transiciones de fotogramas clave (2-9). Seleccionar un valor revela dinámicamente las entradas requeridas para cada fotograma. | DYNAMIC_COMBO | Sí | "2"<br>"3"<br>"4"<br>"5"<br>"6"<br>"7"<br>"8"<br>"9" |
