...
| `imagem_inicial` | A imagem do quadro inicial. A proporção de aspecto deve estar entre 1:4 e 4:1. | IMAGE | Sim | Proporção de aspecto 1:4 a 4:1 |
| `semente` | Um valor de semente (seed) para geração de números aleatórios, garantindo resultados reproduzíveis (padrão: 1). | INT | Sim | 0 a 2147483647 |
