...
|-----------|--------------|-------------|-------|-------------|
| `color` | STRING | Sí | N/A | Un valor de color en el formato hexadecimal `#RRGGBB`. |
...
|------------------|--------------|-------------|
| `rgb_int` | INT | El valor entero RGB calculado. Se obtiene mediante la fórmula: `(Rojo * 65536) + (Verde * 256) + Azul`. |
