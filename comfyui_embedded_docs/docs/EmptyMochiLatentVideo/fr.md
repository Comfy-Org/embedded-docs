...
|-----------|-----------------|--------|-------|-------------|
| `width` | INT | Oui | 16 à MAX_RESOLUTION | La largeur de la vidéo latente en pixels (par défaut : 848, doit être divisible par 16) |
| `height` | INT | Oui | 16 à MAX_RESOLUTION | La hauteur de la vidéo latente en pixels (par défaut : 480, doit être divisible par 16) |
| `length` | INT | Oui | 7 à MAX_RESOLUTION | Le nombre d'images dans la vidéo latente (par défaut : 25, doit être divisible par 6 après soustraction de 1) |
