...
| `prompt` | Uma descrição em texto que orienta o conteúdo e o movimento do vídeo gerado. | STRING | Sim | - |
...
| `fps` | Os quadros por segundo (fps) do vídeo (padrão: 25). | COMBO | Sim | `25`<br>`50` |
...
* Se você selecionar uma `duration` superior a 10 segundos, deve usar o modelo **"LTX-2 (Fast)"**, a resolução **"1920x1080"** e **25** FPS. Essa combinação é necessária para vídeos mais longos.
