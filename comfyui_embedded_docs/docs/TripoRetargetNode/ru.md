...
|-------------|-----------|-------------|
| `model_file` | STRING | Сгенерированный анимированный файл 3D-модели (только для обратной совместимости) |
| `retarget task_id` | RETARGET_TASK_ID | Идентификатор задачи для отслеживания операции ретаргетинга |
| `GLB` | FILE3DGLB | Анимированная 3D-модель в формате GLB |
