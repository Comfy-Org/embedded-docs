...
| --- | --- | --- |
| `ملف النموذج` | ملف النموذج ثلاثي الأبعاد المتحرك المُنشأ (لأغراض التوافق مع الإصدارات السابقة فقط) | STRING |
| `معرّف مهمة إعادة الاستهداف` | معرف المهمة لتتبع عملية إعادة توجيه الحركة | RETARGET_TASK_ID |
