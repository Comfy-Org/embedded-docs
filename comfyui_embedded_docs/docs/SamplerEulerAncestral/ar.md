...
| --- | --- | --- | --- | --- |
| `إيتا` | يتحكم في حجم الخطوة ودرجة العشوائية في عملية أخذ العينات (الافتراضي: 1.0). هذا معامل متقدم. | FLOAT | نعم | 0.0 - 100.0 |
| `ضجيج s` | يتحكم في مقدار الضوضاء المضافة أثناء أخذ العينات (الافتراضي: 1.0). هذا معامل متقدم. | FLOAT | نعم | 0.0 - 100.0 |
