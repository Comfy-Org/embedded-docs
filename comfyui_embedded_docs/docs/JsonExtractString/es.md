...
|-----------|--------------|-------------|-------|-------------|
| `json_string` | STRING | Sí | N/A | El texto que contiene los datos JSON a analizar. |
| `key` | STRING | Sí | N/A | La clave específica cuyo valor de cadena desea extraer del objeto JSON. |
...
|------------------|--------------|-------------|
| `output` | STRING | El valor de cadena extraído del JSON para la clave especificada, o una cadena vacía si la extracción falla. |
