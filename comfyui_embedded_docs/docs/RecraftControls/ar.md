...
|---------|--------------|--------|--------|-------|
| `colors` | COLOR | لا | - | إعدادات الألوان للعناصر الرئيسية |
| `background_color` | COLOR | لا | - | إعداد لون الخلفية |

## المخرجات

| اسم المخرج | نوع البيانات | الوصف |
|------------|--------------|--------|
| `recraft_controls` | CONTROLS | عناصر تحكم Recraft المهيأة والتي تحتوي على إعدادات الألوان |
