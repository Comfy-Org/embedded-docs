...
| --- | --- | --- |
| `نقاط کلیدی` | نقاط کلیدی در قالب فریم OpenPose (عرض بوم، ارتفاع بوم، افراد). خروجی شامل افراد تشخیص‌داده‌شده است که هر کدام دارای آرایه‌ای از مختصات نقاط کلیدی (x, y) و نمرات اطمینان متناظر آن‌ها هستند. | POSE_KEYPOINT |
