...
| Campo | Tipo de Dados | Descrição                                                                       |
|-------|---------------|-----------------------------------------------------------------------------------|
| `ui`  | N/A           | Fornece um componente de interface do usuário exibindo as imagens PNG animadas geradas e indicando se a animação é de quadro único ou múltiplos quadros. |