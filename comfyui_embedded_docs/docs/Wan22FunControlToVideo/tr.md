...
|-----------|-----------|----------|
| `positive` | CONDITIONING | Birleştirme gizili, maske ve isteğe bağlı referans gizillerini içeren, videoya özgü gizil verilerle değiştirilmiş pozitif koşullama |
| `negative` | CONDITIONING | Birleştirme gizili, maske ve isteğe bağlı referans gizillerini içeren, videoya özgü gizil verilerle değiştirilmiş negatif koşullama |
