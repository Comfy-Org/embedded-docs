...
|-----------|-----------|----------|-------|-------------|
| `مدل` | MODEL | بله | - | مدلی که پچ مقیاس‌دهی اپسیلون روی آن اعمال خواهد شد. |
| `ضریب مقیاس‌دهی` | FLOAT | خیر | 0.5 - 1.5 | عاملی که نویز پیش‌بینی‌شده با آن مقیاس‌دهی می‌شود. مقدار بیشتر از 1.0 نویز را کاهش می‌دهد، در حالی که مقدار کمتر از 1.0 آن را افزایش می‌دهد (پیش‌فرض: 1.005). |

## خروجی‌ها

| نام خروجی | نوع داده | توضیحات |
|-------------|-----------|-------------|
| `مدل` | MODEL | نسخه پچ‌شده مدل ورودی که تابع مقیاس‌دهی اپسیلون روی فرآیند نمونه‌برداری آن اعمال شده است. |
