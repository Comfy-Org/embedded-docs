...
Le nœud PrimitiveStringMultiline fournit un champ de saisie de texte multiligne pour saisir et transmettre des valeurs de chaîne dans votre flux de travail. Il accepte une saisie de texte avec plusieurs lignes et renvoie la même valeur de chaîne sans modification. Ce nœud est utile lorsque vous devez saisir un contenu texte plus long ou un texte formaté sur plusieurs lignes.
...
| --- | --- | --- |
| `output` | La même valeur de chaîne que celle fournie en entrée | STRING |
