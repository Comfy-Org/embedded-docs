...
|-----------|-----------------|--------|-------|-------------|
| `valeur` | STRING | Oui | N/D | La valeur de texte saisie pouvant s'étendre sur plusieurs lignes |

## Sorties

| Nom de la sortie | Type de données | Description |
|------------------|-----------------|-------------|
| `output` | STRING | La même valeur de chaîne que celle fournie en entrée |
