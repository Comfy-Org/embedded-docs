...
| `histograma` | Um histograma opcional para exibir junto com a curva como referência visual. | HISTOGRAM | Não | N/A |

## Saídas

| Nome da Saída | Descrição | Tipo de Dado |
| --- | --- | --- |
| `curva` | A curva editada após os ajustes realizados na interface do nó. | CURVE |
