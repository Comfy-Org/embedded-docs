...
|-----------|-----------|----------|-------|-------------|
| `image` | IMAGE | نعم | - | صورة الإدخال المراد معالجتها للدقة الفائقة |
...
|-------------|-----------|-------------|
| `controlnet_input` | IMAGE | تمثيل الصورة المشفرة المناسب لمدخلات شبكة التحكم |
| `stage_c` | LATENT | تمثيل كامن مؤقت للمرحلة C من معالجة Stable Cascade |
