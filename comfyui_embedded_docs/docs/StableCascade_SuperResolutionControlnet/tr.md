...
|-----------|-----------|----------|
| `controlnet_input` | IMAGE | Controlnet girdisi için uygun kodlanmış görüntü temsili |
| `stage_c` | LATENT | Stable Cascade işleminin C aşaması için yer tutucu gizil temsil |
