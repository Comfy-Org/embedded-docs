...
|-----------|-----------|----------|-------|-------------|
| `template` | STRING | 예 | 여러 옵션 사용 가능 | PixVerse 비디오 생성에 사용할 템플릿입니다. 사용 가능한 옵션은 PixVerse 시스템의 사전 정의된 템플릿에 해당합니다. |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `pixverse_template` | STRING | 선택한 템플릿 이름에 해당하는 템플릿 ID로, 다른 PixVerse 노드에서 비디오 생성에 사용할 수 있습니다. |
