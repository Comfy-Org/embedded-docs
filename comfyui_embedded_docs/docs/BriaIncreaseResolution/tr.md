...
Bria Increase Resolution, Bria'nın görüntü büyütme API'sini kullanarak bir girdi görüntüsünü 2 kat veya 4 kat büyütür ve orijinal içeriği korur. Görüntüyü yükler, Bria hizmetinde işler ve büyütülmüş sonucu bir görüntü olarak döndürür.
...
- Bria, büyütmeden önce girdi görüntüsünün kısa kenarını en az 224 piksele büyütür. Çok uzun olan görüntüler, daha kare bir şekle kırpılmasını isteyen bir hataya neden olabilir.

## Çıktılar

| Çıktı Adı | Açıklama | Veri Türü |
|-------------|-------------|-----------|
| `IMAGE` | Bria API'si tarafından döndürülen büyütülmüş görüntü. | IMAGE |
