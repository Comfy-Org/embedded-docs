...
| `moderation` | Configurações de moderação. Quando definido como "true", ativa as subopções `visual_input_moderation` e `visual_output_moderation`, ambas com padrão False. | DYNAMIC_COMBO | Sim | "false"<br>"true" |
