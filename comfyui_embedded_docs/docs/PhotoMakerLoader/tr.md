...
|-----------|-----------|---------|--------|----------|
| `photomaker_model_adı` | STRING | Evet | Birden çok seçenek mevcut | Yüklenecek PhotoMaker model dosyasının adı. Mevcut seçenekler, `photomaker` klasöründe bulunan model dosyalarına göre belirlenir. |
