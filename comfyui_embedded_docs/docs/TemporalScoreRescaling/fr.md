...
|------------------|-----------------|-------------|
| `patched_model` | MODEL | Le modèle d'entrée, désormais patché avec la fonction de rééchelonnement temporel des scores appliquée à son processus d'échantillonnage. |
