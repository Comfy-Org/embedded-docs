...
| 字段               | Comfy 数据类型    | 描述                                                                                       |
|-------------------|-------------------|-------------------------------------------------------------------------------------------|
| `model`           | `MODEL`           | 用于修改的基础模型，LoRA 调整将应用于此模型。                                                   |
| `lora_name`       | `COMBO[STRING]`   | 要加载的 LoRA 文件名，指定应用于模型的调整内容。                                                |
| `strength_model`  | `FLOAT`           | 决定 LoRA 调整的强度，数值越高表示修改幅度越大。                                               |

## 输出

| 字段     | 数据类型 | 描述                                                                  |
|---------|-------------|----------------------------------------------------------------------|
| `model` | `MODEL`     | 应用了 LoRA 调整后的修改模型，反映了模型行为或能力上的变化。                               |