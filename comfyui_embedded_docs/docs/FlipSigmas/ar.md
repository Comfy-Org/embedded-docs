...
|--------------|---------------|--------|
| `قيم_السيغما`     | `SIGMAS`      | تمثل المعلمة `sigmas` تسلسل قيم سيجما المراد عكسها. يُعد هذا التسلسل حاسمًا للتحكم في مستويات الضوضاء المطبقة أثناء عملية الانتشار، ويكون عكسها أساسيًا لعملية التوليد العكسي. |
