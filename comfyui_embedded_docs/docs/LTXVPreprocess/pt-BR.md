...
| `img_compression` | Quantidade de compressão a ser aplicada na imagem (padrão: 35) | INT | Não | 0-100 |

## Saídas

| Nome da Saída | Descrição | Tipo de Dado |
| --- | --- | --- |
| `output_image` | A imagem de saída processada com a compressão aplicada | IMAGE |
