...
|-----------|-----------|----------|-------|-------------|
| `긍정 조건` | CONDITIONING | 예 | - | 원하는 이미지 특성에 대한 텍스트 프롬프트와 설정을 포함하는 긍정 컨디셔닝 데이터 |
| `부정 조건` | CONDITIONING | 예 | - | 원하지 않는 이미지 특성에 대한 텍스트 프롬프트와 설정을 포함하는 부정 컨디셔닝 데이터 |
| `vae` | VAE | 예 | - | 입력 이미지를 잠재 표현으로 인코딩하는 데 사용되는 VAE 모델 |
| `픽셀` | IMAGE | 예 | - | 처리 및 잠재 공간으로 인코딩될 입력 이미지 |
...
| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `부정 조건` | CONDITIONING | 잠재 이미지 표현이 첨부된 긍정 컨디셔닝 데이터 |
| `잠재 이미지` | CONDITIONING | 잠재 이미지 표현이 첨부된 부정 컨디셔닝 데이터 |
