...
| `negative` | CONDITIONING | Oui | - | Données de conditionnement négatives contenant les prompts texte et les paramètres pour les caractéristiques d'image non souhaitées |
