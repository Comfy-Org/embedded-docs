...
| `négatif` | CONDITIONING | Oui | - | Données de conditionnement négatives contenant les invites textuelles et les paramètres pour les caractéristiques d'image indésirables |
