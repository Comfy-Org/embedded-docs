...
| 参数 | 数据类型 | 是否必填 | 范围 | 描述 |
|-----------|-----------|----------|-------|-------------|
| `positive` | CONDITIONING | 是 | - | 包含文本提示和所需图像特征设置的正向条件数据 |
| `negative` | CONDITIONING | 是 | - | 包含文本提示和不需要图像特征设置的负向条件数据 |
...
| 输出名称 | 数据类型 | 描述 |
|-------------|-----------|-------------|
| `positive` | CONDITIONING | 附加了潜在图像表示的正向条件数据 |
| `negative` | CONDITIONING | 附加了潜在图像表示的负向条件数据 |
