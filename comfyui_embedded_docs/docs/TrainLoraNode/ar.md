...
| --- | --- | --- |
| `lora` | أوزان LoRA المُدرّبة التي يمكن حفظها أو تطبيقها على نماذج أخرى. | LORA_MODEL |
| `خريطة الخسارة` | قاموس يحتوي على قيم خسارة التدريب بمرور الوقت. | LOSS_MAP |
| `الخطوات` | إجمالي عدد خطوات التدريب المُنجزة (بما في ذلك أي خطوات سابقة من LoRA موجود). | INT |
