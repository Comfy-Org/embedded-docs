...
| `hedef_çözünürlük` | STRING | Evet | `"2K"`<br>`"4K"`<br>`"8K"` | Yükseltilmiş görüntü için istenen çıktı çözünürlüğü. |
...
|-----------|-----------|----------|
| `görüntü` | IMAGE | Yükseltilmiş, yüksek çözünürlüklü çıktı görüntüsü. |
