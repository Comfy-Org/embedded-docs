...
|-----------|--------------|-------------|-------|-------------|
| `modelo` | STRING | Sí | `"SeedVR2"`<br>`"Ultimate"` | El modelo de IA a utilizar para la ampliación. "SeedVR2" y "Ultimate" ofrecen diferentes niveles de calidad y precios. |
| `imagen` | IMAGE | Sí | | La imagen de entrada que se va a ampliar. |
| `resolución_objetivo` | STRING | Sí | `"2K"`<br>`"4K"`<br>`"8K"` | La resolución de salida deseada para la imagen ampliada. |
...
|------------------|--------------|-------------|
| `imagen` | IMAGE | La imagen de salida ampliada y de alta resolución. |
