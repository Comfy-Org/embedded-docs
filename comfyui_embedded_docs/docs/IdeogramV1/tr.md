...
|-----------|-----------|----------|--------|----------|
| `istem` | STRING | Evet | - | Görsel oluşturma için istem (varsayılan: boş) |
...
| `en_boy_oranı` | COMBO | Hayır | "1:1"<br>"16:9"<br>"9:16"<br>"4:3"<br>"3:4"<br>"3:2"<br>"2:3" | Görsel oluşturma için en-boy oranı (varsayılan: "1:1") |
...
| `negatif_istem` | STRING | Hayır | - | Görselden çıkarılacak öğelerin açıklaması (varsayılan: boş) |
