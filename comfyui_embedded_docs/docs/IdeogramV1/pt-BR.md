...
| `turbo` | BOOLEAN | Sim | - | Se deve usar o modo turbo (geração mais rápida, qualidade potencialmente inferior) (padrão: False) |
...
| `seed` | INT | Não | 0-2147483647 | Valor de semente aleatório para a geração (padrão: 0) |
| `negative_prompt` | STRING | Não | - | Descrição do que deve ser excluído da imagem (padrão: vazio) |
