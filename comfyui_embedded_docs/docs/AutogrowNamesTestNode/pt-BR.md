...
|-----------|--------------|-------------|-------|-----------|
| `autogrow` | FLOAT | Sim | N/A | Um grupo de entrada dinâmico. Você pode adicionar várias entradas float, cada uma com um nome predefinido da lista: "a", "b" ou "c". O nó aceitará qualquer combinação dessas entradas nomeadas. |
