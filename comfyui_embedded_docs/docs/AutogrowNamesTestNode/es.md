...
|-----------|--------------|-------------|-------|-------------|
| `autogrow` | FLOAT | Sí | N/A | Un grupo de entrada dinámico. Puedes agregar múltiples entradas float, cada una con un nombre predefinido de la lista: "a", "b" o "c". El nodo aceptará cualquier combinación de estas entradas nombradas. |
...
|------------------|--------------|-------------|
| `output` | STRING | Una sola cadena de texto que contiene los valores de todas las entradas float proporcionadas, unidos con comas. |
