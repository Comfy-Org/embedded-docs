...
|-----------|-------------|-------------|
| `model1`  | `MODEL`     | El primer modelo a fusionar. Sirve como modelo base sobre el cual se aplican los parches del segundo modelo. |
| `model2`  | `MODEL`     | El segundo modelo del cual se extraen y aplican parches al primer modelo, según las proporciones de mezcla especificadas. |
