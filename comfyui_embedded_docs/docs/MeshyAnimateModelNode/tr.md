...
|-----------|-----------|----------|-------|-------------|
| `rig_task_id` | STRING | Evet | Yok | Daha önce tamamlanmış bir Meshy karakter iskeletlendirme işlemine ait benzersiz görev kimliği. |
| `action_id` | INT | Evet | 0 ile 696 | Uygulanacak animasyon eyleminin kimlik numarası. Mevcut değerlerin listesi için <https://docs.meshy.ai/en/api/animation-library> adresini ziyaret edin. (varsayılan: 0) |
