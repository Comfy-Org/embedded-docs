...
| `estado_del_editor` | Dibuje cuadros delimitadores y establezca el tipo, texto, descripción y paleta de colores de cada cuadro. Comience con el elemento de fondo primero y el de primer plano al final. | BOUNDING_BOXES | Sí | - |
...
| `elementos` | Un arreglo estructurado de objetos de elemento, cada uno con tipo, coordenadas del cuadro delimitador (normalizadas de 0 a 1000), texto (para tipo de texto), descripción y paleta de colores. | ARRAY |
