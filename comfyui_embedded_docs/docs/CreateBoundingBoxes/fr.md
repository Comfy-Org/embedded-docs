...
| `état_éditeur` | Dessinez les boîtes englobantes et définissez le type, le texte, la description et la palette de couleurs de chaque boîte. Commencez par l'élément d'arrière-plan et terminez par le premier plan. | BOUNDING_BOXES | Oui | - |
...
| `éléments` | Un tableau structuré d'objets d'éléments, chacun contenant le type, les coordonnées de la boîte englobante (normalisées 0-1000), le texte (pour le type texte), la description et la palette de couleurs. | ARRAY |
