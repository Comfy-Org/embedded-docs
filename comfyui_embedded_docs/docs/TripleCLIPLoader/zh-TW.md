...
| 參數 | 資料類型 | 必要 | 範圍 | 說明 |
|-----------|-----------|----------|-------|-------------|
| `clip_name1` | STRING | 是 | 提供多種選項 | 從可用的文字編碼器中載入的第一個文字編碼器模型 |
| `clip_name2` | STRING | 是 | 提供多種選項 | 從可用的文字編碼器中載入的第二個文字編碼器模型 |
| `clip_name3` | STRING | 是 | 提供多種選項 | 從可用的文字編碼器中載入的第三個文字編碼器模型 |
