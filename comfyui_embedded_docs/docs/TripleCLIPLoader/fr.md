...
TripleCLIPLoader charge trois modèles d’encodeur de texte en même temps et les combine en un seul modèle CLIP. Il est utilisé pour les workflows qui nécessitent plusieurs encodeurs de texte fonctionnant ensemble, comme SD3, qui utilise les modèles clip-l, clip-g et t5.

Une recette courante pour SD3 est : clip-l, clip-g, t5.
