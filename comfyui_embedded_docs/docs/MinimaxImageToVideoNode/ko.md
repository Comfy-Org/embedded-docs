...
|-----------|-----------|----------|-------|-------------|
| `이미지` | IMAGE | 예 | - | 동영상 생성의 첫 번째 프레임으로 사용할 이미지 |
| `프롬프트 텍스트` | STRING | 예 | - | 동영상 생성을 안내하는 텍스트 프롬프트 (기본값: 빈 문자열) |
| `모델` | COMBO | 예 | "I2V-01-Director"<br>"I2V-01"<br>"I2V-01-live" | 동영상 생성에 사용할 모델 (기본값: "I2V-01") |
| `시드` | INT | 아니요 | 0 ~ 18446744073709551615 | 노이즈 생성에 사용되는 난수 시드 (기본값: 0) |
