...
| --- | --- | --- | --- | --- |
| `amostras` | A representação latente a ser dividida e organizada em lote. | LATENT | Sim | - |
...
| `tamanho_do_fatiamento` | O tamanho de cada fatia a ser cortada da dimensão especificada. Se o tamanho da dimensão não for perfeitamente divisível por este valor, o restante é descartado. (padrão: 1) | INT | Sim | 1 a 16384 (resolução máxima) |
