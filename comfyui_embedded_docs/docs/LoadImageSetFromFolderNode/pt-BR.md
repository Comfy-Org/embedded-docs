...
|-----------|--------------|-------------|-------|-----------|
| `folder` | STRING | Sim | Múltiplas opções disponíveis | A pasta de onde carregar as imagens. |
| `resize_method` | STRING | Não | "Nenhum"<br>"Esticar"<br>"Cortar"<br>"Preencher" | O método a ser usado para redimensionar as imagens (padrão: "Nenhum"). |
