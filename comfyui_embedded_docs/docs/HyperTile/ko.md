...
| `tile_size` | INT | 아니오 | 1-2048 | 처리에 사용할 목표 타일 크기 (기본값: 256) |
| `swap_size` | INT | 아니오 | 1-128 | 처리 중 타일 재배열 방식을 제어합니다 (기본값: 2) |
| `max_depth` | INT | 아니오 | 0-10 | 타일링을 적용할 최대 깊이 수준 (기본값: 0) |
| `scale_depth` | BOOLEAN | 아니오 | - | 깊이 수준에 따라 타일 크기를 스케일링할지 여부 (기본값: False) |
