...
|------------------|-----------------|-------------|
| `CONDITIONING` | CONDITIONING | Sortie conditionnelle raffinée contenant l'encodage intégré de la sémantique du texte, des normes esthétiques et des informations dimensionnelles, spécifiquement conçue pour guider le modèle SDXL Refiner dans un raffinement précis de l'image |
