...
|-----------|-----------|----------|-------|-------------|
| `модель1` | MODEL | Да | - | Базовая модель для слияния |
| `модель2` | MODEL | Да | - | Вторичная модель для слияния с базовой моделью |
| `pos_embedder.` | FLOAT | Да | 0.0 - 1.0 | Вес смешивания эмбеддера позиций (по умолчанию: 1.0) |
