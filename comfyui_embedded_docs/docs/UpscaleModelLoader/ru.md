...
|---------------|--------------------|---------------------------------------------------------------------------------|
| `model_name`  | `COMBO[STRING]`    | Определяет имя загружаемой модели повышения разрешения, идентифицируя и извлекая правильный файл модели из директории моделей апскейлинга. |
