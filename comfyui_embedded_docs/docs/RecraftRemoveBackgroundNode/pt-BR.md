...
Este nó remove o fundo de imagens usando o serviço Recraft API. Ele processa cada imagem no lote de entrada individualmente e retorna tanto as imagens processadas com fundos transparentes quanto as máscaras alfa correspondentes que indicam as áreas de fundo removidas.
...
| `mask` | Máscaras do canal alfa que indicam as áreas de fundo removidas, no formato B,H,W | MASK |
