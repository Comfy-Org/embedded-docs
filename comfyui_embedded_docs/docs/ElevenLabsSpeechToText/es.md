...
| `modelo` | COMBO | Sí | `"scribe_v2"` | Modelo a utilizar para la transcripción. Al seleccionar este modelo se revelan parámetros adicionales. |
...
| `código_de_idioma` | STRING | No | - | Código de idioma ISO-639-1 o ISO-639-3 (ej. 'en', 'es', 'fra'). Déjelo vacío para detección automática. (predeterminado: "") |
| `número_de_hablantes` | INT | No | 0 - 32 | Número máximo de hablantes a predecir. Establezca en 0 para detección automática. (predeterminado: 0) |
...
|------------------|--------------|-------------|
| `código_de_idioma` | STRING | El texto transcrito del audio. |
| `palabras_json` | STRING | El código de idioma detectado del audio. |
