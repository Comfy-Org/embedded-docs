...
| `invite` | STRING | Oui | - | Instruction textuelle décrivant la modification d'image souhaitée (prend en charge les entrées multilignes et les instructions dynamiques) |
...
|------------------|-----------------|-------------|
| `CONDITIONING` | CONDITIONING | Données de conditionnement encodées contenant les tokens textuels et les latents de référence optionnels pour la génération d'images |
