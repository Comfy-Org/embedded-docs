...
| `پرامپت` | STRING | بله | - | دستور متنی توصیف‌کننده تغییر مورد نظر در تصویر (پشتیبانی از ورودی چندخطی و پرامپت‌های پویا) |
| `vae` | VAE | خیر | - | مدل VAE اختیاری برای تولید لیتنت‌های مرجع از تصاویر ورودی |
| `تصویر ۱` | IMAGE | خیر | - | اولین تصویر ورودی اختیاری برای تحلیل و تغییر |
| `تصویر ۲` | IMAGE | خیر | - | دومین تصویر ورودی اختیاری برای تحلیل و تغییر |
| `تصویر ۳` | IMAGE | خیر | - | سومین تصویر ورودی اختیاری برای تحلیل و تغییر |
