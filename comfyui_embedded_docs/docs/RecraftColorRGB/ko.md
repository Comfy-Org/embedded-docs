...
|-----------|-----------|----------|-------|-------------|
| `r` | INT | 예 | 0-255 | 색상의 빨간색 값(기본값: 0) |
| `g` | INT | 예 | 0-255 | 색상의 녹색 값(기본값: 0) |
| `b` | INT | 예 | 0-255 | 색상의 파란색 값(기본값: 0) |
| `recraft_color` | COLOR | 아니요 | - | 새 RGB 색상으로 확장할 선택적 기존 Recraft 색상 체인 |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `recraft_color` | COLOR | 지정된 RGB 값을 포함하여 생성된 Recraft 색상 객체, 또는 기존 색상 체인이 제공된 경우 확장된 색상 체인 |
