...
| `لون إعادة الصياغة` | COLOR | لا | - | سلسلة ألوان Recraft موجودة اختياريًا لتمديدها باللون RGB الجديد |

## المخرجات

| اسم المخرج | نوع البيانات | الوصف |
|-------------|-----------|-------------|
| `لون إعادة الصياغة` | COLOR | كائن لون Recraft الذي تم إنشاؤه والذي يحتوي على قيم RGB المحددة، أو سلسلة الألوان الممتدة إذا تم توفير سلسلة موجودة |
