...
|-----------|-----------|----------|-------|-------------|
| `r` | INT | نعم | 0-255 | قيمة اللون الأحمر (الافتراضي: 0) |
| `g` | INT | نعم | 0-255 | قيمة اللون الأخضر (الافتراضي: 0) |
| `b` | INT | نعم | 0-255 | قيمة اللون الأزرق (الافتراضي: 0) |
| `recraft_color` | COLOR | لا | - | سلسلة ألوان Recraft موجودة اختياريًا لتمديدها باللون RGB الجديد |

## المخرجات

| اسم المخرج | نوع البيانات | الوصف |
|-------------|-----------|-------------|
| `recraft_color` | COLOR | كائن لون Recraft الذي تم إنشاؤه والذي يحتوي على قيم RGB المحددة، أو سلسلة الألوان الممتدة إذا تم توفير سلسلة موجودة |
