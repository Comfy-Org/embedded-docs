...
|-----------|-----------|------------|---------|-------|-------------|
| `hooks_A` | HOOKS | 선택 사항 | None | - | 결합할 첫 번째 후크 그룹 |
| `hooks_B` | HOOKS | 선택 사항 | None | - | 결합할 두 번째 후크 그룹 |
| `hooks_C` | HOOKS | 선택 사항 | None | - | 결합할 세 번째 후크 그룹 |
| `hooks_D` | HOOKS | 선택 사항 | None | - | 결합할 네 번째 후크 그룹 |
...
| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `HOOKS` | HOOKS | 제공된 모든 후크 구성을 포함하는 결합된 후크 그룹 |
