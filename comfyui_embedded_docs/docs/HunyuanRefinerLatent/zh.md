...
| 参数 | 数据类型 | 是否必填 | 范围 | 描述 |
|-----------|-----------|----------|-------|-------------|
| `positive` | CONDITIONING | 是 | - | 待处理的正向 conditioning 输入 |
| `negative` | CONDITIONING | 是 | - | 待处理的负向 conditioning 输入 |
...
| 输出名称 | 数据类型 | 描述 |
|-------------|-----------|-------------|
| `positive` | CONDITIONING | 经过噪声增强和潜在图像拼接处理后的正向 conditioning |
| `negative` | CONDITIONING | 经过噪声增强和潜在图像拼接处理后的负向 conditioning |
