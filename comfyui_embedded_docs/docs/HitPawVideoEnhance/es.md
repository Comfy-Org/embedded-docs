...
| `resolución` | La resolución objetivo para el video mejorado. Algunas opciones pueden no estar disponibles según el `modelo` seleccionado. | COMBO | Sí | `"original"`<br>`"720p"`<br>`"1080p"`<br>`"2k/qhd"`<br>`"4k/uhd"`<br>`"8k"` |
