...
| `background_color` | Background color for the output video. | COMBO | Yes | `"Black"`<br>`"White"`<br>`"Gray"`<br>`"Red"`<br>`"Green"`<br>`"Blue"`<br>`"Yellow"`<br>`"Cyan"`<br>`"Magenta"`<br>`"Orange"` |
...
|-------------|-------------|-----------|
| `output` | The processed video file with the background removed and replaced by the selected color. The output video is encoded as MP4 with H.264. | VIDEO |
