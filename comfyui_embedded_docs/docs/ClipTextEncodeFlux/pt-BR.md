...
`CLIPTextEncodeFlux` é um nó avançado de codificação de texto projetado para a arquitetura Flux. Ele processa duas entradas de texto separadas por meio de diferentes codificadores — CLIP-L e T5XXL — e as combina com uma escala de orientação para produzir uma saída de condicionamento unificada para a geração de imagens.

## Entradas

| Parâmetro | Descrição | Tipo de Dados | Obrigatório | Intervalo |
| --- | --- | --- | --- | --- |
| `clip` | Um modelo CLIP compatível com a arquitetura Flux, incluindo os codificadores CLIP-L e T5XXL. | CLIP | Sim | - |
...
| `orientação` | Controla a influência das condições de texto no processo de geração. Valores mais altos significam adesão mais rigorosa ao texto. Padrão: 3.5. Ajustável em incrementos de 0.1. | FLOAT | Sim | 0.0 - 100.0 |
