...
| `start_frame` | IMAGE | Sí | - | La imagen que servirá como primer fotograma del video generado. La imagen debe tener al menos 300x300 píxeles y una relación de aspecto entre 1:2.5 y 2.5:1. |
...
| `generate_audio` | BOOLEAN | No | - | Cuando está habilitado, el nodo generará audio para acompañar el video. Cuando está deshabilitado, el video será silencioso. (valor predeterminado: True) |
