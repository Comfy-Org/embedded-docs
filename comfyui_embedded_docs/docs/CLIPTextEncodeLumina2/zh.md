...
|-----------|-----------|----------|-------|-------------|
| `system_prompt` | STRING | 是 | `"superior"`<br>`"alignment"` | Lumina2 提供两种系统提示词："superior" 生成具有卓越图文对齐效果的图像；"alignment" 生成具有最高图文对齐程度的高质量图像。 |
| `user_prompt` | STRING | 是 | 无 | 需要编码的文本。支持多行输入和动态提示词。 |
