...
|-----------|-----------|----------|-------|-------------|
| `folder_name` | STRING | Evet | Yok | ComfyUI çıktı dizini içinde bulunan, kaydedilmiş veri kümesini içeren klasörün adı (varsayılan: "training_dataset"). |

## Çıkışlar

| Çıkış Adı | Veri Türü | Açıklama |
|-------------|-----------|-------------|
| `latents` | LATENT | Her bir sözlüğün `"samples"` anahtarına sahip bir tensör içerdiği, gizli sözlüklerin listesi. |
| `conditioning` | CONDITIONING | Her bir iç listenin ilgili bir örnek için koşullandırma verileri içerdiği, koşullandırma listelerinin listesi. |
