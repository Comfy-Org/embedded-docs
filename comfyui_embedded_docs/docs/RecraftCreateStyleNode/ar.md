...
|-----------|-----------|----------|-------|-------------|
| `style` | STRING | نعم | `"realistic_image"`<br>`"digital_illustration"` | النمط الأساسي للصور المولدة. |
| `images` | IMAGE | نعم | من 1 إلى 5 صور | مجموعة من 1 إلى 5 صور مرجعية تُستخدم لإنشاء النمط المخصص. |
...
|-------------|-----------|-------------|
| `style_id` | STRING | المعرف الفريد للنمط المخصص الذي تم إنشاؤه حديثًا. |
