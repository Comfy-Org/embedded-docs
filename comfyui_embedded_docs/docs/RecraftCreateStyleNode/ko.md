...
|-----------|-----------|----------|-------|-------------|
| `style` | STRING | 예 | `"realistic_image"`<br>`"digital_illustration"` | 생성된 이미지의 기본 스타일입니다. |
| `images` | IMAGE | 예 | 1~5개 이미지 | 사용자 정의 스타일을 만드는 데 사용되는 1~5개의 참조 이미지 세트입니다. |
...
| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `style_id` | STRING | 새로 생성된 사용자 정의 스타일의 고유 식별자입니다. |
