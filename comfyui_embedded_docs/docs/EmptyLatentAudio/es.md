...
|-----------|--------------|-------------|-------|-------------|
| `segundos` | FLOAT | Sí | 1.0 - 1000.0 | La duración del audio en segundos (predeterminado: 47.6) |
...
|------------------|--------------|-------------|
| `LATENT` | LATENT | Devuelve un tensor latente vacío para procesamiento de audio con la duración y el tamaño de lote especificados. El tensor tiene una forma de [batch_size, 64, length], donde length se calcula a partir de la duración del audio y la frecuencia de muestreo. |
