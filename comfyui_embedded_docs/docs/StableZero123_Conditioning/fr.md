...
| --- | --- | --- |
| `positive` | Données de conditionnement positives combinant les caractéristiques de l'image et les embeddings de caméra, incluant l'image d'entrée encodée par VAE comme latent à concaténer | CONDITIONING |
| `negative` | Données de conditionnement négatives avec des caractéristiques initialisées à zéro et un latent initialisé à zéro | CONDITIONING |
