...
| `width` | INT | Нет | 16 до MAX_RESOLUTION | Ширина выходного латентного представления (по умолчанию: 256, должна быть кратна 8) |
| `height` | INT | Нет | 16 до MAX_RESOLUTION | Высота выходного латентного представления (по умолчанию: 256, должна быть кратна 8) |
| `batch_size` | INT | Нет | 1 до 4096 | Количество образцов для генерации в пакете (по умолчанию: 1) |
| `elevation` | FLOAT | Нет | -180.0 до 180.0 | Угол места камеры в градусах (по умолчанию: 0.0) |
| `azimuth` | FLOAT | Нет | -180.0 до 180.0 | Угол азимута камеры в градусах (по умолчанию: 0.0) |
