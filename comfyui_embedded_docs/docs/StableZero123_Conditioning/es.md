...
| --- | --- | --- |
| `positivo` | Datos de condicionamiento positivo que combinan características de imagen e incrustaciones de cámara | CONDITIONING |
| `negativo` | Datos de condicionamiento negativo con características inicializadas en cero | CONDITIONING |
| `latente` | Representación latente con dimensiones [batch_size, 4, height//8, width//8] | LATENT |
