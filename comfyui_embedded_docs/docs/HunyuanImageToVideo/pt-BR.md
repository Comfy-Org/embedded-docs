...
- "v1 (concat)": Concatena o latente da imagem com o latente do vídeo e aplica uma máscara para mesclar a imagem ao vídeo
...
Se `start_image` não for fornecido, nenhum condicionamento de orientação é adicionado e o latente é retornado como um bloco simples de zeros.
