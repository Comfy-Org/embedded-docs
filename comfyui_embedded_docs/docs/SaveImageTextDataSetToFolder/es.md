...
| `texts` | STRING | Sí | - | Lista de descripciones de texto a guardar. |
| `folder_name` | STRING | No | - | Nombre de la carpeta donde se guardarán las imágenes (dentro del directorio de salida). (predeterminado: "dataset") |
| `filename_prefix` | STRING | No | - | Prefijo para los nombres de archivo de las imágenes guardadas. (predeterminado: "image") |
