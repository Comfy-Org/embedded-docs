...
| Parâmetro | Tipo de Dado | Descrição |
|-----------|-------------|-------------|
| `latent`  | `LATENT`    | A saída é uma versão modificada das amostras latentes de entrada, com ajustes baseados no comportamento da semente especificado. Ela mantém ou altera o índice do lote para refletir o comportamento da semente escolhido. |