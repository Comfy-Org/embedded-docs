...
|---------------|-----------------|-------------|
| `CONDITIONING` | CONDITIONING | Les données de conditionnement combinées générées à partir des deux invites textuelles, prêtes à être transmises à un modèle Kandinsky 5 pour la génération d'images. |
