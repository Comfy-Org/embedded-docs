...
CLIPTextEncodeKandinsky5 节点为 Kandinsky 5 模型准备文本提示。它接受两个独立的文本输入，使用提供的 CLIP 模型对其进行分词，并将它们组合成单个 conditioning 输出。此输出用于引导图像生成过程。
...
| 输出名称 | 描述 | 数据类型 |
| --- | --- | --- |
| `CONDITIONING` | 由两个文本提示生成的组合 conditioning 数据，可直接输入 Kandinsky 5 模型以生成图像。 | CONDITIONING |
