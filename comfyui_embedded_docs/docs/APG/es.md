...
|-----------|--------------|-------------|-------|-------------|
| `modelo` | MODEL | Sí | - | El modelo de difusión al que se aplicará la guía proyectada adaptativa |
...
| `umbral_norm` | FLOAT | Sí | 0.0 a 50.0 | Normaliza el vector de guía a este valor; la normalización se desactiva con un valor de 0 (predeterminado: 5.0). |
| `momento` | FLOAT | Sí | -5.0 a 1.0 | Controla un promedio móvil de la guía durante la difusión; se desactiva con un valor de 0 (predeterminado: 0.0). |

## Salidas

| Nombre de Salida | Tipo de Dato | Descripción |
|------------------|--------------|-------------|
| `modelo` | MODEL | Devuelve el modelo modificado con guía proyectada adaptativa aplicada a su proceso de muestreo |
