...
| `graine` | Seed pour déterminer si le nœud doit se relancer ; les résultats réels sont non déterministes, quelle que soit la seed (défaut : 0). | INT | Oui | 0 à 2147483647 |
