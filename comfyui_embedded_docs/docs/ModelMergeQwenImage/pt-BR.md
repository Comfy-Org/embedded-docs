...
| `pos_embeds.` | FLOAT | Sim | 0.0 a 1.0 | Peso para mesclagem de embeddings posicionais (padrão: 1.0) |
| `img_in.` | FLOAT | Sim | 0.0 a 1.0 | Peso para mesclagem do processamento de entrada de imagem (padrão: 1.0) |
| `txt_norm.` | FLOAT | Sim | 0.0 a 1.0 | Peso para mesclagem da normalização de texto (padrão: 1.0) |
| `txt_in.` | FLOAT | Sim | 0.0 a 1.0 | Peso para mesclagem do processamento de entrada de texto (padrão: 1.0) |
| `time_text_embed.` | FLOAT | Sim | 0.0 a 1.0 | Peso para mesclagem de embeddings de tempo e texto (padrão: 1.0) |
| `transformer_blocks.0.` a `transformer_blocks.59.` | FLOAT | Sim | 0.0 a 1.0 | Peso para mesclagem de cada bloco transformador (padrão: 1.0) |
| `proj_out.` | FLOAT | Sim | 0.0 a 1.0 | Peso para mesclagem da projeção de saída (padrão: 1.0) |

## Saídas

| Nome da Saída | Tipo de Dado | Descrição |
|-------------|-----------|-------------|
| `model` | MODEL | O modelo mesclado combinando componentes de ambos os modelos de entrada com os pesos especificados |
