...
| `model` | COMBO | Oui | `"Nano Banana 2 (Gemini 3.1 Flash Image)"` | Sélectionne le modèle Gemini à utiliser pour la génération d'images. Une seule option est actuellement disponible. |
