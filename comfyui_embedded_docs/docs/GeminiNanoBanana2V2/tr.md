...
| `temperature` | Üretimdeki rastgeleliği kontrol eder. Düşük değerler daha odaklı/deterministik sonuçlar verir. (varsayılan: 1.0) Gelişmiş parametre. | FLOAT | Hayır | 0.0 ile 2.0 arası (adım 0.01) |
| `top_p` | Çekirdek örnekleme eşiği. Düşük değerler daha odaklı, yüksek değerler daha çeşitlidir. (varsayılan: 0.95) Gelişmiş parametre. | FLOAT | Hayır | 0.0 ile 1.0 arası (adım 0.01) |
...
| Parametre | Açıklama | Veri Türü | Gerekli | Aralık |
|-----------|-------------|-----------|----------|-------|
| `images` | İsteğe bağlı referans görüntüleri. Toplam 14 görüntüye kadar. Genişletilebilir yuva: `image_1` ile `image_14` arasını bağlayın. | IMAGE | Hayır | 0 ile 14 görsel arası |
