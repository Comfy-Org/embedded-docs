...
| `system_prompt` | Foundational instructions that dictate an AI's behavior. If left empty, a built-in prompt instructing the model to always produce an image is used. Advanced parameter. | STRING | No | N/A |
