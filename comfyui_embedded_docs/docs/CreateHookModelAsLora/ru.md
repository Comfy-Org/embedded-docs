...
|----------|------------|--------------|----------|----------|
| `название_ckpt` | STRING | Да | Доступно несколько вариантов | Файл контрольной точки для загрузки весов (выберите из доступных контрольных точек) |
| `сила_модели` | FLOAT | Да | от -20.0 до 20.0 | Множитель силы, применяемый к весам модели (по умолчанию: 1.0) |
| `сила_клипа` | FLOAT | Да | от -20.0 до 20.0 | Множитель силы, применяемый к весам CLIP (по умолчанию: 1.0) |
| `предыдущие_хуки` | HOOKS | Нет | - | Необязательные предыдущие перехватчики для объединения с вновь созданными перехватчиками LoRA |
...
|------------|------------|----------|
| `HOOKS` | HOOKS | Созданные перехватчики LoRA, объединенные с любыми предыдущими перехватчиками (если они были предоставлены) |
