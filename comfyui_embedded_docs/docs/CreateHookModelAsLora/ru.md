...
|-----------|-----------|----------|-------|-------------|
| `ckpt_name` | COMBO | Да | Доступно несколько вариантов | Файл контрольной точки, из которого загружаются веса (выберите из доступных контрольных точек) |
| `strength_model` | FLOAT | Да | -20.0 до 20.0 | Множитель силы, применяемый к весам модели (по умолчанию: 1.0) |
| `strength_clip` | FLOAT | Да | -20.0 до 20.0 | Множитель силы, применяемый к весам CLIP (по умолчанию: 1.0) |
| `prev_hooks` | HOOKS | Нет | - | Опциональные предыдущие хуки для комбинирования с вновь созданными LoRA-хуками |
