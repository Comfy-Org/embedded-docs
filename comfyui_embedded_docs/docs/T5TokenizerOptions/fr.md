...
| `remplissage_min` | Valeur de padding minimale à définir pour tous les types de modèles T5 (défaut : 0) | INT | Oui | 0 à 10000 |
| `longueur_min` | Valeur de longueur minimale à définir pour tous les types de modèles T5 (défaut : 0) | INT | Oui | 0 à 10000 |
