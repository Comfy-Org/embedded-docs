...
| `min_dolgu` | INT | Hayır | 0 ile 10000 | Tüm T5 model türleri için ayarlanacak minimum dolgu değeri (varsayılan: 0) |
| `min_uzunluk` | INT | Hayır | 0 ile 10000 | Tüm T5 model türleri için ayarlanacak minimum uzunluk değeri (varsayılan: 0) |
