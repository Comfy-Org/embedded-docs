...
| `primeiro.` | Taxa de mesclagem para o primeiro bloco de camadas (padrão: 1.0) | FLOAT | Sim | 0.0 a 1.0 (passo: 0.01) |
...
| `último.` | Taxa de mesclagem para o último bloco (padrão: 1.0) | FLOAT | Sim | 0.0 a 1.0 (passo: 0.01) |
