...
|-------|-----------|------------|---------|-------|-------------|
| `model` | MODEL | 必选 | - | - | 用于采样的模型，提供模型采样对象 |
| `steps` | INT | 必选 | 20 | 1-10000 | 生成 sigmas 的采样步数 |
| `alpha` | FLOAT | 必选 | 0.6 | 0.0-50.0 | Beta 调度器的 alpha 参数，控制调度曲线形状 |
| `beta` | FLOAT | 必选 | 0.6 | 0.0-50.0 | Beta 调度器的 beta 参数，控制调度曲线形状 |
