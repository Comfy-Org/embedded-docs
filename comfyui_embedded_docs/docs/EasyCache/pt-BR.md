...
O nó EasyCache adiciona um sistema de cache nativo a um modelo de difusão que acelera a amostragem ao reutilizar resultados de etapas calculadas anteriormente, em vez de recalcular cada etapa. Ele é ativado somente entre pontos inicial e final configuráveis do processo de amostragem e pula etapas quando a mudança estimada na saída permanece abaixo de um limite definido pelo usuário. Este é um nó experimental destinado ao uso avançado de depuração.
