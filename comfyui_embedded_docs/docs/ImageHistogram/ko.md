...
|-----------|-----------|----------|-------|-------------|
| `image` | IMAGE | 예 | 해당 없음 | 분석할 입력 이미지입니다. 노드는 배치(batch) 내 첫 번째 이미지를 처리합니다. |
...
| `luminance` | HISTOGRAM | ITU-R BT.709 표준 휘도 공식을 사용하여 계산된 이미지의 인지적 밝기에 대한 히스토그램입니다. |
| `red` | HISTOGRAM | 빨간색 채널의 픽셀 강도 분포를 보여주는 히스토그램입니다. |
| `green` | HISTOGRAM | 녹색 채널의 픽셀 강도 분포를 보여주는 히스토그램입니다. |
