...
| `rouge` | Un histogramme montrant la distribution des intensités des pixels dans le canal de couleur rouge. | HISTOGRAM |
| `vert` | Un histogramme montrant la distribution des intensités des pixels dans le canal de couleur vert. | HISTOGRAM |
| `bleu` | Un histogramme montrant la distribution des intensités des pixels dans le canal de couleur bleu. | HISTOGRAM |
