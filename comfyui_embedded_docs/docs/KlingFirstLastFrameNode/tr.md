...
| `süre` | INT | Hayır | 3 ile 15 | Videonun saniye cinsinden uzunluğu (varsayılan: 5). |
| `ilk_kare` | IMAGE | Evet | Yok | Video için başlangıç görseli. En az 300x300 piksel olmalı ve en boy oranı 1:2,5 ile 2,5:1 arasında olmalıdır. |
| `son_kare` | IMAGE | Evet | Yok | Video için bitiş görseli. En az 300x300 piksel olmalı ve en boy oranı 1:2,5 ile 2,5:1 arasında olmalıdır. |
| `ses_oluştur` | BOOLEAN | Hayır | Yok | Video için ses oluşturulup oluşturulmayacağını kontrol eder (varsayılan: True). |
