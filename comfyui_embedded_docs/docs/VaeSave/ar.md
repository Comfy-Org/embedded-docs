...
|-----------|-------------|-------------|
| `vae`     | VAE       | نموذج التشفير التلقائي المتغير (VAE) المراد حفظه. هذا المعامل أساسي لأنه يمثل النموذج الذي سيتم تسلسل حالته وتخزينها. |
| `filename_prefix` | STRING   | بادئة لاسم الملف الذي سيتم حفظ النموذج وبياناته الوصفية تحته. يتيح ذلك تخزينًا منظمًا وسهولة استرجاع النماذج. |
