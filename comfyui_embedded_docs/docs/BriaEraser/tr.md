...
Bria Eraser, Bria API'sini kullanarak bir görüntüden nesneleri veya alanları kaldırır. Silinecek bölgeleri belirten bir görüntü ve bir maske sağlarsınız; düğüm her ikisini de Bria'ya yükler, silme işini çalıştırır, tamamlanmasını bekler ve maskelenen alanların silindiği düzenlenmiş görüntüyü döndürür.
...
| `mask` | Beyaz alanlar silinir, siyah alanlar korunur. Maske gönderilmeden önce ikili hale getirilir, bu nedenle kısmen boyanmış alanlar beyaz olarak sayılır. Görüntüyle aynı en-boy oranına sahip olmalıdır. | MASK | Evet | - |
