...
|-----------|-----------|----------|-------|-------------|
| `지속 시간` | FLOAT | 예 | 0.0 ~ 1.8446744073709552e+19 | 빈 오디오 클립의 길이(초 단위, 기본값: 60.0) |
| `샘플링 레이트` | INT | 예 | 1 ~ 192000 | 빈 오디오 클립의 샘플 레이트(기본값: 44100) |
| `채널` | INT | 예 | 1 ~ 2 | 오디오 채널 수(1은 모노, 2는 스테레오, 기본값: 2) |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `AUDIO` | AUDIO | 파형 데이터와 샘플 레이트 정보를 포함하여 생성된 무음 오디오 클립 |
