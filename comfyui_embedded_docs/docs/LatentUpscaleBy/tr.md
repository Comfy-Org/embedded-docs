...
|---------------|--------------|-------------|
| `samples`     | `LATENT`     | Büyütülecek görüntülerin gizli temsili. Bu parametre, büyütme işlemine tabi tutulacak girdi verisini belirlemede çok önemlidir. |
...
| `scale_by`    | `FLOAT`      | Gizli örneklerin hangi faktörle ölçekleneceğini belirler. Bu parametre, çıktının çözünürlüğünü doğrudan etkileyerek büyütme süreci üzerinde hassas kontrol sağlar. |
