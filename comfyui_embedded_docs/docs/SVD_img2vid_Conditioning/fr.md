...
| `augmentation_level` | FLOAT | Oui | 0,0 à 10,0 | Niveau d'augmentation du bruit à appliquer à l'image d'entrée (par défaut : 0,0, pas : 0,01) |
...
| `negative` | CONDITIONING | Données de conditionnement négatives avec des embeddings et paramètres vidéo mis à zéro |
