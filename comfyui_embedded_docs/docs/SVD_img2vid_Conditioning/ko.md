...
| `video_frames` | INT | 예 | 1부터 4096까지 | 비디오에서 생성할 프레임 수 (기본값: 14) |
...
| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `positive` | CONDITIONING | 이미지 임베딩과 비디오 매개변수를 포함하는 긍정적 조건화 데이터 |
| `negative` | CONDITIONING | 영점 처리된 임베딩과 비디오 매개변수를 가진 부정적 조건화 데이터 |
