...
|-----------|--------------|-------------|-------|-------------|
| `imagen` | IMAGE | Sí | - | Imagen de referencia del avatar. El ancho y alto deben ser de al menos 300 px. La relación de aspecto debe estar entre 1:2.5 y 2.5:1. |
| `archivo_de_audio` | AUDIO | Sí | - | Entrada de audio. Debe tener una duración de entre 2 y 300 segundos. |
| `modo` | COMBO | Sí | `"std"`<br>`"pro"` | El modo de generación a utilizar. |
...
| `semilla` | INT | Sí | 0 a 2147483647 | La semilla controla si el nodo debe volver a ejecutarse; los resultados no son deterministas independientemente de la semilla. (predeterminado: 0) |
