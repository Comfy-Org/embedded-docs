...
|-----------|-----------------|--------|-------|-------------|
| `image` | IMAGE | Oui | - | Image de référence de l'avatar. La largeur et la hauteur doivent être d'au moins 300 px. Le rapport hauteur/largeur doit être compris entre 1:2,5 et 2,5:1. |
...
| `prompt` | STRING | Non | - | Invite facultative pour définir les actions, les émotions et les mouvements de caméra de l'avatar. (par défaut : chaîne vide) |
...
|------------------|-----------------|-------------|
| `output` | VIDEO | La vidéo d'humain numérique générée. |
