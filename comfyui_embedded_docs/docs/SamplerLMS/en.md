...
| --- | --- | --- | --- | --- |
| `order` | The order parameter for the LMS sampler algorithm, which controls the numerical method's accuracy and stability (default: 4; advanced parameter) | INT | Yes | 1 to 100 |
