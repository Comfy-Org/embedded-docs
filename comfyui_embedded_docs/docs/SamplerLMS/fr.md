...
|-----------|-----------------|--------|-------|-------------|
| `order` | INT | Oui | 1 à 100 | Le paramètre d'ordre pour l'algorithme de l'échantillonneur LMS, qui contrôle la précision et la stabilité de la méthode numérique (valeur par défaut : 4) |
