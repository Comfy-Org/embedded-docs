...
|-----------|-----------|----------|-------|-------------|
| `samples` | LATENT | 예 | 해당 없음 | 디코딩할 잠재 표현입니다. |
| `audio_vae` | VAE | 예 | 해당 없음 | 잠재 표현 디코딩에 사용되는 오디오 VAE 모델입니다. |
...
| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `Audio` | AUDIO | 디코딩된 오디오 파형과 관련 샘플 레이트입니다. 파형은 입력 잠재 표현과 동일한 장치로 이동된 텐서이며, 샘플 레이트는 오디오 VAE 모델에 의해 결정됩니다. |
