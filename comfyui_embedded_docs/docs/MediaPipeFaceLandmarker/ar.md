...
| --- | --- | --- |
| `face_landmarks` | مخرج منظم يحتوي على نتائج اكتشاف الوجه لكل إطار، بما في ذلك 468 نقطة مرجعية للوجه، ومعاملات تشكيل الوجه ARKit-52، ومصفوفات التحويل، ومجموعات الاتصال لتصور الشبكة. | FACE_LANDMARKS |
