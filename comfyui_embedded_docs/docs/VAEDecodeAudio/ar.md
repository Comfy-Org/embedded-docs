...
|-----------|-------------|-----------|----------|-------|
| `عينات` | العينات الصوتية المُشفَّرة في الفضاء الكامن والتي سيُعاد فك تشفيرها إلى موجة صوتية. إذا كانت العينات تحمل معدل عينات خاصًا بها، فسيُستخدم هذا القيمة للمخرجات. | LATENT | نعم | - |
