...
| `tile_size` | INT | 예 | 64-4096 (단계: 64) | 공간 처리용 각 타일의 크기 (기본값: 512) |
| `overlap` | INT | 예 | 0-4096 (단계: 32) | 인접 타일 간의 겹침 정도 (기본값: 64) |
| `temporal_size` | INT | 예 | 8-4096 (단계: 4) | 비디오 VAE 전용: 한 번에 인코딩할 프레임 수 (기본값: 64) |
| `temporal_overlap` | INT | 예 | 4-4096 (단계: 4) | 비디오 VAE 전용: 겹칠 프레임 수 (기본값: 8) |
