...
O nó EmptyHunyuanImageLatent cria um espaço latente vazio, totalmente zerado, para modelos de geração de imagem Hunyuan. Ele produz um latente inicial vazio usando a largura, a altura e o tamanho do lote fornecidos, que pode então ser passado para nós posteriores no fluxo de trabalho. O tensor latente contém 64 canais, e cada dimensão espacial é igual à dimensão de pixel correspondente dividida por 32.
...
|-------------|-------------|-----------|
| `LATENT` | Um tensor latente vazio com 64 canais e dimensões de altura ÷ 32 por largura ÷ 32, pronto para o processamento de imagem Hunyuan | LATENT |
