# ByteDance Seedream 5.0 Pro Layer Separation (Legacy)
...
| `prompt_optimization` | Prompt-optimization mode: "standard" gives higher quality, "fast" shorter generation time. Default: "standard". | COMBO | No | "standard"<br>"fast" |
