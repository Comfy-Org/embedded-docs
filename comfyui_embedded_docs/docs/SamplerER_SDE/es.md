...
|------------------|--------------|-------------|
| `sampler` | SAMPLER | Un objeto de muestreador configurado que puede utilizarse en el pipeline de muestreo con la configuración de solucionador especificada. |
