...
|-----------|-----------|----------|--------|----------|
| `width` | INT | Evet | 16 ile MAKSİMUM ÇÖZÜNÜRLÜK (adım: 16) | Çıktı gizli görüntüsünün piksel cinsinden genişliği (varsayılan: 1024) |
| `height` | INT | Evet | 16 ile MAKSİMUM ÇÖZÜNÜRLÜK (adım: 16) | Çıktı gizli görüntüsünün piksel cinsinden yüksekliği (varsayılan: 1024) |
| `batch_size` | INT | Evet | 1 ile 4096 | Bir grupta oluşturulacak gizli görüntü sayısı (varsayılan: 1) |
