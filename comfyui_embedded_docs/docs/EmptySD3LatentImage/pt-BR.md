...
| --- | --- | --- | --- | --- |
| `width` | A largura da imagem latente de saída em pixels (padrão: 1024) | INT | Sim | 16 a MAX_RESOLUTION (passo: 16) |
| `height` | A altura da imagem latente de saída em pixels (padrão: 1024) | INT | Sim | 16 a MAX_RESOLUTION (passo: 16) |
...
| --- | --- | --- |
| `LATENT` | Um tensor latente contendo amostras em branco com dimensões compatíveis com SD3. O tensor possui 16 canais e é reduzido espacialmente por um fator de 8 em comparação com a largura e a altura de entrada. | LATENT |
