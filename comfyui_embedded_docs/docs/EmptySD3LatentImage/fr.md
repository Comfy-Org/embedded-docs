...
|---------------|-----------------|-------------|
| `LATENT` | LATENT | Un tenseur latent contenant des échantillons vierges avec des dimensions compatibles SD3. Le tenseur possède 16 canaux et est sous-échantillonné spatialement par un facteur de 8 par rapport à la largeur et à la hauteur d'entrée. |
