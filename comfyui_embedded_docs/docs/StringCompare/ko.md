...
|-----------|-----------|----------|-------|-------------|
| `문자열_a` | STRING | 예 | - | 비교할 첫 번째 문자열 |
| `문자열_b` | STRING | 예 | - | 비교 대상이 되는 두 번째 문자열 |
| `모드` | COMBO | 예 | "Starts With"<br>"Ends With"<br>"Equal" | 사용할 비교 방식 (기본값: "Starts With") |
| `대소문자 구분` | BOOLEAN | 아니요 | - | 비교 시 대소문자 구분 여부 (기본값: true) |
