...
| `clip_vision_output` | CLIP_VISION_OUTPUT | No | - | Salida opcional de CLIP vision para condicionamiento adicional |
| `start_image` | IMAGE | No | - | Imagen inicial opcional para inicializar la generación de video |
