...
| `width` | INT | Да | 16 до MAX_RESOLUTION | Ширина выходного видео (по умолчанию: 832, шаг: 16) |
| `height` | INT | Да | 16 до MAX_RESOLUTION | Высота выходного видео (по умолчанию: 480, шаг: 16) |
...
|-------------|-----------|-------------|
| `positive` | CONDITIONING | Модифицированное позитивное кондиционирование с включенными данными изображения и зрения |
| `negative` | CONDITIONING | Модифицированное негативное кондиционирование с включенными данными изображения и зрения |
