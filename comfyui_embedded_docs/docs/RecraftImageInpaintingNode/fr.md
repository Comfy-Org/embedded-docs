...
| `invite` | STRING | Oui | - | Invite pour la génération d'image (par défaut : chaîne vide, longueur maximale : 1000 caractères) |
...
| `invite négative` | STRING | Non | - | Une description textuelle facultative des éléments indésirables sur une image (par défaut : chaîne vide) |
