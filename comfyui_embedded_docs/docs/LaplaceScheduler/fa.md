...
|---------|----------|--------|--------|---------|
| `گام‌ها` | INT | بله | 1 تا 10000 | تعداد مراحل نمونه‌گیری در برنامه زمانی (پیش‌فرض: 20) |
| `سیگما بیشینه` | FLOAT | بله | 0.0 تا 5000.0 | بیشینه مقدار سیگما در ابتدای برنامه زمانی (پیش‌فرض: 14.614642) |
| `سیگما کمینه` | FLOAT | بله | 0.0 تا 5000.0 | کمینه مقدار سیگما در انتهای برنامه زمانی (پیش‌فرض: 0.0291675) |
| `مو` | FLOAT | بله | 10.0- تا 10.0 | پارامتر میانگین برای توزیع لاپلاس (پیش‌فرض: 0.0) |
| `بتا` | FLOAT | بله | 0.0 تا 10.0 | پارامتر مقیاس برای توزیع لاپلاس (پیش‌فرض: 0.5) |

## خروجی‌ها

| نام خروجی | نوع داده | توضیحات |
|-----------|----------|---------|
| `SIGMAS` | SIGMAS | یک دنباله از مقادیر سیگما بر اساس برنامه زمانی توزیع لاپلاس |
