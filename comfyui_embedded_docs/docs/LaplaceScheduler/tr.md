...
|-----------|-----------|----------|-------|-------------|
| `steps` | INT | Evet | 1 - 10000 | Programdaki örnekleme adımlarının sayısı (varsayılan: 20) |
| `sigma_max` | FLOAT | Evet | 0.0 - 5000.0 | Programın başındaki maksimum sigma değeri (varsayılan: 14.614642) |
