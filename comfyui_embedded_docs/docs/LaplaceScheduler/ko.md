...
|-----------|-----------|----------|-------|-------------|
| `스텝 수` | INT | 예 | 1 ~ 10000 | 스케줄의 샘플링 단계 수입니다 (기본값: 20) |
| `최대 시그마` | FLOAT | 예 | 0.0 ~ 5000.0 | 스케줄 시작 시 최대 시그마 값입니다 (기본값: 14.614642) |
| `최소 시그마` | FLOAT | 예 | 0.0 ~ 5000.0 | 스케줄 종료 시 최소 시그마 값입니다 (기본값: 0.0291675) |
