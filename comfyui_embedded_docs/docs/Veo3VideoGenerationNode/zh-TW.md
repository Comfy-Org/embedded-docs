...
使用 Google 的 Veo 3 API 從文字提示生成影片。此節點支援兩種 Veo 3 模型：veo-3.0-generate-001 和 veo-3.0-fast-generate-001。它擴展了基礎 Veo 節點，加入了 Veo 3 的特定功能，包括音訊生成和固定的 8 秒鐘持續時間。
...
| `duration_seconds` | INT | 否 | 8-8 | 輸出影片的持續時間（單位：秒）（Veo 3 僅支援 8 秒鐘）(預設值: 8) |
