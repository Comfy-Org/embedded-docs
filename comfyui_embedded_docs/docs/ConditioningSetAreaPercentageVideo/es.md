...
|-----------|--------------|-----------------|-------------------|-------|-------------|
| `acondicionamiento` | CONDITIONING | Requerido | - | - | Los datos de condicionamiento a modificar |
...
| `fuerza` | FLOAT | Requerido | 1.0 | 0.0 - 10.0 | El multiplicador de intensidad aplicado al condicionamiento dentro del área definida |

## Salidas

| Nombre de Salida | Tipo de Dato | Descripción |
|------------------|--------------|-------------|
| `acondicionamiento` | CONDITIONING | Los datos de condicionamiento modificados con el área y la configuración de intensidad especificadas aplicadas |
