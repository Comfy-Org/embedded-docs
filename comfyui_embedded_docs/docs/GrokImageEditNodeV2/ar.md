...
|---|---|---|---|---|
| `model` | نموذج Grok للصور الذي سيتم استخدامه. تتغير المعاملات الفرعية الموضحة أدناه اعتمادًا على النموذج المحدد. | DYNAMIC_COMBO | نعم | "grok-imagine-image-2.0"<br>"grok-imagine-image-quality"<br>"grok-imagine-image-pro"<br>"grok-imagine-image" |
| `prompt` | الموجّه النصي المستخدم لإنشاء الصورة. (الافتراضي: "") | STRING | نعم | N/A |
| `seed` | البذرة لتحديد ما إذا كان ينبغي إعادة تشغيل العقدة؛ النتائج الفعلية غير حتمية بغض النظر عن البذرة. (الافتراضي: 0) | INT | نعم | 0 to 2147483647 |
