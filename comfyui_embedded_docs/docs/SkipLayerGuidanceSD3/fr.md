...
| `pourcentage_de_départ` | FLOAT | Oui | 0.0 - 1.0 | Le point de départ de l'application du guidage, exprimé en pourcentage du nombre total d'étapes (par défaut : 0.01) |
| `pourcentage_de_fin` | FLOAT | Oui | 0.0 - 1.0 | Le point d'arrêt de l'application du guidage, exprimé en pourcentage du nombre total d'étapes (par défaut : 0.15) |
