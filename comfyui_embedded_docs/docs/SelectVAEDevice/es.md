...
|------------------|--------------|-------------|
| `vae` | VAE | El modelo VAE, ahora asignado al dispositivo seleccionado. Si el dispositivo solicitado no está disponible o no es válido, el VAE se pasa sin cambios. |
