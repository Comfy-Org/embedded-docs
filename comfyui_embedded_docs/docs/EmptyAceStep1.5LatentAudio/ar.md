...
|---------|--------------|--------|--------|-------|
| `seconds` | FLOAT | نعم | 1.0 - 1000.0 | مدة الصوت المراد توليده بالثواني (القيمة الافتراضية: 120.0). |
| `batch_size` | INT | نعم | 1 - 4096 | عدد الصور الكامنة في الدفعة (القيمة الافتراضية: 1). |

## المخرجات

| اسم المخرج | نوع البيانات | الوصف |
|------------|--------------|-------|
| `LATENT` | LATENT | موتر كامن فارغ يمثل صوتًا صامتًا، مع معرف نوعي "audio". |
