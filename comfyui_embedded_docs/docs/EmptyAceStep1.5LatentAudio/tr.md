...
|-----------|-----------|----------|--------|----------|
| `seconds` | FLOAT | Evet | 1.0 - 1000.0 | Oluşturulacak sesin saniye cinsinden süresi (varsayılan: 120.0). |
| `batch_size` | INT | Evet | 1 - 4096 | Toplu işteki latent görüntü sayısı (varsayılan: 1). |
