...
| `vae` | VAE | 예 | - | 잠재 샘플 디코딩에 사용되는 VAE 모델 |
| `tile_size` | INT | 예 | 64-4096 (단위: 32) | 처리할 각 타일의 크기 (기본값: 512) |
| `overlap` | INT | 예 | 0-4096 (단위: 32) | 인접 타일 간 중첩 정도 (기본값: 64) |
| `temporal_size` | INT | 예 | 8-4096 (단위: 4) | 비디오 VAE에만 사용: 한 번에 디코딩할 프레임 수 (기본값: 64) |
| `temporal_overlap` | INT | 예 | 4-4096 (단위: 4) | 비디오 VAE에만 사용: 중첩할 프레임 수 (기본값: 8) |
