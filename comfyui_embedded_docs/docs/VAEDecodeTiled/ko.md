...
| `overlap` | INT | 예 | 0-4096 (단계: 32) | 인접 타일 간의 오버랩 양 (기본값: 64) |
| `temporal_size` | INT | 예 | 8-4096 (단계: 4) | 비디오 VAE 전용: 한 번에 디코딩할 프레임 수 (기본값: 64) |
| `temporal_overlap` | INT | 예 | 4-4096 (단계: 4) | 비디오 VAE 전용: 오버랩할 프레임 양 (기본값: 8) |
