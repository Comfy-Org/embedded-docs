...
| `temporal_size` | INT | Sí | 8-4096 (paso: 4) | Solo para VAEs de video: Cantidad de fotogramas a decodificar a la vez (predeterminado: 64) |
| `temporal_overlap` | INT | Sí | 4-4096 (paso: 4) | Solo para VAEs de video: Cantidad de fotogramas a superponer (predeterminado: 8) |
