...
|---------|----------|-------|--------|---------|
| `samples` | LATENT | بله | - | بازنمایی نهفته‌ای که باید به تصاویر تبدیل شود |
| `vae` | VAE | بله | - | مدل VAE مورد استفاده برای رمزگشایی نمونه‌های نهفته |
| `tile_size` | INT | بله | 64-4096 (گام: 32) | اندازه هر کاشی برای پردازش (پیش‌فرض: 512) |
| `overlap` | INT | بله | 0-4096 (گام: 32) | میزان هم‌پوشانی بین کاشی‌های مجاور (پیش‌فرض: 64) |
| `temporal_size` | INT | بله | 8-4096 (گام: 4) | فقط برای VAEهای ویدیویی: تعداد فریم‌هایی که در هر بار رمزگشایی می‌شوند (پیش‌فرض: 64) |
| `temporal_overlap` | INT | بله | 4-4096 (گام: 4) | فقط برای VAEهای ویدیویی: تعداد فریم‌های هم‌پوشانی (پیش‌فرض: 8) |
