...
O nó VAEDecodeTiled decodifica representações latentes em imagens usando uma abordagem em blocos para lidar com imagens grandes de forma eficiente. Ele processa a entrada em blocos menores para gerenciar o uso de memória enquanto mantém a qualidade da imagem. O nó também oferece suporte a VAEs de vídeo processando quadros temporais em partes com sobreposição para transições suaves.
