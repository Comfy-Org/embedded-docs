...
| `sigma_maks` | FLOAT       | Maksimum sigma değerini tanımlayarak difüzyon sürecindeki gürültü yoğunluğunun üst sınırını belirler. Uygulanan gürültü seviyelerinin aralığının belirlenmesinde önemli bir rol oynar. |
