...
| `تمويه سيغما` | FLOAT | لا | 0.0 إلى 10.0 | مقدار التمويه المطبق لإنشاء خريطة التوجيه (القيمة الافتراضية: 2.0) |

## المخرجات

| اسم المخرج | نوع البيانات | الوصف |
|-------------|---------------|--------|
| `النموذج` | MODEL | النموذج المعدل مع تطبيق توجيه الانتباه الذاتي |
