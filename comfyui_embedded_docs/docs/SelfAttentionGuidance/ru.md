...
|----------|------------|--------------|----------|----------|
| `модель` | MODEL | Да | - | Диффузионная модель, к которой применяется управление самовниманием |
| `масштаб` | FLOAT | Нет | -2.0 до 5.0 | Сила эффекта управления самовниманием (по умолчанию: 0.5) |
...
|------------|------------|----------|
| `модель` | MODEL | Модифицированная модель с примененным управлением самовниманием |
