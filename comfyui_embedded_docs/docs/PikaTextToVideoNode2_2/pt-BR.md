...
| `negative_prompt` | STRING | Sim | - | Texto descrevendo o que você não deseja que apareça no vídeo gerado |
...
| `aspect_ratio` | FLOAT | Não | 0,4 - 2,5 | Proporção de aspecto (largura / altura) (padrão: 1,7777777777777777) |
