...
|-----------|-----------|----------|-------|-------------|
| `النموذج` | COMBO | نعم | `"stable-audio-2.5"` | نموذج توليد الصوت المستخدم (الافتراضي: "stable-audio-2.5") |
| `المطالبة` | STRING | نعم | - | الوصف النصي المستخدم لتوليد المحتوى الصوتي (الافتراضي: سلسلة فارغة) |
| `المدة` | INT | لا | 1-190 | يتحكم في مدة الصوت المُولّد بالثواني (الافتراضي: 190) |
| `البذرة` | INT | لا | 0-4294967294 | البذرة العشوائية المستخدمة في التوليد (الافتراضي: 0) |
| `الخطوات` | INT | لا | 4-8 | يتحكم في عدد خطوات أخذ العينات (الافتراضي: 8) |
