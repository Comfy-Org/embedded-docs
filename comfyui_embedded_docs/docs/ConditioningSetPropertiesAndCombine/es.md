...
|-----------|--------------|-----------------|-------------------|-------|-------------|
| `cond` | CONDITIONING | Requerido | - | - | Los datos de condicionamiento originales a modificar |
...
| `ganchos` | HOOKS | Opcional | - | - | Funciones hook opcionales para procesamiento personalizado |
