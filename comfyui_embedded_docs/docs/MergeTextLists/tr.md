...
|-----------|-----------|----------|-------|-------------|
| `metinler` | STRING | Evet | N/A | Birleştirilecek metin listeleri. Girişe birden fazla liste bağlanabilir ve bunlar tek bir listede birleştirilir. |
...
|-------------|-----------|-------------|
| `metinler` | STRING | Tüm giriş metinlerini içeren tek bir birleştirilmiş liste. |
