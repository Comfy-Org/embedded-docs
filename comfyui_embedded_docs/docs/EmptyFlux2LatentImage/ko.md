...
|-----------|-----------|----------|-------|-------------|
| `너비` | INT | 예 | 16 ~ 8192 | 생성할 최종 이미지의 너비입니다. 잠재 표현의 너비는 이 값을 16으로 나눈 값이 됩니다. 기본값은 1024입니다. |
| `높이` | INT | 예 | 16 ~ 8192 | 생성할 최종 이미지의 높이입니다. 잠재 표현의 높이는 이 값을 16으로 나눈 값이 됩니다. 기본값은 1024입니다. |
| `배치 크기` | INT | 아니요 | 1 ~ 4096 | 단일 배치에서 생성할 잠재 샘플의 개수입니다. 기본값은 1입니다. |
