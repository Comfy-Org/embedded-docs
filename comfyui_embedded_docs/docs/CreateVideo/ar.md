...
|---------|--------------|--------|--------|-------|
| `images` | IMAGE | نعم | - | الصور المراد إنشاء الفيديو منها. |
| `fps` | FLOAT | نعم | 1.0 - 120.0 | عدد الإطارات في الثانية لسرعة تشغيل الفيديو (القيمة الافتراضية: 30.0). |
| `audio` | AUDIO | لا | - | الصوت المراد إضافته إلى الفيديو. |

## المخرجات

| اسم المخرج | نوع البيانات | الوصف |
|------------|--------------|-------|
| `output` | VIDEO | ملف الفيديو المُنشأ الذي يحتوي على الصور المدخلة والصوت الاختياري. |
