...
|---------|--------------|--------|--------|-------|
| `الصور` | IMAGE | نعم | - | الصور المراد إنشاء الفيديو منها. |
| `الإطارات في الثانية` | FLOAT | نعم | 1.0 - 120.0 | عدد الإطارات في الثانية لسرعة تشغيل الفيديو (القيمة الافتراضية: 30.0). |
