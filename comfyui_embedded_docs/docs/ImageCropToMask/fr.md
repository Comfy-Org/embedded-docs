...
| `width` | Largeur de sortie en pixels. (par défaut : 1024) | INT | Oui | 64 à 4096 (pas de 8) |
| `height` | Hauteur de sortie en pixels. (par défaut : 1024) | INT | Oui | 64 à 4096 (pas de 8) |
...
| `background` | Couleur d’arrière-plan derrière le sujet masqué. (par défaut : #000000) | COLOR | Oui | — |
