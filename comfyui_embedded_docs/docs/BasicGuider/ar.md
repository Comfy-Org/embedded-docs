...
|-----------|-----------|----------|-------|-------------|
| `model` | MODEL | نعم | - | النموذج المراد استخدامه للتوجيه |
| `conditioning` | CONDITIONING | نعم | - | بيانات التكييف التي تُوجّه عملية التوليد |

## المخرجات

| اسم المخرج | نوع البيانات | الوصف |
|-------------|-----------|-------------|
| `GUIDER` | GUIDER | كائن موجه (guider) يمكن استخدامه أثناء عملية أخذ العينات لتوجيه التوليد |
