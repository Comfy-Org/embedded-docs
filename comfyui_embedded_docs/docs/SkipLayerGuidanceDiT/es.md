...
| `capas_dobles` | STRING | Sí | - | Números de capa separados por comas para bloques dobles a omitir (predeterminado: "7, 8, 9") |
| `capas_simples` | STRING | Sí | - | Números de capa separados por comas para bloques individuales a omitir (predeterminado: "7, 8, 9") |
| `escala` | FLOAT | Sí | 0.0 - 10.0 | Factor de escala de guía (predeterminado: 3.0) |
| `porcentaje_inicio` | FLOAT | Sí | 0.0 - 1.0 | Porcentaje inicial para la aplicación de la guía (predeterminado: 0.01) |
| `porcentaje_final` | FLOAT | Sí | 0.0 - 1.0 | Porcentaje final para la aplicación de la guía (predeterminado: 0.15) |
| `escala_reescalado` | FLOAT | Sí | 0.0 - 10.0 | Factor de escala de reescalado para ajustar la magnitud de salida (predeterminado: 0.0, sin reescalado) |
