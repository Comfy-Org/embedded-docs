...
|---------|----------|-------|--------|---------|
| `مدل` | MODEL | بله | - | مدلی که راهنمایی لایه‌پرشده روی آن اعمال می‌شود |
| `لایه‌های دوگانه` | STRING | بله | - | شماره لایه‌های جدا شده با کاما برای بلوک‌های دوبل که باید پرش شوند (پیش‌فرض: "7, 8, 9") |
| `لایه‌های تکی` | STRING | بله | - | شماره لایه‌های جدا شده با کاما برای بلوک‌های تکی که باید پرش شوند (پیش‌فرض: "7, 8, 9") |
| `مقیاس` | FLOAT | بله | 0.0 - 10.0 | ضریب مقیاس راهنمایی (پیش‌فرض: 3.0) |
| `درصد شروع` | FLOAT | بله | 0.0 - 1.0 | درصد شروع برای اعمال راهنمایی (پیش‌فرض: 0.01) |
| `درصد پایان` | FLOAT | بله | 0.0 - 1.0 | درصد پایان برای اعمال راهنمایی (پیش‌فرض: 0.15) |
| `مقیاس بازتنظیم` | FLOAT | بله | 0.0 - 10.0 | ضریب مقیاس بازتنظیم برای تنظیم اندازه خروجی (پیش‌فرض: 0.0، به معنی عدم بازتنظیم) |
...
|-----------|----------|---------|
| `مدل` | MODEL | مدل اصلاح‌شده با راهنمایی لایه‌پرشده اعمال‌شده |
