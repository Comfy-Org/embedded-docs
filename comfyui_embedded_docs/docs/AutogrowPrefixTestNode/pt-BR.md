...
|-----------|--------------|-------------|-------|-----------|
| `autogrow` | AUTOGROW | Sim | 1 a 10 entradas | Um grupo de entrada dinâmico que pode aceitar entre 1 e 10 valores float. Cada entrada no grupo é do tipo FLOAT com valor mínimo de 1 e valor máximo de 10. |
