...
|-----------|--------------|-------------|-------|-------------|
| `autogrow` | AUTOGROW | Sí | 1 a 10 entradas | Un grupo de entrada dinámico que puede aceptar entre 1 y 10 valores flotantes. Cada entrada en el grupo es de tipo FLOAT con un valor mínimo de 1 y un valor máximo de 10. |
...
|------------------|--------------|-------------|
| `output` | STRING | Una sola cadena que contiene todos los valores flotantes de entrada, separados por comas. |
