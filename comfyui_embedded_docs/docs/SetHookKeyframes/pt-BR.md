...
|-----------|--------------|-------------|-------|-----------|
| `hooks` | HOOKS | Sim | - | O grupo de hooks ao qual o agendamento de quadros-chave será aplicado |
| `hook_kf` | HOOK_KEYFRAMES | Não | - | Grupo opcional de quadros-chave contendo informações de temporização para execução dos hooks |

## Saídas

| Nome da Saída | Tipo de Dado | Descrição |
|---------------|--------------|-----------|
| `hooks` | HOOKS | O grupo de hooks modificado com o agendamento de quadros-chave aplicado (clonado se quadros-chave foram fornecidos) |
