...
| `stop_at_clip_layer` | INT | Sim | -24 a -1 | Especifica em qual camada parar. Um valor de -1 usa todas as camadas, enquanto -24 usa apenas a primeira camada (padrão: -1) |
