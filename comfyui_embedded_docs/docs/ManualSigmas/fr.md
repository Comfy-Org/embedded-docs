...
|-----------|-----------------|--------|-------|-------------|
| `sigmas` | STRING | Oui | Nombres séparés par des virgules ou des espaces | Une chaîne contenant les valeurs sigma. Le nœud extrait tous les nombres de cette chaîne. Par exemple, "1, 0.5, 0.1" ou "1 0.5 0.1". La valeur par défaut est "1, 0.5". |
