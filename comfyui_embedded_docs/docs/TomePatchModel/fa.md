...
|---------|----------|--------|--------|---------|
| `model` | MODEL | بله | - | مدل انتشار که ادغام توکن روی آن اعمال می‌شود |
| `ratio` | FLOAT | خیر | 0.0 - 1.0 | نسبت توکن‌هایی که باید ادغام شوند (پیش‌فرض: 0.3) |

## خروجی‌ها

| نام خروجی | نوع داده | توضیحات |
|-----------|----------|---------|
| `model` | MODEL | مدل اصلاح‌شده با ادغام توکن اعمال‌شده |
