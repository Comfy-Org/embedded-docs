...
| `proporção` | A proporção de tokens a fundir (padrão: 0.3). Valores mais altos fundem mais tokens, o que pode proporcionar maior aceleração, mas potencialmente menor qualidade. | FLOAT | Sim | 0.0 - 1.0 |
