...
|-----------|--------------|-------------|-------|-----------|
| `modelo` | MODEL | Sim | - | O modelo de difusão ao qual aplicar a fusão de tokens |
| `proporção` | FLOAT | Não | 0.0 - 1.0 | A proporção de tokens a serem mesclados (padrão: 0.3) |

## Saídas

| Nome da Saída | Tipo de Dado | Descrição |
|---------------|--------------|-----------|
| `modelo` | MODEL | O modelo modificado com a fusão de tokens aplicada |
