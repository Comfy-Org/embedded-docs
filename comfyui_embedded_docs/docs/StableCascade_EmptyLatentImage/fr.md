...
|-----------|-----------------|--------|-------|-------------|
| `width` | INT | Oui | 256 à MAX_RESOLUTION | La largeur de l'image de sortie en pixels (par défaut : 1024, pas : 8) |
| `height` | INT | Oui | 256 à MAX_RESOLUTION | La hauteur de l'image de sortie en pixels (par défaut : 1024, pas : 8) |
...
|---------------|-----------------|-------------|
| `stage_c` | LATENT | Le tenseur latent de l'étape C avec les dimensions [batch_size, 16, hauteur//compression, largeur//compression] |
| `stage_b` | LATENT | Le tenseur latent de l'étape B avec les dimensions [batch_size, 4, hauteur//4, largeur//4] |
