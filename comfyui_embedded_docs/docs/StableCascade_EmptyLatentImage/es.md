...
|-----------|-----------|----------|-------|-------------|
| `width` | INT | Sí | 256 a MAX_RESOLUTION | El ancho de la imagen de salida en píxeles (por defecto: 1024, paso: 8) |
| `height` | INT | Sí | 256 a MAX_RESOLUTION | La altura de la imagen de salida en píxeles (por defecto: 1024, paso: 8) |
| `compression` | INT | Sí | 4 a 128 | El factor de compresión que determina las dimensiones latentes para la etapa C (por defecto: 42, paso: 1) |
...
|-------------|-----------|-------------|
| `stage_c` | LATENT | El tensor latente de etapa C con dimensiones [batch_size, 16, height//compression, width//compression] |
