...
|-----------|--------------|-------------|-------|-------------|
| `width` | INT | Sí | 256 a MAX_RESOLUTION | El ancho de la imagen de salida en píxeles (predeterminado: 1024, incremento: 8) |
| `height` | INT | Sí | 256 a MAX_RESOLUTION | La altura de la imagen de salida en píxeles (predeterminado: 1024, incremento: 8) |
| `compression` | INT | Sí | 4 a 128 | El factor de compresión que determina las dimensiones latentes para la etapa C (predeterminado: 42, incremento: 1) |
...
|------------------|--------------|-------------|
| `stage_c` | LATENT | El tensor latente de la etapa C con dimensiones [batch_size, 16, altura//compresión, ancho//compresión] |
