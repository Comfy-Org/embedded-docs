...
| `compression` | INT | Да | 4 до 128 | Коэффициент сжатия, определяющий латентные размерности для стадии C (по умолчанию: 42, шаг: 1) |
| `batch_size` | INT | Нет | 1 до 4096 | Количество латентных образцов для генерации в пакете (по умолчанию: 1) |

## Выходы

| Имя выхода | Тип данных | Описание |
|-------------|-----------|-------------|
| `stage_c` | LATENT | Латентный тензор стадии C с размерностями [batch_size, 16, height//compression, width//compression] |
