...
| `beta_d`    | FLOAT           | Détermine la distribution globale des niveaux de bruit, influençant la variance des niveaux de bruit générés.                                 |
...
| `eps_s`     | FLOAT           | Ajuste la valeur epsilon de départ, permettant un réglage fin du niveau de bruit initial dans le processus de diffusion.                                    |
