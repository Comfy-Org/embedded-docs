...
| Paramètre | Description | Type Comfy |
| --- | --- | --- |
| `conditioning` | Le conditionnement enrichi ou modifié, intégrant la sortie du modèle de style. Il représente le conditionnement final stylisé, prêt pour un traitement ou une génération ultérieure. | `CONDITIONING` |
