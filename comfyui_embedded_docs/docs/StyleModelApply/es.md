...
| Parámetro | Descripción | Tipo Comfy |
| --- | --- | --- |
| `conditioning` | El condicionamiento mejorado o alterado, que incorpora la salida del modelo de estilo. Representa el condicionamiento final estilizado, listo para su posterior procesamiento o generación. | `CONDITIONING` |
