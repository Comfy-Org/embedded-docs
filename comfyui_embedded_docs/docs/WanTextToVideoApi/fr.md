...
|-----------|-----------------|--------|-------|-------------|
| `model` | COMBO | Oui | "wan2.5-t2v-preview"<br>"wan2.6-t2v" | Modèle à utiliser (par défaut : "wan2.6-t2v") |
| `prompt` | STRING | Oui | - | Prompt décrivant les éléments et les caractéristiques visuelles. Prend en charge l'anglais et le chinois (par défaut : "") |
...
| `duration` | INT | Non | 5-15 (par pas de 5) | Durée de la vidéo en secondes. Une durée de 15 secondes est disponible uniquement pour le modèle Wan 2.6 (par défaut : 5) |
