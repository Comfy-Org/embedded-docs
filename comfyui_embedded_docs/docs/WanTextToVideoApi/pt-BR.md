...
|-----------|--------------|-------------|-------|-----------|
| `model` | COMBO | Sim | "wan2.5-t2v-preview"<br>"wan2.6-t2v" | Modelo a ser utilizado (padrão: "wan2.6-t2v") |
| `prompt` | STRING | Sim | - | Prompt descrevendo os elementos e características visuais. Suporta inglês e chinês (padrão: "") |
| `negative_prompt` | STRING | Não | - | Prompt negativo descrevendo o que deve ser evitado (padrão: "") |
...
| `duration` | INT | Não | 5-15 (em incrementos de 5) | Duração do vídeo em segundos. A duração de 15 segundos está disponível apenas para o modelo Wan 2.6 (padrão: 5) |
