...
| `strength` | L'intensité de l'effet ControlNet (par défaut : 1.0) | FLOAT | Oui | 0.0 - 10.0 |
...
**Remarque :** Lorsque `strength` est défini sur 0, le nœud renvoie les conditionnements positif et négatif inchangés sans appliquer ControlNet.
