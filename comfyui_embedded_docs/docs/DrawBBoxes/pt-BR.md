...
| `bboxes` | BOUNDINGBOX | Sim | - | Uma lista de dicionários de caixas delimitadoras. Cada dicionário deve conter as chaves `x`, `y`, `width`, `height` e, opcionalmente, `label` e `score`. |
