...
|-----------|--------------|-------------|-------|-------------|
| `model` | MODEL | Sí | - | El modelo de difusión al que se le aplicará la configuración de muestreo AuraFlow |
| `shift` | FLOAT | Sí | 0.0 - 100.0 | El valor de desplazamiento que se aplicará a la distribución de muestreo (predeterminado: 1.73) |
