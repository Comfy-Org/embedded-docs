...
| `duration` | COMBO | 是 | `"5"`<br>`"10"` | 视频时长（秒）（默认："5"） |
| `ratio` | COMBO | 是 | `"1024:1024"`<br>`"1280:720"`<br>`"720:1280"`<br>`"1920:1080"`<br>`"1080:1920"`<br>`"2048:1080"`<br>`"1080:2048"` | 生成视频的宽高比（默认："1024:1024"） |
