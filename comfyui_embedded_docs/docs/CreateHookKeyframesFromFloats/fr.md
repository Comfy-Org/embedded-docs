...
|-----------|-----------------|--------|-------|-------------|
| `force_flottants` | FLOATS | Oui | -1 à ∞ | Une seule valeur flottante ou une liste de valeurs flottantes représentant les valeurs de force pour les images clés (par défaut : -1) |
...
| `precedent_crochet_kf` | HOOK_KEYFRAMES | Non | - | Un groupe d'images clés de hook existant auquel ajouter les nouvelles images clés, ou crée un nouveau groupe s'il n'est pas fourni |
...
|---------------|-----------------|-------------|
| `HOOK_KF` | HOOK_KEYFRAMES | Un groupe d'images clés de hook contenant les images clés nouvellement créées, soit en tant que nouveau groupe, soit ajouté au groupe d'images clés d'entrée |
