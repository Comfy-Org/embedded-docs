...
|-----------|-----------------|--------|-------|-------------|
| `floats_strength` | FLOATS | Oui | -1 à ∞ | Une seule valeur flottante ou une liste de valeurs flottantes représentant les valeurs de force pour les images clés (par défaut : -1) |
...
| `prev_hook_kf` | HOOK_KEYFRAMES | Non | - | Un groupe d'images clés de hook existant auquel ajouter les nouvelles images clés, ou crée un nouveau groupe s'il n'est pas fourni |
