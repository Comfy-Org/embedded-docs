...
| `flavor` | The processing style. "sublime" is for general use, "photo" is optimized for photographs, and "photo_denoiser" is for noisy photos. | STRING | Yes | `"sublime"`<br>`"photo"`<br>`"photo_denoiser"` |
