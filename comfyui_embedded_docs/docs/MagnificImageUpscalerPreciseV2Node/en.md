...
| `scale_factor` | The desired upscaling multiplier. | COMBO | Yes | `"2x"`<br>`"4x"`<br>`"8x"`<br>`"16x"` |
| `flavor` | Processing style: sublime for general use, photo for photographs, photo_denoiser for noisy photos. | COMBO | Yes | `"sublime"`<br>`"photo"`<br>`"photo_denoiser"` |
