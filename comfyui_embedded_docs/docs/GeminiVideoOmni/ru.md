...
| `prompt` | Текстовый запрос, описывающий генерируемое видео. После удаления начальных и конечных пробелов должен содержать хотя бы один непробельный символ. | STRING | Да | Минимум 1 символ после удаления пробелов |
