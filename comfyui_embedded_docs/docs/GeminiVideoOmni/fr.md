...
Générer une vidéo avec audio à partir d'une invite textuelle en utilisant le modèle Gemini Omni Flash de Google. Vous pouvez éventuellement fournir des images et/ou vidéos de référence pour guider ou modifier le résultat. Décrivez la durée souhaitée (3 à 10 secondes) et le format d'image (16:9 ou 9:16) directement dans l'invite.
...
| `videos` | Vidéos de référence optionnelles pour guider ou modifier la génération vidéo. Maximum de 3 vidéos, chacune jusqu'à 10 secondes. | VIDEO | Non | Plusieurs vidéos autorisées (max 3, chacune max 10s) |
...
| `STRING` | Toute réponse textuelle du modèle, telle qu'un raisonnement ou des explications. | STRING |
