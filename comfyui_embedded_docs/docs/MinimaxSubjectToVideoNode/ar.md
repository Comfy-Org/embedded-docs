...
|-----------|-----------|----------|-------|-------------|
| `subject` | IMAGE | نعم | - | صورة الموضوع المرجعي لتوليد الفيديو |
| `prompt_text` | STRING | نعم | - | نص وصفي لتوجيه عملية توليد الفيديو (الافتراضي: سلسلة فارغة) |
| `model` | COMBO | لا | "S2V-01" | النموذج المستخدم لتوليد الفيديو (الافتراضي: "S2V-01") |
...
|-------------|-----------|-------------|
| `output` | VIDEO | الفيديو المُنشأ بناءً على صورة الموضوع المدخلة والنص الوصفي |
