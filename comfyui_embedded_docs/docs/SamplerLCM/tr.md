...
|-----------|-----------|----------|--------|----------|
| `s_noise` | FLOAT | Evet | 0,0 ile 64,0 (adım: 0,01) | İlk adımdaki adım başına gürültü çarpanı. 1,0 değeri modelin eğitim gürültü ölçeğiyle eşleşir. (varsayılan: 1,0) |
| `s_noise_end` | FLOAT | Evet | 0,0 ile 64,0 (adım: 0,01) | Son adımdaki adım başına gürültü çarpanı. Sabit bir gürültü programı için `s_noise` ile aynı değere ayarlayın. (varsayılan: 1,0) |
| `noise_clip_std` | FLOAT | Evet | 0,0 ile 10,0 (adım: 0,01) | Adım başına gürültüyü +/- N standart sapma aralığına sıkıştırır. 0 değeri sıkıştırmayı devre dışı bırakır. (varsayılan: 0,0) |

## Çıkışlar

| Çıkış Adı | Veri Türü | Açıklama |
|-----------|-----------|----------|
| `SAMPLER` | SAMPLER | Yapılandırılmış LCM örnekleyici nesnesi, bir örnekleme iş akışında kullanılmaya hazırdır. |
