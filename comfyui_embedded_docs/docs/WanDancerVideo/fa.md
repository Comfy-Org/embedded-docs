...
| --- | --- | --- |
| `positive` | شرطی‌سازی مثبت به‌همراه داده‌های اضافی (لاتنت الحاقی، CLIP Vision، صدا) پیوست‌شده. | CONDITIONING |
| `negative` | شرطی‌سازی منفی به‌همراه داده‌های اضافی (لاتنت الحاقی، CLIP Vision، صدا) پیوست‌شده. | CONDITIONING |
