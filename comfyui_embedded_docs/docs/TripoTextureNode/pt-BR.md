...
| `referência` | Imagens de referência que orientam as texturas. Não podem ser combinadas com `texture_prompt` ou `style_image`. (padrão: "none") | DYNAMIC_COMBO | Não | "none"<br>"image"<br>"multiview" |
