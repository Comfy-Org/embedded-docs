...
| ------------ | ---------- | ---------------------------------------------------------------------------------------- |
| `genişlik`      | `INT`      | Video genişliği, varsayılan 848, minimum 16, maksimum `nodes.MAX_RESOLUTION`, adım boyutu 16. |
| `yükseklik`     | `INT`      | Video yüksekliği, varsayılan 480, minimum 16, maksimum `nodes.MAX_RESOLUTION`, adım boyutu 16. |
| `uzunluk`     | `INT`      | Video uzunluğu, varsayılan 25, minimum 1, maksimum `nodes.MAX_RESOLUTION`, adım boyutu 4.    |
