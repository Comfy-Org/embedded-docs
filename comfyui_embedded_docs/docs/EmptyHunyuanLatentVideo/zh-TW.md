...
| 參數 | Comfy 類型 | 說明 |
| ----------- | ---------- | ------------------------------------------------------------------------------------------ |
| `width` | `INT` | 影片寬度，預設值 848，最小值 16，最大值 `nodes.MAX_RESOLUTION`，步進值 16。 |
| `height` | `INT` | 影片高度，預設值 480，最小值 16，最大值 `nodes.MAX_RESOLUTION`，步進值 16。 |
| `length` | `INT` | 影片長度，預設值 25，最小值 1，最大值 `nodes.MAX_RESOLUTION`，步進值 4。 |
| `batch_size` | `INT` | 批次大小，預設值 1，最小值 1，最大值 4096。 |
