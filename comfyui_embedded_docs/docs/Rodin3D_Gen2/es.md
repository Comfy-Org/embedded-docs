...
|-----------|-----------|----------|-------|-------------|
| `Imágenes` | IMAGE | Sí | - | Imágenes de entrada para usar en la generación del modelo 3D |
| `Semilla` | INT | No | 0-65535 | Valor de semilla aleatoria para la generación (predeterminado: 0) |
| `Tipo_Material` | COMBO | No | "PBR"<br>"Shaded" | Tipo de material a aplicar al modelo 3D (predeterminado: "PBR") |
| `Recuento_Polígonos` | COMBO | No | "4K-Quad"<br>"8K-Quad"<br>"18K-Quad"<br>"50K-Quad"<br>"2K-Triangle"<br>"20K-Triangle"<br>"150K-Triangle"<br>"500K-Triangle" | Recuento de polígonos objetivo para el modelo 3D generado (predeterminado: "500K-Triangle") |
...
|-------------|-----------|-------------|
| `GLB` | STRING | Ruta de archivo al modelo 3D generado (para compatibilidad hacia atrás) |
