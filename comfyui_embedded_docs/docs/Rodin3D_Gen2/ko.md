...
| `Seed` | INT | 아니요 | 0-65535 | 생성을 위한 무작위 시드 값 (기본값: 0) |
| `Material_Type` | COMBO | 아니요 | "PBR"<br>"Shaded" | 3D 모델에 적용할 재질 유형 (기본값: "PBR") |
| `Polygon_count` | COMBO | 아니요 | "4K-Quad"<br>"8K-Quad"<br>"18K-Quad"<br>"50K-Quad"<br>"2K-Triangle"<br>"20K-Triangle"<br>"150K-Triangle"<br>"500K-Triangle" | 생성된 3D 모델의 목표 폴리곤 수 (기본값: "500K-Triangle") |
...
| 출력 이름 | 데이터 유형 | 설명 |
|-------------|-----------|-------------|
| `3D Model Path` | STRING | 생성된 3D 모델의 파일 경로 (하위 호환성 유지) |
