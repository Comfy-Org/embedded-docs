...
El nodo And realiza una operación lógica Y (AND) sobre un conjunto de valores de entrada. Devuelve `true` solo si todos los valores proporcionados se consideran verdaderos según las reglas de veracidad de Python. Este nodo es útil para comprobar que se cumplen múltiples condiciones antes de continuar.

## Entradas

| Parámetro | Descripción | Tipo de dato | Requerido | Rango |
| --- | --- | --- | --- | --- |
| `values` | Una lista ampliable de valores a evaluar. El nodo requiere al menos un valor, y puedes añadir más ranuras haciendo clic en el botón "+" del nodo. Cada ranura acepta cualquier tipo de dato. | ANY | Sí | 1 o más valores |
