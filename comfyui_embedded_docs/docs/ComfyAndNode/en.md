...
| --- | --- | --- | --- | --- |
| `values` | A growable list of values to evaluate. The node requires at least one value, and you can add more slots by clicking the "+" button on the node. Each slot accepts any data type. | ANY | Yes | 1 or more values |
