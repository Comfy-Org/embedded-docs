...
|-----------|-----------|----------|-------|-------------|
| `values` | ANY | Evet | 1 veya daha fazla değer | Değerlendirilecek değerlerin listesi. Düğüm en az bir değer kabul eder ve düğüm üzerindeki "+" düğmesine tıklayarak daha fazla değer ekleyebilirsiniz. |
