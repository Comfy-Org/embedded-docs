...
|--------------|---------------|--------|
| `الصورة`      | `IMAGE`       | المعامل `image` يمثل الصورة المدخلة المراد عكس ألوانها. يعد هذا المعامل حاسمًا لتحديد الصورة المستهدفة التي سيتم عكس ألوانها، مما يؤثر على تنفيذ العقدة والنتيجة البصرية لعملية الانعكاس. |
