...
| `BEFORE_RANGE` | TIMESTEPS_RANGE | 0.0 ile start_percent arasındaki zaman adımı aralığı |
| `AFTER_RANGE` | TIMESTEPS_RANGE | end_percent ile 1.0 arasındaki zaman adımı aralığı |
