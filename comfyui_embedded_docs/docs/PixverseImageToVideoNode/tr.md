...
|-----------|-----------|----------|-------|-------------|
| `image` | IMAGE | Evet | - | Videoya dönüştürülecek giriş görüntüsü |
...
| `negative_prompt` | STRING | Hayır | - | Bir görüntüde istenmeyen öğelerin isteğe bağlı metin açıklaması |
| `pixverse_template` | CUSTOM | Hayır | - | PixVerse Şablon düğümü tarafından oluşturulan, oluşturma stilini etkilemek için isteğe bağlı şablon |
