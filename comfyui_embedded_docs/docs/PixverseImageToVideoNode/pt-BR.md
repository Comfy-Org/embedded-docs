...
| `prompt_negativo` | Uma descrição textual opcional de elementos indesejados em uma imagem | STRING | Não | - |
| `pixverse_template` | Um template opcional para influenciar o estilo da geração, criado pelo nó PixVerse Template | CUSTOM | Não | - |

**Nota:** Ao usar qualidade 1080p, o modo de movimento é automaticamente definido como normal e a duração é limitada a 5 segundos. Para durações diferentes de 5 segundos, o modo de movimento também é automaticamente definido como normal.
