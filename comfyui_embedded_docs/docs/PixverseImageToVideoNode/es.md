...
| `quality` | COMBO | Sí | `res_540p`<br>`res_1080p` | Configuración de calidad de video (por defecto: res_540p) |
...
| `seed` | INT | Sí | 0-2147483647 | Semilla para la generación del video (por defecto: 0) |
| `negative_prompt` | STRING | No | - | Una descripción de texto opcional de elementos no deseados en una imagen |
