...
| `calidad` | COMBO | Sí | `res_540p`<br>`res_1080p` | Configuración de calidad del video (predeterminado: res_540p) |
...
| `semilla` | INT | Sí | 0-2147483647 | Semilla para la generación del video (predeterminado: 0) |
| `prompt_negativo` | STRING | No | - | Una descripción textual opcional de elementos no deseados en una imagen |
| `plantilla_pixverse` | CUSTOM | No | - | Una plantilla opcional para influir en el estilo de generación, creada por el nodo Plantilla PixVerse |
