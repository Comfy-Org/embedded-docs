...
| `prompt` | STRING | 아니요 | - | 영상 생성을 위한 텍스트 설명 |
| `duration` | INT | 아니요 | 5-5 | 출력 영상의 길이(초) (기본값: 5, 5초로 고정) |
| `seed` | INT | 아니요 | 0-2147483647 | 영상 생성을 위한 시드 (0은 무작위) (기본값: 0) |
| `resolution` | COMBO | 아니요 | `"1080p"` | 지원되는 값은 모델 및 길이에 따라 다를 수 있습니다 (기본값: "1080p") |
