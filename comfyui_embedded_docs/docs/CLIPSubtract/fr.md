...
| `clip2` | CLIP | Requis | - | - | Le modèle CLIP dont les correctifs clés seront soustraits du modèle de base |
| `multiplier` | FLOAT | Requis | 1.0 | -10.0 à 10.0, pas de 0.01 | Contrôle l'intensité de l'opération de soustraction. Les valeurs positives soustraient les caractéristiques de clip2, les valeurs négatives les ajoutent à la place. |
