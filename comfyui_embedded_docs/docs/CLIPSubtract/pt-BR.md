...
| `clip2` | CLIP | Obrigatório | - | - | O modelo CLIP cujos patches-chave serão subtraídos do modelo base |
| `multiplier` | FLOAT | Obrigatório | 1.0 | -10.0 a 10.0, passo 0.01 | Controla a intensidade da operação de subtração. Valores positivos subtraem características do clip2, valores negativos adicionam características. |
