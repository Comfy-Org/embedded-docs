...
| `width`   | `FLOAT`     | Определяет ширину области в процентах от общей ширины изображения, влияя на то, какая часть изображения подвергается кондиционированию по горизонтали. |
...
| `strength`| `FLOAT`     | Управляет интенсивностью эффекта кондиционирования в указанной области, позволяя точно настраивать его воздействие. |
