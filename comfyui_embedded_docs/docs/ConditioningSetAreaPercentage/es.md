...
| `ancho`   | `FLOAT`     | Especifica el ancho del área como un porcentaje del ancho total de la imagen, influyendo en la extensión horizontal del condicionamiento sobre la imagen. |
...
| `fuerza`| `FLOAT`     | Controla la intensidad del efecto de condicionamiento dentro del área especificada, permitiendo un ajuste preciso de su impacto. |
