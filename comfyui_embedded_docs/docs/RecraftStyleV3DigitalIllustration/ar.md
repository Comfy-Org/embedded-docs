...
| --- | --- | --- |
| `نمط إعادة الصياغة` | كائن نمط مُهيأ يحتوي على النمط المحدد "الرسم التوضيحي الرقمي" والنمط الفرعي الاختياري، جاهز للإرسال إلى عقد واجهة برمجة تطبيقات Recraft الأخرى. | STYLEV3 |
