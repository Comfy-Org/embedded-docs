...
| 參數              | 資料類型        | 說明                                                              |
|-------------------|-----------------|-------------------------------------------------------------------|
| `image`           | `IMAGE`         | 要放大至指定總像素數量的輸入影像。                                |
| `upscale_method`  | COMBO[STRING]   | 用於放大影像的方法。此方法會影響放大後影像的品質與特性。          |
| `megapixels`      | `FLOAT`         | 影像的目標大小，單位為百萬像素。這決定了放大後影像的總像素數量。 |

## 輸出

| 參數    | 資料類型 | 說明                                                              |
|---------|----------|-------------------------------------------------------------------|
| `image` | `IMAGE`  | 具有指定總像素數量且維持原始長寬比的放大後影像。                  |