...
| --- | --- | --- |
| `ماسک‌ها` | ماسک‌های بخش‌بندی. وقتی `ماسک‌های جداگانه` False باشد (پیش‌فرض)، یک ماسک ترکیبی واحد به ازای هر فریم برمی‌گرداند. وقتی True باشد، ماسک‌های جداگانه برای هر شیء تشخیص داده شده برمی‌گرداند | MASK |
