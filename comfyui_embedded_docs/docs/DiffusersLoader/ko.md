...
|-----------|-----------|----------|-------|-------------|
| `model_path` | STRING | 예 | 여러 옵션 사용 가능<br>(diffusers 폴더에서 자동으로 채워짐) | 불러올 diffusers 모델 디렉토리의 경로입니다. 이 노드는 구성된 diffusers 폴더에서 유효한 diffusers 모델을 자동으로 스캔하고 사용 가능한 옵션을 나열합니다. |
