...
|---------|---------------|--------|---------|-------|
| `model_path` | STRING | نعم | تتوفر خيارات متعددة<br>(يتم تعبئتها تلقائيًا من مجلدات diffusers) | مسار دليل نموذج diffusers المراد تحميله. تقوم العقدة بمسح المجلدات المُهيأة تلقائيًا للبحث عن نماذج diffusers الصالحة وتعرض الخيارات المتاحة. |
