...
|-----------|-----------------|--------|-------|-------------|
| `folder` | COMBO | Oui | *Chargé dynamiquement depuis `folder_paths.get_input_subfolders()`* | Le dossier à partir duquel charger les images. Les options disponibles sont les sous-répertoires du répertoire d'entrée de ComfyUI. |
