...
| `auto_size` | Escala el modelo a su tamaño real en metros mediante su transformación de escena. Se ignora cuando `model.texture` es `"none"` (predeterminado: False). Ajuste avanzado. | BOOLEAN | Sí | True/False |
