...
|-----------|-----------|---------|--------|----------|
| `ckpt_adı` | STRING | Evet | Birden çok seçenek mevcut | LoRA modeli olarak yüklenecek kontrol noktası dosyası. Mevcut seçenekler, kontrol noktaları klasörünün içeriğine bağlıdır. |
