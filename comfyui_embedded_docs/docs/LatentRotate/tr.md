...
|-----------|-------------|-------------|
| `örnekler` | `LATENT`    | 'samples' parametresi, döndürülecek görüntülerin gizli uzay temsillerini temsil eder. Döndürme işleminin başlangıç noktasını belirlemek için kritik öneme sahiptir. |
| `döndürme` | COMBO[STRING] | 'rotation' parametresi, gizli görüntülerin hangi açıyla döndürülmesi gerektiğini belirtir. Ortaya çıkan görüntülerin yönünü doğrudan etkiler. |
