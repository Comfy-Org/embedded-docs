...
PaintMesh toma una malla 3D y un campo de color de vóxeles. Asigna a cada vértice el color del vóxel más cercano en el campo, escribiendo el resultado como colores de vértice en la malla de salida. Si el campo de vóxeles está vacío, la malla se pinta con colores de vértice cero (negro) por defecto.
...
| `voxel_colors` | Campo de vóxeles que contiene los datos de color utilizados para pintar. Del campo solo se utilizan los canales RGB del color base. | VOXEL | Sí | N/A |
...
|-------------|-------------|-----------|
| `mesh` | La malla pintada con colores de vértice aplicados. | MESH |
