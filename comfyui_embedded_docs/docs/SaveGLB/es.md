...
|-----------|-----------|----------|-------|-------------|
| `mesh` | MESH | Sí | - | Los datos de malla 3D que se guardarán como archivo GLB |
| `filename_prefix` | STRING | No | - | El prefijo para el nombre de archivo de salida (predeterminado: "mesh/ComfyUI") |
