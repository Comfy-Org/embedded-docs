...
| `width` | INT | Yes | 16 to MAX_RESOLUTION | The output width for the generated video frames (default: 576, must be divisible by 8) |
| `height` | INT | Yes | 16 to MAX_RESOLUTION | The output height for the generated video frames (default: 576, must be divisible by 8) |
