...
| --- | --- | --- |
| `positive` | Los datos de condicionamiento positivo que contienen embeddings de imagen y parámetros de cámara para la generación | CONDITIONING |
| `negative` | Los datos de condicionamiento negativo con embeddings puestos a cero para generación contrastiva | CONDITIONING |
