...
|---------------|-----------------|-------------|
| `positive` | CONDITIONING | Les données de conditionnement positif contenant les embeddings d'image et les paramètres de caméra pour la génération |
| `negative` | CONDITIONING | Les données de conditionnement négatif avec des embeddings mis à zéro pour la génération contrastive |
