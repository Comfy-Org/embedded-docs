...
|-----------|-------------|-----------------|--------|-------|
| `vidéo` | Vidéo avec parole à traduire. | VIDEO | Oui | - |
...
| `traduire uniquement l'audio` | Remplace uniquement la piste audio, en conservant les mouvements de bouche d'origine (pas de synchronisation labiale). (par défaut : False) | BOOLEAN | Non | True<br>False |
| `nombre de locuteurs` | Nombre de locuteurs dans la vidéo. 0 = détection automatique. (par défaut : 0) | INT | Non | 0 à 10 |
| `graine` | N'est pas envoyé à HeyGen ; modifiez-le pour forcer une nouvelle exécution. (par défaut : 42) | INT | Non | 0 à 2147483647 |

## Sorties

| Nom de sortie | Description | Type de données |
|---------------|-------------|-----------------|
| `vidéo` | La vidéo traduite avec clonage vocal et synchronisation labiale appliqués. | VIDEO |
