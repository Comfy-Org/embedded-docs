...
|-----------|-----------|----------|-------|-------------|
| `çözücü_türü` | STRING | Evet | `"midpoint"`<br>`"heun"` | Örnekleme sürecinde kullanılacak diferansiyel denklem çözücüsünün türü |
...
| `gürültü_cihazı` | STRING | Evet | `"gpu"`<br>`"cpu"` | Gürültü hesaplamalarının yapıldığı cihaz. "cpu" olarak ayarlandığında, örnekleyici CPU tabanlı gürültü üretimi kullanır; "gpu" olarak ayarlandığında ise potansiyel olarak daha hızlı performans için GPU tabanlı gürültü üretimi kullanır |
