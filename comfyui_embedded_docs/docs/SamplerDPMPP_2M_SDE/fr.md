...
|-----------|-----------------|--------|-------|-------------|
| `type_solveur` | STRING | Oui | `"midpoint"`<br>`"heun"` | Le type de solveur d'équations différentielles à utiliser pour le processus d'échantillonnage |
