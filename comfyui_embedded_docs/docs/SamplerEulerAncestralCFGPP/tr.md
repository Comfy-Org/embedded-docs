...
SamplerEulerAncestralCFGPP düğümü, görüntü üretimi için sınıflandırıcısız rehberlik (CFG++) ile Euler Ancestral yöntemini kullanan bir örnekleyici oluşturur. Bu örnekleyici, atasal örnekleme tekniklerini rehberlik koşullandırmasıyla birleştirerek tutarlılığı korurken çeşitli görüntü varyasyonları üretir ve gürültü ile adım boyutu ayarlarını kontrol eden parametreler aracılığıyla ince ayar yapılmasına olanak tanır.
...
| `s_noise` | Örnekleme sürecinde eklenen gürültü miktarını ayarlar (varsayılan: 1.0) | FLOAT | Evet | 0.0 - 10.0 |
