...
|-----------|-----------|----------|-------|-------------|
| `samples` | LATENT | Evet | | Yükseltilecek videonun giriş gizli temsili. |
| `upscale_model` | LATENT_UPSCALE_MODEL | Evet | | Gizli veriler üzerinde 2 kat yükseltme işlemini gerçekleştirmek için kullanılan yüklenmiş model. |
