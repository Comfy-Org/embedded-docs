...
|-----------|-------------|---------------|-----------|-------|
| `model` | Modelo a utilizar para la extensión de video. Al seleccionar un modelo se muestran sus ajustes específicos de duración y resolución. | COMBO | Sí | `"viduq2-pro"`<br>`"viduq2-turbo"` |
...
| `end_frame` | Una imagen opcional para usar como fotograma final de destino para la extensión. | IMAGE | No | - |
...
| Parámetro | Descripción | Tipo de datos | Requerido | Rango |
|-----------|-------------|---------------|-----------|-------|
| `model.duration` | Duración del video extendido en segundos (por defecto: 4). Esta configuración aparece después de seleccionar un modelo. | INT | Sí | 1 a 7 |
| `model.resolution` | Resolución del video de salida. Esta configuración aparece después de seleccionar un modelo. | COMBO | Sí | `"720p"`<br>`"1080p"` |
