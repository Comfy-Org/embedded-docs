...
|-----------|--------------|-------------|-------|-----------|
| `modelo` | COMBO | Sim | `"viduq2-pro"`<br>`"viduq2-turbo"` | O modelo de IA a ser usado para extensão de vídeo. Selecionar um modelo revela suas configurações específicas de duração e resolução. |
...
| `vídeo` | VIDEO | Sim | - | O vídeo de origem a ser estendido. |
...
| `quadro_final` | IMAGE | Não | - | Uma imagem opcional para usar como quadro final alvo para a extensão. Se fornecida, sua proporção de aspecto deve estar entre 1:4 e 4:1, e suas dimensões devem ter pelo menos 128x128 pixels. |
