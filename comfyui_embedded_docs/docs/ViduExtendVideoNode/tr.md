...
| `end_frame` | IMAGE | Hayır | - | Uzatma için hedef bitiş karesi olarak kullanılacak isteğe bağlı bir görsel. Sağlanırsa, en boy oranı 1:4 ile 4:1 arasında olmalı ve boyutları en az 128x128 piksel olmalıdır. |
