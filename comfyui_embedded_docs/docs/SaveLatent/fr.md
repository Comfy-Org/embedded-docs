...
|-----------|-----------------|--------|-------|-------------|
| `échantillons` | LATENT | Oui | - | Les échantillons latents à sauvegarder sur le disque |
| `préfixe_du_nom_de_fichier` | STRING | Non | - | Le préfixe du nom de fichier de sortie (par défaut : "latents/ComfyUI") |
...
|---------------|-----------------|-------------|
| `ui` | UI | Fournit les informations d'emplacement du fichier pour le latent sauvegardé dans l'interface ComfyUI |
