...
|-----------|-----------------|--------|-------|-------------|
| `samples` | LATENT | Oui | - | Les échantillons latents à sauvegarder sur le disque |
| `filename_prefix` | STRING | Non | - | Le préfixe du nom de fichier de sortie (par défaut : "latents/ComfyUI") |
