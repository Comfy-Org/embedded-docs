...
| Parámetro | Descripción | Tipo de Dato |
| --- | --- | --- |
| `image` | La salida es una única imagen que combina la imagen de entrada con la máscara alfa, incorporando información de transparencia en el contenido visual. | `IMAGE` |
