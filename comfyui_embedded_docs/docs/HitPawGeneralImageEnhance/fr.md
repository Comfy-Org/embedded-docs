...
Ce nœud améliore les images à basse résolution en les agrandissant en super-résolution tout en supprimant les artefacts et le bruit. Il envoie l'image à une API externe pour traitement, et il peut ajuster automatiquement la taille d'entrée afin de rester dans la limite de sortie autorisée. La taille de sortie maximale autorisée est de 32 mégapixels.
