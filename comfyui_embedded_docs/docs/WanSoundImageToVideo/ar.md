...
| --- | --- | --- |
| `النص الإيجابي` | التكييف الإيجابي المُعالج الذي تم تعديله لتوليد الفيديو | CONDITIONING |
| `النص السلبي` | التكييف السلبي المُعالج الذي تم تعديله لتوليد الفيديو | CONDITIONING |
| `الكامن` | تمثيل الفيديو المُنشأ في الفضاء الكامن والذي يمكن فك تشفيره إلى إطارات الفيديو النهائية | LATENT |
