...
| --- | --- | --- |
| `positive` | التكييف الإيجابي المُعالج الذي تم تعديله لتوليد الفيديو | CONDITIONING |
| `negative` | التكييف السلبي المُعالج الذي تم تعديله لتوليد الفيديو | CONDITIONING |
