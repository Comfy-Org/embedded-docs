...
| --- | --- | --- |
| `positive` | Conditionnement positif traité et modifié pour la génération vidéo | CONDITIONING |
| `negative` | Conditionnement négatif traité et modifié pour la génération vidéo | CONDITIONING |
