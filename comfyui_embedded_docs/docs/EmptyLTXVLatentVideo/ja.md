...
| パラメータ | データ型 | 必須 | 範囲 | 説明 |
|-----------|-----------|----------|-------|-------------|
| `width` | INT | はい | 64 ～ MAX_RESOLUTION | 潜在ビデオテンソルの幅（デフォルト: 768, ステップ: 32） |
| `height` | INT | はい | 64 ～ MAX_RESOLUTION | 潜在ビデオテンソルの高さ（デフォルト: 512, ステップ: 32） |
| `length` | INT | はい | 1 ～ MAX_RESOLUTION | 潜在ビデオのフレーム数（デフォルト: 97, ステップ: 8） |
