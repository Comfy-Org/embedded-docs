...
|-----------|-----------|----------|-------|-------------|
| `width` | INT | 예 | 64 ~ MAX_RESOLUTION | 잠재 비디오 텐서의 너비 (기본값: 768, 단계: 32) |
| `height` | INT | 예 | 64 ~ MAX_RESOLUTION | 잠재 비디오 텐서의 높이 (기본값: 512, 단계: 32) |
| `length` | INT | 예 | 1 ~ MAX_RESOLUTION | 잠재 비디오의 프레임 수 (기본값: 97, 단계: 8) |
| `batch_size` | INT | 아니요 | 1 ~ 4096 | 한 배치에서 생성할 잠재 비디오의 개수 (기본값: 1) |
