...
| `model` | The LTX 2.5 model version to use. The video resolution (1920x1080 or 1080x1920) is selected together with the model; both models offer the same resolution options. | COMBO | Yes | "LTX-2.5 (Fast)"<br>"LTX-2.5 (Pro)" |
