...
| `modèle` | La version du modèle LTX 2.5 à utiliser. La résolution est choisie avec le modèle ; les deux modèles offrent les mêmes options de résolution (1920x1080 ou 1080x1920). | COMBO | Oui | "LTX-2.5 (Fast)"<br>"LTX-2.5 (Pro)" |
