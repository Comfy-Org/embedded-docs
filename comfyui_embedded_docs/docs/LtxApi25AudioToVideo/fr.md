...
| `image` | Première image facultative à utiliser pour la vidéo. Une seule image est prise en charge. | IMAGE | Non | Image unique |

Remarques sur les contraintes :
- La durée de l'audio doit être comprise entre 2 et 20 secondes ; le nœud génère une erreur si elle est en dehors de cette plage.
