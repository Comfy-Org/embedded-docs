...
Este nodo genera un video que sigue una pista de audio utilizando el modelo LTX 2.5. El audio determina la duración del video (entre 2 y 20 segundos), y opcionalmente puedes proporcionar una imagen para usar como primer fotograma. El video se genera a través del servicio API de LTX 2.5.
...
- El prompt es obligatorio y no puede estar vacío.
...
|------------------|-------------|--------------|
| `video` | El video generado a partir de la pista de audio proporcionada. | VIDEO |
