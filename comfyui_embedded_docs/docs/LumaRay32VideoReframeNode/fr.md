...
|-----------|-------------|-----------------|--------|-------|
| `video` | Vidéo source à recadrer. Jusqu'à 30 secondes. | VIDEO | Oui | - |
| `prompt` | Décrit comment les zones de toile nouvellement exposées doivent être remplies. | STRING | Oui | - |
| `aspect_ratio` | Le ratio d'affichage cible pour la vidéo recadrée (par défaut : "16:9"). | STRING | Oui | "16:9"<br>"9:16"<br>"1:1"<br>"4:3"<br>"3:4"<br>"21:9" |
| `resolution` | La résolution de sortie de la vidéo recadrée (par défaut : "720p"). | STRING | Oui | "360p"<br>"540p"<br>"720p"<br>"1080p" |
| `seed` | Graine pour une génération reproductible. | INT | Oui | - |
...
|---------------|-------------|-----------------|
| `video` | La vidéo recadrée avec le nouveau ratio d'affichage et les zones de toile remplies. | VIDEO |
