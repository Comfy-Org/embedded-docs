...
|-----------|-----------|----------|-------|-------------|
| `프롬프트` | STRING | 아니요 | - | 비디오 확장을 안내하는 긍정 텍스트 프롬프트 |
| `부정 프롬프트` | STRING | 아니요 | - | 확장된 비디오에서 제외할 요소에 대한 부정 텍스트 프롬프트 |
| `cfg 스케일` | FLOAT | 아니요 | 0.0 - 1.0 | 프롬프트 안내 강도를 제어합니다 (기본값: 0.5) |
| `비디오 ID` | STRING | 예 | - | 확장할 비디오의 ID입니다. 텍스트-비디오, 이미지-비디오 및 이전 비디오 확장 작업으로 생성된 비디오를 지원합니다. 확장 후 총 재생 시간이 3분을 초과할 수 없습니다. |
