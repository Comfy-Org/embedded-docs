...
|-----------|-----------|----------|-------|-------------|
| `prompt` | STRING | 아니오 | - | 비디오 확장을 안내하는 긍정적인 텍스트 프롬프트 |
| `negative_prompt` | STRING | 아니오 | - | 확장된 비디오에서 피해야 할 요소에 대한 부정적인 텍스트 프롬프트 |
| `cfg_scale` | FLOAT | 아니오 | 0.0 - 1.0 | 프롬프트 안내의 강도를 제어합니다 (기본값: 0.5) |
| `video_id` | STRING | 예 | - | 확장할 비디오의 ID입니다. 텍스트-비디오, 이미지-비디오 및 이전 비디오 확장 작업으로 생성된 비디오를 지원합니다. 확장 후 총 지속 시간이 3분을 초과할 수 없습니다. |
