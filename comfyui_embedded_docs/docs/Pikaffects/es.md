...
|-----------|-----------|----------|-------|-------------|
| `image` | IMAGE | Sí | - | La imagen de referencia a la que se aplicará el Pikaffect. |
| `pikaffect` | COMBO | Sí | "Cake-ify"<br>"Crumble"<br>"Crush"<br>"Decapitate"<br>"Deflate"<br>"Dissolve"<br>"Explode"<br>"Eye-pop"<br>"Inflate"<br>"Levitate"<br>"Melt"<br>"Peel"<br>"Poke"<br>"Squish"<br>"Ta-da"<br>"Tear" | El efecto visual específico que se aplicará a la imagen (predeterminado: "Cake-ify"). |
...
|-------------|-----------|-------------|
| `output` | VIDEO | El video generado con el Pikaffect aplicado. |
