...
|-----------|-----------|----------|-------|-------------|
| `image` | IMAGE | Да | - | Референсное изображение, к которому применяется эффект Pikaffect. |
...
| `prompt_text` | STRING | Да | - | Текстовое описание, направляющее процесс генерации видео. |
