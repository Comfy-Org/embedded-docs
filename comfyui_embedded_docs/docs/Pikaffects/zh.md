...
|-----------|-----------|----------|-------|-------------|
| `image` | IMAGE | 是 | - | 应用 Pikaffect 效果的参考图像。 |
| `pikaffect` | COMBO | 是 | "Cake-ify"<br>"Crumble"<br>"Crush"<br>"Decapitate"<br>"Deflate"<br>"Dissolve"<br>"Explode"<br>"Eye-pop"<br>"Inflate"<br>"Levitate"<br>"Melt"<br>"Peel"<br>"Poke"<br>"Squish"<br>"Ta-da"<br>"Tear" | 应用于图像的具体视觉效果（默认值："Cake-ify"）。 |
| `prompt_text` | STRING | 是 | - | 引导视频生成的文本描述。 |
