...
| --- | --- | --- |
| `imagens` | A entrada 'images' especifica as imagens a serem processadas e salvas como imagens de pré-visualização temporárias. Esta é a entrada principal do nó, determinando quais imagens passarão pelo processo de geração de pré-visualização. | `IMAGE` |
