...
O nó ModelMergeAuraflow mescla dois modelos Auraflow ao atribuir um peso de mesclagem separado a cada parte do modelo, das camadas iniciais até a saída final. Cada peso controla quanto do segundo modelo é misturado ao primeiro modelo naquele componente específico, proporcionando controle preciso sobre a mesclagem.
...
| `double_layers.2.` | Peso de mesclagem para o grupo de camadas duplas 2 (padrão: 1.0) | FLOAT | Sim | 0.0 - 1.0 |
| `double_layers.3.` | Peso de mesclagem para o grupo de camadas duplas 3 (padrão: 1.0) | FLOAT | Sim | 0.0 - 1.0 |
...
Todos os pesos de mesclagem são valores FLOAT com valor padrão de 1.0, valor mínimo de 0.0, valor máximo de 1.0 e passo de 0.01.

## Saídas

| Nome da Saída | Descrição | Tipo de Dados |
| --- | --- | --- |
| `model` | O modelo mesclado que combina características de ambos os modelos de entrada de acordo com os pesos de mesclagem especificados | MODEL |
