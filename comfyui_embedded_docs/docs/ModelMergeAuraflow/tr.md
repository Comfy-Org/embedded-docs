...
ModelMergeAuraflow düğümü, iki Auraflow modelini modelin her bir parçasına ayrı bir harmanlama ağırlığı atayarak başlangıç katmanlarından son çıktıya kadar harmanlar. Her ağırlık, ikinci modelin birinci modele ilgili bileşende ne kadar karıştırılacağını kontrol ederek birleştirme üzerinde hassas kontrol sağlar.
...
Tüm harmanlama ağırlıkları, varsayılan değeri 1.0, minimum değeri 0.0, maksimum değeri 1.0 ve adım değeri 0.01 olan FLOAT değerleridir.

## Çıktılar

| Çıktı Adı | Açıklama | Veri Türü |
| --- | --- | --- |
| `model` | Belirtilen harmanlama ağırlıklarına göre her iki girdi modelinin özelliklerini birleştiren birleştirilmiş model | MODEL |
