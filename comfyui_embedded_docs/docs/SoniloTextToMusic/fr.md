...
| `duration` | INT | Non | 0 à 360 | Durée cible en secondes. Mettez 0 pour laisser le modèle inférer la durée à partir du prompt. Maximum : 6 minutes (360 secondes). Valeur par défaut : 0. |
| `seed` | INT | Non | 0 à 18446744073709551615 | Graine pour la reproductibilité. Actuellement ignorée par le service Sonilo mais conservée pour la cohérence du graphe. Valeur par défaut : 0. |
