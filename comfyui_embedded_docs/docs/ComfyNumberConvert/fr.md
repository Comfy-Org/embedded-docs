...
| --- | --- | --- | --- | --- |
| `valeur` | La valeur à convertir en sorties numériques. Accepte un entier, un nombre à virgule flottante, une chaîne de texte ou un booléen vrai/faux. | INT, FLOAT, STRING, BOOLEAN | Oui | N/A |
