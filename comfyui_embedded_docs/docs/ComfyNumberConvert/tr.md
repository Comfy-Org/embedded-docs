...
|-------------|-----------|-------------|
| `FLOAT` | FLOAT | Giriş değerinin ondalıklı sayıya dönüştürülmüş hali. |
| `INT` | INT | Giriş değerinin tam sayıya dönüştürülmüş hali. Ondalıklı sayı girişlerinde, ondalık kısmı keser. |
