...
|------------------|--------------|-------------|
| `MODEL` | MODEL | El modelo clonado con la imagen inicial codificada almacenada en su configuración para la generación de video. |
