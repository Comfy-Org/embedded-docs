...
| `size` | COMBO | Sí | `"1024x1024"`<br>`"1024x2048"`<br>`"2048x1024"`<br>`"2048x2048"`<br>`"512x512"`<br>`"512x1024"`<br>`"1024x512"`<br>`"2048x512"`<br>`"512x2048"` | El tamaño de la imagen generada. (predeterminado: "1024x1024") |
| `n` | INT | Sí | 1-6 | El número de imágenes a generar. (predeterminado: 1, mínimo: 1, máximo: 6) |
| `seed` | INT | Sí | 0-18446744073709551615 | Semilla para determinar si el nodo debe re-ejecutarse; los resultados reales son no deterministas independientemente de la semilla. (predeterminado: 0, mínimo: 0, máximo: 18446744073709551615) |
