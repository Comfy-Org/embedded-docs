...
| `negative_prompt` | STRING | خیر | - | یک توضیح متنی اختیاری از عناصر نامطلوب در یک تصویر. (پیش‌فرض: "") |
