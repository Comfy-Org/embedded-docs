...
|----------|-------------|-----------|--------|------|------|
| `model_type` | STRING | COMBO | - | SD1, SDXL, SVD | 시그마 계산에 사용할 모델 유형을 지정합니다 |
| `steps` | INT | INT | 10 | 1-10000 | 생성할 샘플링 단계의 총 수 |
| `denoise` | FLOAT | FLOAT | 1.0 | 0.0-1.0 | 이미지를 얼마나 제노이즈할지 제어하며, 1.0은 모든 단계를 사용하고 더 낮은 값은 더 적은 단계를 사용합니다 |
