...
| `adımlar` | Üretilecek toplam örnekleme adımı sayısı (varsayılan: 10) | INT | Evet | 1 ile 10000 |
| `gürültü_azaltma` | Görüntüde ne kadar gürültü giderme yapılacağını kontrol eder; 1.0 tüm adımları kullanır ve daha düşük değerler daha az adım kullanır (varsayılan: 1.0) | FLOAT | Evet | 0.0 ile 1.0 (adım: 0.01) |
