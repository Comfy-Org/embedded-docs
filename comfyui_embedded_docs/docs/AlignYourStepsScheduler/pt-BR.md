...
| --- | --- | --- | --- | --- |
| `tipo_de_modelo` | Especifica o tipo de modelo a ser usado para o cálculo de sigma (padrão: "SD1") | COMBO | Sim | `"SD1"`<br>`"SDXL"`<br>`"SVD"` |
| `passos` | O número total de etapas de amostragem a serem geradas (padrão: 10) | INT | Sim | 1 a 10000 |
| `reduzir_ruído` | Controla quanto a imagem será submetida à remoção de ruído, em que 1.0 usa todas as etapas e valores menores usam menos etapas (padrão: 1.0) | FLOAT | Sim | 0.0 a 1.0 (passo: 0.01) |
