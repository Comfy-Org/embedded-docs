...
|-----------|--------------|-----------|-------|-------------|
| `order` | INT | Sí | 2-3 | El orden del método de muestreo (predeterminado: 3) |
...
| `accept_safety` | FLOAT | Sí | 0.0-100.0 | Factor de seguridad para la aceptación de pasos (predeterminado: 0.81) |
| `eta` | FLOAT | Sí | 0.0-100.0 | Parámetro de estocasticidad (predeterminado: 0.0) |
| `s_noise` | FLOAT | Sí | 0.0-100.0 | Factor de escalado de ruido (predeterminado: 1.0) |
