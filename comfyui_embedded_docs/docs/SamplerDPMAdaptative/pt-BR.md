...
|-----------|--------------|-------------|-------|-----------|
| `ordem` | INT | Sim | 2-3 | A ordem do método do amostrador (padrão: 3) |
...
| `aceitar_segurança` | FLOAT | Sim | 0,0-100,0 | Fator de segurança para aceitação do passo (padrão: 0,81) |
| `eta` | FLOAT | Sim | 0,0-100,0 | Parâmetro de estocasticidade (padrão: 0,0) |
| `s_ruído` | FLOAT | Sim | 0,0-100,0 | Fator de escala de ruído (padrão: 1,0) |
