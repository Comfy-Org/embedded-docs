...
| `sigma_max` | FLOAT       | 최대 노이즈 수준으로, 노이즈 스케줄의 상한을 설정합니다.                                                                                                                                                                                                                                                                                                                                 |
| `sigma_min` | FLOAT       | 최소 노이즈 수준으로, 노이즈 스케줄의 하한을 설정합니다.                                                                                                                                                                                                                                                                                                                                 |
| `rho`       | FLOAT       | 다지수 노이즈 스케줄의 형태를 제어하는 매개변수로, 최소값과 최대값 사이에서 노이즈 수준이 어떻게 진행되는지에 영향을 줍니다.                                                                                                                                                                                                               |

## 출력

| 매개변수 | 데이터 타입 | 설명                                                                 |
|-----------|-------------|-----------------------------------------------------------------------------|
| `sigmas`  | SIGMAS      | 지정된 다지수 노이즈 스케줄에 맞춰 조정된 노이즈 수준(sigmas) 시퀀스를 출력합니다. |