...
Este nodo genera un video con calidad profesional a partir de una imagen inicial usando un modelo LTX 2.5. Describes el contenido del video con un prompt de texto, seleccionas una variante del modelo y ajustas la duración, la resolución, la velocidad de fotogramas y la generación de audio. Se puede proporcionar un fotograma final opcional para definir el final del video.
