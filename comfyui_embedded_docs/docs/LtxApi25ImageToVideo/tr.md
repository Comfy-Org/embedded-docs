...
| `süre` | Üretilen videonun saniye cinsinden süresi. | INT | Evet | Tam sayı |
...
| `ses_oluştur` | Video için ses üretilip üretilmeyeceği. | BOOLEAN | Evet | True<br>False |
...
| `tohum` | Tekrarlanabilir üretim için tohum değeri. Aynı tohumu aynı ayarlarla kullanmak aynı sonucu üretir. | INT | Evet | Tam sayı (varsayılan: 42) |
