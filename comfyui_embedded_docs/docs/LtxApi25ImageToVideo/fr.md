...
| `modèle` | Groupe de paramètres du modèle. Sélectionne la variante du modèle LTX 2.5 à utiliser. | COMBO | Oui | "LTX-2.5 (Fast)"<br>"LTX-2.5 (Pro)" |
...
| `fps` | Fréquence d'images de la vidéo générée. | INT | Oui | Entier (par défaut : 25) |
| `générer_audio` | Indique s'il faut générer de l'audio pour la vidéo. | BOOLEAN | Oui | True<br>False (par défaut : True) |
