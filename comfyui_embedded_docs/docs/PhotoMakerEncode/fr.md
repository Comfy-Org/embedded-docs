...
|-----------|-----------------|--------|-------|-------------|
| `photomaker` | PHOTOMAKER | Oui | - | Le modèle PhotoMaker utilisé pour traiter l'image et générer les embeddings |
...
| `texte` | STRING | Oui | - | Le prompt textuel pour la génération du conditionnement (par défaut : "photograph of photomaker") |
...
|---------------|-----------------|-------------|
| `CONDITIONING` | CONDITIONING | Les données de conditionnement contenant les embeddings d'image et de texte pour guider la génération d'images |
