...
|-----------|-----------|------------|---------|-------|-------------|
| `hooks_A` | HOOKS | 선택적 | None | - | 결합할 첫 번째 훅 그룹 |
| `hooks_B` | HOOKS | 선택적 | None | - | 결합할 두 번째 훅 그룹 |
| `hooks_C` | HOOKS | 선택적 | None | - | 결합할 세 번째 훅 그룹 |
| `hooks_D` | HOOKS | 선택적 | None | - | 결합할 네 번째 훅 그룹 |
| `hooks_E` | HOOKS | 선택적 | None | - | 결합할 다섯 번째 훅 그룹 |
| `hooks_F` | HOOKS | 선택적 | None | - | 결합할 여섯 번째 훅 그룹 |
| `hooks_G` | HOOKS | 선택적 | None | - | 결합할 일곱 번째 훅 그룹 |
| `hooks_H` | HOOKS | 선택적 | None | - | 결합할 여덟 번째 훅 그룹 |
...
| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `HOOKS` | HOOKS | 제공된 모든 훅 구성을 포함하는 단일 결합 훅 그룹 |
