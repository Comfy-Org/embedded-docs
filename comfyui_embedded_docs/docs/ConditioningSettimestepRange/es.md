...
| `start` | `FLOAT` | El parámetro de inicio especifica el comienzo del rango de pasos de tiempo como un porcentaje del proceso total de generación, permitiendo un control preciso sobre cuándo comienzan los efectos del condicionamiento. |
| `end` | `FLOAT` | El parámetro de finalización define el punto final del rango de pasos de tiempo como un porcentaje, habilitando un control preciso sobre la duración y la conclusión de los efectos del condicionamiento. |
