...
| Parámetro | Descripción | Tipo de dato |
| --- | --- | --- |
| `image` | La imagen procesada, con valores de píxeles normalizados y transformaciones aplicadas según sea necesario. Está lista para su posterior procesamiento o análisis. | `IMAGE` |
