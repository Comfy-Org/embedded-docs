...
|-----------|--------------|-------------|
| `image`   | COMBO[STRING] | El parámetro `image` especifica el identificador de la imagen que se cargará y procesará. Es fundamental para determinar la ruta al archivo de imagen y, posteriormente, cargar la imagen para su transformación y normalización. |

## Salidas

| Parámetro | Tipo de dato | Descripción |
|-----------|-------------|-------------|
| `image`   | `IMAGE`     | La imagen procesada, con valores de píxeles normalizados y transformaciones aplicadas según sea necesario. Está lista para su posterior procesamiento o análisis. |
