...
|---------------|-------------|-----------------|
| `voice` | La voix clonée nouvellement créée, identifiée par un identifiant vocal unique renvoyé par l’API Fish Audio. Cette voix peut être utilisée pour la synthèse vocale. | FISHAUDIO_VOICE |
