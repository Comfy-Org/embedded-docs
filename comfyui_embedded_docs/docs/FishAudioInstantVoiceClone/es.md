...
|------------------|-------------|---------------|
| `voice` | La voz clonada recién creada, identificada por un ID de voz único devuelto por la API de Fish Audio. Esta voz se puede utilizar para la conversión de texto a voz. | FISHAUDIO_VOICE |
