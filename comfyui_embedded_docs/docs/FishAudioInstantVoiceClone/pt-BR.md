# Clonagem Instantânea de Voz do Fish Audio
...
|-------------|-------------|-----------|
| `voice` | A voz clonada recém-criada, identificada por um ID de voz único retornado pela API Fish Audio. Esta voz pode ser usada para conversão de texto em fala. | FISHAUDIO_VOICE |
