...
**Nota:** A duração total de todo o áudio de referência combinado deve ser inferior a 270 segundos. Se a duração combinada atingir ou exceder 270 segundos, o nó retorna um erro.

## Saídas

| Nome da Saída | Descrição | Tipo de Dado |
|---------------|-----------|--------------|
| `voice` | A voz clonada recém-criada, identificada por um ID de voz exclusivo retornado pela API Fish Audio. Esta voz pode ser usada para conversão de texto em fala. | FISHAUDIO_VOICE |
