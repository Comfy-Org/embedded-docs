...
|-----------|-----------|----------|-------|-------------|
| `LoRA 파일명` | STRING | 예 | 여러 옵션 사용 가능 | loras 디렉토리에서 로드할 LoRA 파일의 이름 |
| `모델 강도` | FLOAT | 예 | -20.0 ~ 20.0 | 모델 조정을 위한 강도 배율 (기본값: 1.0) |
| `CLIP 강도` | FLOAT | 예 | -20.0 ~ 20.0 | CLIP 조정을 위한 강도 배율 (기본값: 1.0) |
| `이전 후크` | HOOKS | 아니요 | 해당 없음 | 새로운 LoRA 훅과 결합할 선택적 기존 훅 그룹 |
