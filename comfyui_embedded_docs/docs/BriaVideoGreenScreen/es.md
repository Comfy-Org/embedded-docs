...
**Nota:** El video de entrada no debe exceder 60 segundos de duración.

## Salidas

| Nombre de salida | Descripción | Tipo de datos |
|------------------|-------------|---------------|
| `video` | El video procesado (MP4, H.264) con el fondo original reemplazado por el tono de croma seleccionado | VIDEO |
