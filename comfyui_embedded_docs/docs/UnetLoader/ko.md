...
| 매개변수 | 데이터 타입 | 설명 |
|-------------|--------------|-------------|
| `UNet 모델 파일명` | COMBO[STRING] | 로드할 U-Net 모델의 이름을 지정합니다. 이 이름은 미리 정의된 디렉터리 구조 내에서 모델을 찾는 데 사용되며, 다양한 U-Net 모델을 동적으로 로드할 수 있도록 합니다. |
...
| 매개변수 | 데이터 타입 | 설명 |
|-----------|-------------|-------------|
| `model`   | MODEL     | 로드된 U-Net 모델을 반환하며, 시스템 내에서 추가 처리 또는 추론에 활용할 수 있도록 합니다. |