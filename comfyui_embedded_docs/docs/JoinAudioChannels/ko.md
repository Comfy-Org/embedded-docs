...
|-----------|-----------|----------|-------|-------------|
| `audio_left` | AUDIO | 예 | | 결과 스테레오 오디오에서 왼쪽 채널로 사용될 모노 오디오 데이터입니다. |
| `audio_right` | AUDIO | 예 | | 결과 스테레오 오디오에서 오른쪽 채널로 사용될 모노 오디오 데이터입니다. |
...
| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `audio` | AUDIO | 결합된 왼쪽 및 오른쪽 채널을 포함하는 결과 스테레오 오디오입니다. |
