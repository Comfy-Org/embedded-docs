...
| --- | --- | --- |
| `image` | Yükseltme modeli tarafından işlenmiş, yükseltilmiş görüntü. Bu çıktı, yükseltme işleminin sonucudur ve geliştirilmiş çözünürlük veya kaliteyi sergiler. | `IMAGE` |
