...
| --- | --- | --- |
| `image` | La imagen escalada, procesada por el modelo de escalado. Esta salida es el resultado de la operación de escalado, mostrando la resolución o calidad mejorada. | `IMAGE` |
