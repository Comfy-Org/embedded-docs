...
|---------------|-----------------|-------------|
| `voice` | ELEVENLABS_VOICE | L'identifiant unique du modèle vocal cloné nouvellement créé. Cette sortie peut être connectée à d'autres nœuds de synthèse vocale ElevenLabs. |
