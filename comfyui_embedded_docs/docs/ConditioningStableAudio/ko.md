...
|-----------|-----------|----------|-------|-------------|
| `positive` | CONDITIONING | 예 | - | 오디오 타이밍 정보가 추가될 양극 조건 입력 |
| `negative` | CONDITIONING | 예 | - | 오디오 타이밍 정보가 추가될 음극 조건 입력 |
| `seconds_start` | FLOAT | 예 | 0.0 ~ 1000.0 | 오디오 생성을 시작할 시간(초) (기본값: 0.0) |
| `seconds_total` | FLOAT | 예 | 0.0 ~ 1000.0 | 오디오 생성의 전체 지속 시간(초) (기본값: 47.0) |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `positive` | CONDITIONING | 오디오 타이밍 정보가 적용된 수정된 양극 조건 |
| `negative` | CONDITIONING | 오디오 타이밍 정보가 적용된 수정된 음극 조건 |