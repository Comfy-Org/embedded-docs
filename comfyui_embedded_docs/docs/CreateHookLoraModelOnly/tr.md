...
|-----------|-----------|----------|-------|-------------|
| `lora_name` | STRING | Evet | Birden fazla seçenek mevcut | loras klasöründen yüklenecek LoRA dosyasının adı |
| `strength_model` | FLOAT | Evet | -20.0 ile 20.0 arası | Model bileşenine LoRA uygulama güç çarpanı (varsayılan: 1.0) |
