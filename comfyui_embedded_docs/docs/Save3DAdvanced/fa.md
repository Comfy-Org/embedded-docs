...
|---------|---------|----------|--------|--------|
| `model_3d` | فایل مدل سه‌بعدی از یک گره سه‌بعدی بالادستی. | FILE3D | بله | GLB<br>GLTF<br>FBX<br>OBJ<br>STL<br>USDZ<br>هر نوع |
...
توجه: وقتی `model_3d_info` یا `camera_info` متصل نباشند، گره از مقادیر ذخیره‌شده در `viewport_state` استفاده می‌کند.
