...
|-----------|--------------|-------------|-------|-----------|
| `model_name` | COMBO | Sim | `"kling-v2-6"` | O modelo de IA específico a ser usado para geração de vídeo. |
| `prompt` | STRING | Sim | - | Prompt textual positivo. A descrição usada para gerar o vídeo. Deve ter entre 1 e 2500 caracteres. |
...
| `generate_audio` | BOOLEAN | Não | - | Controla se o áudio é gerado para o vídeo. Quando ativado, a IA criará som com base no prompt. (padrão: `True`) |
