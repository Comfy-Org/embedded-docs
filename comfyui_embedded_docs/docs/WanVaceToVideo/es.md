...
| --- | --- | --- |
| `positive` | Condicionamiento positivo con datos de control de video aplicados | CONDITIONING |
| `negative` | Condicionamiento negativo con datos de control de video aplicados | CONDITIONING |
| `latent` | Tensor latente vacío listo para la generación de video | LATENT |
