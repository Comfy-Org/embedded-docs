...
| `width` | INT | Sí | 16 a MAX_RESOLUTION | Ancho del video de salida en píxeles (por defecto: 832, paso: 16) |
...
| `strength` | FLOAT | Sí | 0.0 a 1000.0 | Intensidad de control para el condicionamiento de video (por defecto: 1.0, paso: 0.01) |
