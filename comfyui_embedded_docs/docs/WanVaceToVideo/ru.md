...
|-----------|-----------|----------|-------|-------------|
| `positive` | CONDITIONING | Да | - | Позитивное кондиционирование для направления генерации |
| `negative` | CONDITIONING | Да | - | Негативное кондиционирование для направления генерации |
...
| `strength` | FLOAT | Да | 0.0 до 1000.0 | Сила контроля для кондиционирования видео (по умолчанию: 1.0, шаг: 0.01) |
...
| `reference_image` | IMAGE | Нет | - | Опорное изображение для дополнительного кондиционирования |
...
|-------------|-----------|-------------|
| `positive` | CONDITIONING | Позитивное кондиционирование с применёнными данными управления видео |
| `negative` | CONDITIONING | Негативное кондиционирование с применёнными данными управления видео |
