...
Примечание: Если `camera_info` или `model_3d_info` не предоставлены, узел использует соответствующие значения из `viewport_state`, когда они доступны.

## Выходные параметры

| Имя выхода | Описание | Тип данных |
|-------------|-------------|-----------|
| `model_3d` | Файл 3D-гауссова сплаттинга, сохранённый в выходной каталог. | FILE3D |
