...
توجه: اگر `camera_info` یا `model_3d_info` ارائه نشود، گره در صورت موجود بودن از مقادیر متناظر `viewport_state` استفاده می‌کند.

## خروجی‌ها

| نام خروجی | توضیحات | نوع داده |
|-------------|-------------|-----------|
| `model_3d` | فایل سه‌بعدی Gaussian splat که در دایرکتوری خروجی ذخیره شده است. | FILE3D |
