...
| `width` | INT | Sí | 16 a MAX_RESOLUTION | El ancho del video de salida en píxeles (predeterminado: 1280) |
| `height` | INT | Sí | 16 a MAX_RESOLUTION | La altura del video de salida en píxeles (predeterminado: 704) |
| `length` | INT | Sí | 1 a MAX_RESOLUTION | El número de fotogramas en la secuencia de video (predeterminado: 121) |
| `batch_size` | INT | Sí | 1 a 4096 | El número de lotes latentes a generar (predeterminado: 1) |
