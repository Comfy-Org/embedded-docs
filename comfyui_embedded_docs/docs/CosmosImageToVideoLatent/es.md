...
| `ancho` | INT | Sí | 16 a MAX_RESOLUTION | El ancho del video de salida en píxeles (predeterminado: 1280) |
| `altura` | INT | Sí | 16 a MAX_RESOLUTION | La altura del video de salida en píxeles (predeterminado: 704) |
| `longitud` | INT | Sí | 1 a MAX_RESOLUTION | El número de fotogramas en la secuencia de video (predeterminado: 121) |
| `tamaño_lote` | INT | Sí | 1 a 4096 | El número de lotes latentes a generar (predeterminado: 1) |
