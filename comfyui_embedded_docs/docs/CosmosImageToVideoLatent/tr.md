...
| `genişlik` | INT | Evet | 16 ile MAX_RESOLUTION | Çıktı videosunun piksel cinsinden genişliği (varsayılan: 1280) |
| `yükseklik` | INT | Evet | 16 ile MAX_RESOLUTION | Çıktı videosunun piksel cinsinden yüksekliği (varsayılan: 704) |
| `uzunluk` | INT | Evet | 1 ile MAX_RESOLUTION | Video dizisindeki kare sayısı (varsayılan: 121) |
| `toplu_boyut` | INT | Evet | 1 ile 4096 | Oluşturulacak gizil temsil gruplarının sayısı (varsayılan: 1) |
| `başlangıç_görüntüsü` | IMAGE | Hayır | - | Video dizisinin başlangıcına kodlanacak isteğe bağlı görüntü |
