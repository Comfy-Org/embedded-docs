...
|-----------|-----------|----------|-------|-------------|
| `مدل` | MODEL | بله | - | مدلی که مقیاس‌گذاری فرکانس روی آن اعمال می‌شود |
| `ضریب مقیاس پایین` | FLOAT | خیر | 0 - 10 | فاکتور مقیاس‌گذاری برای مؤلفه‌های فرکانس پایین (پیش‌فرض: 1.0) |
| `ضریب مقیاس بالا` | FLOAT | خیر | 0 - 10 | فاکتور مقیاس‌گذاری برای مؤلفه‌های فرکانس بالا (پیش‌فرض: 1.25) |
| `آستانه فرکانس` | INT | خیر | 1 - 10000 | تعداد اندیس‌های فرکانسی اطراف مرکز که به عنوان فرکانس پایین در نظر گرفته می‌شوند (پیش‌فرض: 20) |

## خروجی‌ها

| نام خروجی | نوع داده | توضیحات |
|-------------|-----------|-------------|
| `مدل` | MODEL | مدل اصلاح‌شده با مقیاس‌گذاری وابسته به فرکانس اعمال‌شده بر تابع راهنمایی آن |
