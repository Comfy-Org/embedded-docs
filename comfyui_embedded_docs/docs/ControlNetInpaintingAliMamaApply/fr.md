...
| `vae` | VAE | Oui | - | Le VAE (Autoencodeur Variationnel) utilisé pour encoder et décoder les images |
| `image` | IMAGE | Oui | - | L'image d'entrée qui sert de guide de contrôle pour le ControlNet |
| `mask` | MASK | Oui | - | Le masque qui définit les zones de l'image à incruster |
