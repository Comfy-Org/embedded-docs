...
Le nœud ModelSamplingStableCascade applique les paramètres d'échantillonnage Stable Cascade à un modèle en appliquant une valeur de décalage aux paramètres d'échantillonnage. Il renvoie une copie corrigée du modèle d'entrée avec la configuration d'échantillonnage Stable Cascade personnalisée, en laissant le modèle d'origine inchangé.
...
| --- | --- | --- |
| `model` | Le modèle modifié auquel l'échantillonnage Stable Cascade a été appliqué | MODEL |
