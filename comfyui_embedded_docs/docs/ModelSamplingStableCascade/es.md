...
|-----------|-----------|----------|-------|-------------|
| `model` | MODEL | Sí | - | El modelo de entrada al que aplicar el muestreo de cascada estable |
| `shift` | FLOAT | Sí | 0.0 - 100.0 | El valor de desplazamiento a aplicar a los parámetros de muestreo (por defecto: 2.0) |

## Salidas

| Nombre de Salida | Tipo de Dato | Descripción |
|-------------|-----------|-------------|
| `model` | MODEL | El modelo modificado con muestreo de cascada estable aplicado |