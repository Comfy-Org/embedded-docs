...
|-----------|--------------|-------------|-------|-------------|
| `latents` | LATENT | Sí | N/A | Lista de diccionarios latentes provenientes de MakeTrainingDataset. |
| `conditioning` | CONDITIONING | Sí | N/A | Lista de listas de condicionamiento provenientes de MakeTrainingDataset. |
| `folder_name` | STRING | No | N/A | Nombre de la carpeta para guardar el conjunto de datos (dentro del directorio de salida). (predeterminado: "training_dataset") |
| `shard_size` | INT | No | 1 a 100000 | Número de muestras por archivo de fragmento. (predeterminado: 1000) |
