...
| `length` | The total number of frames in the video sequence. Values increase in steps of 4 starting from 1 (1, 5, 9, 13, ...). (default: 33) | INT | Yes | 1 to MAX_RESOLUTION, step: 4 |
