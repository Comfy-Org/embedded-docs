...
| --- | --- | --- |
| `positive` | شرطی‌سازی مثبت اصلاح‌شده که اکنون ممکن است شامل تصویر شروع رمزگذاری‌شده یا خروجی CLIP vision باشد. | CONDITIONING |
| `negative` | شرطی‌سازی منفی اصلاح‌شده که اکنون ممکن است شامل تصویر شروع رمزگذاری‌شده یا خروجی CLIP vision باشد. | CONDITIONING |
