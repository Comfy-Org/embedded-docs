...
|-----------|--------------|-------------|-------|-------------|
| `cadena` | STRING | Sí | - | La cadena de texto de entrada de la que se extraerá. Admite texto de varias líneas. |
| `inicio` | INT | Sí | - | El índice de la posición inicial para la subcadena. El primer carácter se encuentra en el índice 0. |
| `fin` | INT | Sí | - | El índice de la posición final para la subcadena. El carácter en este índice no se incluye en el resultado. |

## Salidas

| Nombre de Salida | Tipo de Dato | Descripción |
|------------------|--------------|-------------|
| `output` | STRING | La subcadena extraída del texto de entrada, que contiene todos los caracteres desde la posición `inicio` hasta (sin incluir) la posición `fin`. |
