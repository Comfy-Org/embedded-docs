...
| `fps_string` | STRING | Uma string de texto descrevendo a taxa de quadros calculada (fps) com base na duração do áudio e no número de quadros de vídeo. Esta string deve ser usada no prompt para o modelo de vídeo. |
