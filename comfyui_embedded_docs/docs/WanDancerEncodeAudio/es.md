...
| `video_frames` | INT | Sí | Mín: 1, Máx: 268435456 (MAX_RESOLUTION), Paso: 4 | El número de fotogramas en el video de destino. Se utiliza para calcular la velocidad de fotogramas para la sincronización (predeterminado: 149). |
| `audio_inject_scale` | FLOAT | Sí | Mín: 0.0, Máx: 10.0, Paso: 0.01 | La escala para las características de audio cuando se inyectan en el modelo de video (predeterminado: 1.0). |
