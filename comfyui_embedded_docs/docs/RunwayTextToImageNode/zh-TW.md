...
| `ratio` | COMBO | 是 | "16:9"<br>"1:1"<br>"21:9"<br>"2:3"<br>"3:2"<br>"4:5"<br>"5:4"<br>"9:16"<br>"9:21" | 生成圖片的長寬比 |
| `reference_image` | IMAGE | 否 | - | 可選的參考圖片，用於引導生成過程 |
...
| 輸出名稱 | 資料類型 | 說明 |
|-------------|-----------|-------------|
| `output` | IMAGE | 根據文字提示和可選參考圖片生成的圖片 |
