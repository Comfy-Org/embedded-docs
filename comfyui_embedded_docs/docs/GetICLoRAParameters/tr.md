...
|-----------|-----------|----------|-------|-------------|
| `iclora_model` | MODEL | Evet | Yok | Meta verilerin çıkarılacağı belirli IC-LoRA için bir LoRA Yükleyici'den doğrudan çıktı. |

## Çıktılar

| Çıktı Adı | Veri Türü | Açıklama |
|-------------|-----------|-------------|
| `iclora_parameters` | IC_LORA_PARAMETERS | LoRA meta verilerinden çıkarılan IC-LoRA parametreleri (örneğin, reference_downscale_factor). LoRA, kılavuzların özel işlenmesini gerektiriyorsa LTXVAddGuide'a bağlayın. |
