...
| Parâmetro | Descrição | Tipo de Dados | Obrigatório | Intervalo |
| --- | --- | --- | --- | --- |
| `prompt` | Prompt que descreve o vídeo. Use identificadores como 'character1' e 'character2' para se referir aos personagens de referência. Deve conter pelo menos um personagem. | STRING | Sim | - |
