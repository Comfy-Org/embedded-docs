...
|-----------|-----------|----------|-------|-------------|
| `video` | VIDEO | 예 | - | 이미지를 추가할 비디오입니다. |
| `image` | IMAGE | 예 | - | 비디오에 추가할 이미지입니다. |
| `prompt_text` | STRING | 예 | - | 비디오에 추가할 내용에 대한 텍스트 설명입니다. |
| `negative_prompt` | STRING | 예 | - | 비디오에서 제외할 내용에 대한 텍스트 설명입니다. |
