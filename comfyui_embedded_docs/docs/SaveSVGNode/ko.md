...
| `filename_prefix` | STRING | 예 | - | 저장할 파일의 접두사입니다. %date:yyyy-MM-dd% 또는 %Empty Latent Image.width%와 같은 형식 정보를 포함하여 노드의 값을 포함시킬 수 있습니다. (기본값: "svg/ComfyUI") |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `ui` | DICT | ComfyUI 인터페이스에 표시하기 위한 파일 이름, 하위 폴더 및 유형을 포함한 파일 정보를 반환합니다 |
