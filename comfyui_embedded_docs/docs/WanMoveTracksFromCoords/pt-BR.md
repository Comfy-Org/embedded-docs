...
|-----------|--------------|-------------|-------|-----------|
| `track_coords` | STRING | Não | N/A | Uma string formatada em JSON contendo os dados de coordenadas para as trilhas. O valor padrão é uma lista vazia (`"[]"`). |
...
|---------------|--------------|-----------|
| `tracks` | TRACKS | Os dados de trilha gerados, contendo as coordenadas do caminho e informações de visibilidade para cada trilha. |
