...
| `quantité` | Le nombre d'éléments à extraire le long de la dimension spécifiée (par défaut : 1). Doit être au moins 1. Le nœud réduit automatiquement cette valeur si elle devait dépasser les données disponibles au-delà de l'index de départ | INT | Oui | 1 à 16384 |
