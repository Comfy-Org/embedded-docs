...
| --- | --- | --- | --- | --- |
| `eta` | Örnekleme sırasında eklenen stokastik gürültü miktarını kontrol eder (varsayılan: 1.0) | FLOAT | Evet | 0.0 - 100.0 (adım 0.01) |
| `s_noise` | Örnekleme süreci sırasında uygulanan gürültü ölçeğini kontrol eder (varsayılan: 1.0) | FLOAT | Evet | 0.0 - 100.0 (adım 0.01) |
