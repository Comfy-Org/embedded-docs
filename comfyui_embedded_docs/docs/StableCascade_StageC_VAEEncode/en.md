...
| `compression` | The compression factor applied to the image before encoding. The image dimensions are divided by this value, then multiplied by the VAE's downscale ratio. This is an advanced parameter. (default: 42) | INT | No | 4-128 |
