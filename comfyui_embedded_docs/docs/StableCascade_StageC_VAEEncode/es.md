...
|-----------|-----------|----------|-------|-------------|
| `image` | IMAGE | Sí | - | La imagen de entrada que será codificada en el espacio latente |
| `vae` | VAE | Sí | - | El modelo VAE utilizado para codificar la imagen |
| `compression` | INT | No | 4-128 | El factor de compresión aplicado a la imagen antes de la codificación (por defecto: 42) |
