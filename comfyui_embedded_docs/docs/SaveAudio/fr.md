...
Ce nœud enregistre les données audio dans un fichier au format FLAC. Il prend une entrée audio, l'écrit dans le répertoire de sortie en utilisant le préfixe de nom de fichier spécifié, et transmet également l'audio à sa sortie. Ce nœud est obsolète et doit être remplacé par le nœud Save Audio actuel.
...
Si l'entrée `audio` ne reçoit aucune donnée (par exemple, lorsque la vidéo source n'a pas de piste audio), le nœud déclenche une erreur et aucun fichier n'est enregistré.

## Sorties

| Nom de sortie | Description | Type de données |
|---------------|-------------|-----------------|
| `audio` | Les données audio fournies à l'entrée, transmises après l'enregistrement du fichier | AUDIO |
