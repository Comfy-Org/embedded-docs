...
|-----------|-----------|----------|-------|-------------|
| `value` | BOOLEAN | Sí | true<br>false | El valor booleano que se pasará a través del nodo |

## Salidas

| Nombre de Salida | Tipo de Dato | Descripción |
|-------------|-----------|-------------|
| `output` | BOOLEAN | El mismo valor booleano que se proporcionó como entrada |