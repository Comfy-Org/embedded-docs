...
| `max_shift` | FLOAT | 예 | 0.0 - 100.0 | 샘플링 계산을 위한 최대 시프트 값 (기본값: 1.15) |
| `base_shift` | FLOAT | 예 | 0.0 - 100.0 | 샘플링 계산을 위한 기본 시프트 값 (기본값: 0.5) |
| `width` | INT | 예 | 16 - MAX_RESOLUTION | 대상 이미지의 픽셀 단위 너비 (기본값: 1024) |
| `height` | INT | 예 | 16 - MAX_RESOLUTION | 대상 이미지의 픽셀 단위 높이 (기본값: 1024) |
