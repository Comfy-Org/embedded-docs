...
El nodo EmptyLatentHunyuan3Dv2 crea tensores latentes vacíos con el formato específico para los modelos de generación 3D Hunyuan3Dv2. Genera espacios latentes vacíos con las dimensiones y la estructura correctas que requiere la arquitectura Hunyuan3Dv2, lo que le permite iniciar flujos de trabajo de generación 3D desde cero. El nodo produce tensores latentes rellenos de ceros que sirven como base para los procesos posteriores de generación 3D.

## Entradas

| Parámetro | Descripción | Tipo de dato | Requerido | Rango |
| --- | --- | --- | --- | --- |
| `resolution` | La dimensión de resolución para el espacio latente (predeterminado: 3072) | INT | Sí | 1 - 8192 |
...
| --- | --- | --- |
| `LATENT` | Devuelve un tensor latente que contiene muestras vacías con formato para la generación 3D de Hunyuan3Dv2 | LATENT |
