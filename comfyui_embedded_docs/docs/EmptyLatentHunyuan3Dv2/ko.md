...
|-----------|-----------|----------|-------|-------------|
| `resolution` | INT | 예 | 1 - 8192 | 잠재 공간의 해상도 차원입니다 (기본값: 3072) |
| `batch_size` | INT | 예 | 1 - 4096 | 배치 내 잠재 이미지의 개수입니다 (기본값: 1) |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `LATENT` | LATENT | Hunyuan3Dv2 3D 생성을 위해 형식화된 빈 샘플이 포함된 잠재 텐서를 반환합니다 |
