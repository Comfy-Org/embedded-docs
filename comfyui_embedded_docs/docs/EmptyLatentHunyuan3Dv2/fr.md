...
| --- | --- | --- |
| `LATENT` | Renvoie un tenseur latent contenant des échantillons vides étiquetés avec le type « hunyuan3dv2 », formaté pour la génération 3D Hunyuan3Dv2 | LATENT |
