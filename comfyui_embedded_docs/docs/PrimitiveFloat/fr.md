...
Le nœud PrimitiveFloat crée une valeur numérique à virgule flottante qui peut être utilisée dans votre flux de travail. Il accepte une seule entrée numérique et génère cette même valeur, ce qui vous permet de définir et de transmettre des valeurs flottantes entre différents nœuds de votre pipeline ComfyUI.

## Entrées

| Paramètre | Description | Type de données | Requis | Plage |
| --- | --- | --- | --- | --- |
| `valeur` | La valeur numérique à virgule flottante à générer (par défaut : 0.0) | FLOAT | Oui | -sys.maxsize to sys.maxsize (step: 0.1) |
