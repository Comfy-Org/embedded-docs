...
| Parámetro | Descripción | Tipo de dato |
| --- | --- | --- |
| `mask` | La salida es una versión invertida de la máscara de entrada, donde las áreas previamente enmascaradas pasan a ser no enmascaradas y viceversa. | MASK |
