...
Bir dosyadan MoGe (Monoküler Geometri) modeli yükler ve onu geometri tahmini görevlerinde kullanıma hazırlar. Bu düğüm, `geometry_estimation` klasöründen bir model dosyası okur ve MoGe modelini eğitilmiş ağırlıklarıyla başlatır.
