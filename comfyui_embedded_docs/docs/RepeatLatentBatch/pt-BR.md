...
| Parâmetro | Tipo de Dados | Descrição |
|-----------|-------------|-------------|
| `latent`  | `LATENT`    | A saída é uma versão modificada das representações latentes de entrada, replicadas de acordo com o 'amount' especificado. Pode incluir máscaras de ruído replicadas e índices de lote ajustados, quando aplicável. |