...
| `intensité` | Force de lissage. 0 = brut, 1 = lissé. (par défaut : 1.0) | FLOAT | Oui | 0.0 à 1.0 (pas 0.05) |
| `méthode` | gaussian : moyenne pondérée symétrique, meilleur lisseur polyvalent.<br>savgol : ajustement polynomial glissant, préserve les pics nets. (par défaut : "savgol") | COMBO | Oui | "gaussian"<br>"savgol" |
| `fenêtre` | Fenêtre temporelle en images (valeurs impaires). (par défaut : 7) | INT | Oui | 1 à 51 (valeurs impaires, pas 2) |
