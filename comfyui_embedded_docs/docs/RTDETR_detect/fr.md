...
| `image` | L'image ou les images d'entrée dans lesquelles détecter des objets. Le nœud traite les images par lots de 32 maximum. | IMAGE | Oui | N/A |
...
| `max_detections` | Nombre maximal de détections à renvoyer par image. Par ordre décroissant de score de confiance (par défaut : 100). | INT | Non | N/A |
