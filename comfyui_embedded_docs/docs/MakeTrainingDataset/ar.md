...
|-----------|-----------|----------|-------|-------------|
| `صور` | IMAGE | نعم | غير متاح | قائمة الصور المراد ترميزها. |
...
| `نصوص` | STRING | لا | غير متاح | قائمة التسميات التوضيحية النصية. يمكن أن يكون طولها n (مطابق لعدد الصور)، أو 1 (مكرر لجميع الصور)، أو محذوفًا (يستخدم سلسلة فارغة). |
...
|-------------|-----------|-------------|
| `تكييف` | LATENT | قائمة من القواميس الكامنة. |
