...
|-----------|-----------|----------|-------|-------------|
| `النموذج1` | MODEL | نعم | - | النموذج الأول للدمج |
| `النموذج2` | MODEL | نعم | - | النموذج الثاني للدمج |
| `pos_embedder.` | FLOAT | نعم | 0.0 - 1.0 | وزن مكون مُضمّن الموضع (القيمة الافتراضية: 1.0) |
| `extra_pos_embedder.` | FLOAT | نعم | 0.0 - 1.0 | وزن مكون مُضمّن الموضع الإضافي (القيمة الافتراضية: 1.0) |
| `x_embedder.` | FLOAT | نعم | 0.0 - 1.0 | وزن مكون مُضمّن x (القيمة الافتراضية: 1.0) |
| `t_embedder.` | FLOAT | نعم | 0.0 - 1.0 | وزن مكون مُضمّن t (القيمة الافتراضية: 1.0) |
| `affline_norm.` | FLOAT | نعم | 0.0 - 1.0 | وزن مكون التسوية الأفينية (القيمة الافتراضية: 1.0) |
