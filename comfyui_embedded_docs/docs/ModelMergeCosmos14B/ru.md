...
| `pos_embedder.` | FLOAT | Да | 0.0 - 1.0 | Вес компонента внедрения позиции (по умолчанию: 1.0) |
| `extra_pos_embedder.` | FLOAT | Да | 0.0 - 1.0 | Вес дополнительного компонента внедрения позиции (по умолчанию: 1.0) |
| `x_embedder.` | FLOAT | Да | 0.0 - 1.0 | Вес компонента внедрения x (по умолчанию: 1.0) |
| `t_embedder.` | FLOAT | Да | 0.0 - 1.0 | Вес компонента внедрения t (по умолчанию: 1.0) |
