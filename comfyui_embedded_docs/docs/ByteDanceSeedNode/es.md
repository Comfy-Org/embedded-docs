...
| `model` | COMBO | Sí | `"Seed 2.0 Pro"`<br>`"Seed 2.0 Lite"`<br>`"Seed 2.0 Mini"` | El modelo Seed utilizado para generar la respuesta. |
...
| `system_prompt` | STRING | No | N/A | Instrucciones fundamentales que dictan el comportamiento del modelo. (por defecto: "") |
...
|------------------|--------------|-------------|
| `output` | STRING | La respuesta de texto generada por el modelo Seed. |
