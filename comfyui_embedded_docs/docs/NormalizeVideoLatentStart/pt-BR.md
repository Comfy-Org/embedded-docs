...
**Nota:** O `reference_frame_count` é automaticamente limitado ao número de quadros disponíveis após os quadros iniciais. Se o latente de vídeo tiver apenas 1 quadro, nenhuma normalização é realizada e o latente original é retornado inalterado.
