...
- Многовидовой режим требует версии модели Small или Base. Модели с другими типами головок (например, Metric или Mono) не поддерживают межвидовое внимание или оценку позы камеры.
