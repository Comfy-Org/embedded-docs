...
|---------|--------------|--------|--------|-------|
| `اسم النموذج` | STRING | نعم | قائمة ملفات النماذج في مجلد `frame_interpolation` | حدد نموذج استيفاء الإطارات لتحميله. يجب وضع النماذج في مجلد 'frame_interpolation'. |

## المخرجات

| اسم المخرج | نوع البيانات | الوصف |
|------------|--------------|-------|
| `FRAME_INTERPOLATION_MODEL` | MODEL | النموذج المحمّل والمهيأ لاستيفاء الإطارات، جاهز للاستخدام في العقد الأخرى. |
