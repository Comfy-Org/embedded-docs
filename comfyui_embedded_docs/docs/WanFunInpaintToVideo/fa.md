...
| --- | --- | --- | --- | --- |
| `مثبت` | پرامپت‌های conditioning مثبت برای تولید ویدئو | CONDITIONING | بله | - |
| `منفی` | پرامپت‌های conditioning منفی برای پرهیز در تولید ویدئو | CONDITIONING | بله | - |
...
| `اندازه دسته` | تعداد ویدئوها برای تولید در یک دسته (پیش‌فرض: 1) | INT | بله | 1 تا 4096 |
| `خروجی clip vision` | خروجی CLIP vision اختیاری که به‌عنوان conditioning برای تصویر شروع استفاده می‌شود | CLIP_VISION_OUTPUT | خیر | - |
| `تصویر شروع` | تصویر فریم شروع اختیاری برای تولید ویدئو | IMAGE | خیر | - |
| `تصویر پایان` | تصویر فریم پایان اختیاری برای تولید ویدئو | IMAGE | خیر | - |
