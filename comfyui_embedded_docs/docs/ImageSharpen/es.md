...
|----------------|-------------|-----------------------------------------------------------------------------------------------|
| `imagen`        | `IMAGE`     | La imagen de entrada que se va a enfocar. Este parámetro es fundamental, ya que determina la imagen base sobre la cual se aplicará el efecto de enfoque. |
| `radio_afinado`| `INT`       | Define el radio del efecto de enfoque. Un radio mayor significa que más píxeles alrededor del borde se verán afectados, lo que genera un efecto de enfoque más pronunciado. |
...
| `alfa`        | `FLOAT`     | Ajusta la intensidad del efecto de enfoque. Los valores de alfa más altos producen un efecto de enfoque más fuerte. |

## Salidas

| Campo  | Tipo de Dato | Descripción                                                              |
|--------|-------------|--------------------------------------------------------------------------|
| `imagen`| `IMAGE`     | La imagen enfocada, con bordes y detalles mejorados, lista para su posterior procesamiento o visualización. |