...
|-----------------|-----------|-------------------------------------------------------------------------------------------|
| `görüntü`         | `IMAGE`   | Keskinleştirilecek giriş görüntüsü. Bu parametre, keskinleştirme efektinin uygulanacağı temel görüntüyü belirlediği için kritik öneme sahiptir. |
| `keskinleştirme_yarıçapı`| `INT`     | Keskinleştirme efektinin yarıçapını tanımlar. Daha büyük bir yarıçap, kenar çevresinde daha fazla pikselin etkileneceği anlamına gelir ve bu da daha belirgin bir keskinleştirme efekti sağlar. |
...
| `alfa`         | `FLOAT`   | Keskinleştirme efektinin yoğunluğunu ayarlar. Daha yüksek alfa değerleri, daha güçlü bir keskinleştirme efekti sağlar. |

## Çıktılar

| Alan   | Veri Türü | Açıklama                                                                              |
|--------|-----------|--------------------------------------------------------------------------------------|
| `görüntü`| `IMAGE`   | Kenarları ve detayları vurgulanmış, daha ileri işleme veya görüntüleme için hazır, keskinleştirilmiş görüntü. |