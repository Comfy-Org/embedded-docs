...
| `سيغما`        | `FLOAT`     | يتحكم في انتشار تأثير الحدّة. القيمة الأعلى لـ `sigma` تؤدي إلى انتقال أكثر سلاسة عند الحواف، بينما تجعل القيمة الأقل عملية الحدّة أكثر تمركزًا. |
| `ألفا`        | `FLOAT`     | يضبط شدة تأثير الحدّة. القيم الأعلى لـ `alpha` تؤدي إلى تأثير حدّة أقوى. |
