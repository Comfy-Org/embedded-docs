...
| ----------- | ------------- | ---------- | ------- | --------- | ------------------------------ | ---------------------------- |
| `model`     | MODEL         | إدخال      | -       | -         | **نوع اللوحة**: مواد اللوحات المختلفة تحتاج لصيغ طلاء مختلفة | كائن نموذج الانتشار، يحدد أساس حساب سيغما |
| `scheduler` | COMBO[STRING] | واجهة      | -       | 9 خيارات  | **تقنية المزج**: اختر كيف يتغير تركيز الطلاء | خوارزمية الجدولة، تتحكم في نمط اضمحلال الضوضاء |
| `steps`     | INT           | واجهة      | 20      | 1-10000   | **عدد مرات المزج**: فرق الدقة بين 20 مزجًا و50 مزجًا | خطوات أخذ العينات، تؤثر على جودة التوليد وسرعته |
| `denoise`   | FLOAT         | واجهة      | 1.0     | 0.0-1.0   | **شدة الإبداع**: تحكم في المستوى من الضبط الدقيق إلى إعادة الرسم | قوة إزالة الضوضاء، تدعم سيناريوهات إعادة الرسم الجزئي |
