...
| `steps`     | INT           | Widget     | 20      | 1-10000   | **Karıştırma Sayısı**: 20 karıştırma ile 50 karıştırmanın hassasiyet farkı | Örnekleme adımları, oluşturma kalitesini ve hızını etkiler |
| `denoise`   | FLOAT         | Widget     | 1.0     | 0.0-1.0   | **Oluşturma Yoğunluğu**: İnce ayardan yeniden boyamaya kadar kontrol seviyesi | Gürültü giderme gücü, kısmi yeniden boyama senaryolarını destekler |
