...
| ----------- | ------------- | ---------- | ------- | --------- | ------------------------------ | ---------------------------- |
| `model` | MODEL | ورودی | - | - | **نوع بوم**: جنس بوم‌های مختلف به فرمول‌های رنگ متفاوتی نیاز دارد | شیء مدل انتشار، مبنای محاسبه سیگما را تعیین می‌کند |
| `scheduler` | COMBO[STRING] | ویجت | - | 9 گزینه | **تکنیک ترکیب**: انتخاب نحوه تغییر غلظت رنگ | الگوریتم زمان‌بندی، نحوه کاهش نویز را کنترل می‌کند |
| `steps` | INT | ویجت | 20 | 1-10000 | **تعداد ترکیب**: تفاوت دقت 20 بار ترکیب در مقابل 50 بار | گام‌های نمونه‌گیری، بر کیفیت تولید و سرعت تأثیر می‌گذارد |
| `denoise` | FLOAT | ویجت | 1.0 | 0.0-1.0 | **شدت خلق**: کنترل سطح از تنظیم دقیق تا بازآفرینی کامل | قدرت نویززدایی، از سناریوهای بازآفرینی جزئی پشتیبانی می‌کند |
