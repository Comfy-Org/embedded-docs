...
| `front` | Vista cuadrada del lado frontal del objeto, con alfa o sobre un fondo negro, encuadrada como el rig: el objeto abarca aproximadamente 1/1.1 del encuadre en su punto más ancho, con la misma escala en cada vista. La primera vista conectada (en orden frontal, izquierda, trasera, derecha) es el frente al que se posa la malla. | IMAGE | No | N/A |
| `left` | Vista cuadrada del lado izquierdo del objeto, con alfa o sobre un fondo negro, encuadrada como el rig: el objeto abarca aproximadamente 1/1.1 del encuadre en su punto más ancho, con la misma escala en cada vista. La primera vista conectada (en orden frontal, izquierda, trasera, derecha) es el frente al que se posa la malla. | IMAGE | No | N/A |
| `back` | Vista cuadrada del lado trasero del objeto, con alfa o sobre un fondo negro, encuadrada como el rig: el objeto abarca aproximadamente 1/1.1 del encuadre en su punto más ancho, con la misma escala en cada vista. La primera vista conectada (en orden frontal, izquierda, trasera, derecha) es el frente al que se posa la malla. | IMAGE | No | N/A |
| `right` | Vista cuadrada del lado derecho del objeto, con alfa o sobre un fondo negro, encuadrada como el rig: el objeto abarca aproximadamente 1/1.1 del encuadre en su punto más ancho, con la misma escala en cada vista. La primera vista conectada (en orden frontal, izquierda, trasera, derecha) es el frente al que se posa la malla. | IMAGE | No | N/A |
