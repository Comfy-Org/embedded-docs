...
| `clip_l` | Texto de entrada para o processamento pelo modelo CLIP-L. Suporta texto multilinha e prompts dinâmicos. | STRING | Sim | - |
| `clip_g` | Texto de entrada para o processamento pelo modelo CLIP-G. Suporta texto multilinha e prompts dinâmicos. | STRING | Sim | - |
| `t5xxl` | Texto de entrada para o processamento pelo modelo T5-XXL. Suporta texto multilinha e prompts dinâmicos. | STRING | Sim | - |
| `llama` | Texto de entrada para o processamento pelo modelo LLaMA. Suporta texto multilinha e prompts dinâmicos. | STRING | Sim | - |
