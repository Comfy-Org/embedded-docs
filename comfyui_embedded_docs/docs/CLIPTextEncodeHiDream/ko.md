...
| `clip_l` | STRING | 여러 줄 텍스트 | - | - | CLIP-L 모델 처리를 위한 텍스트 입력 |
| `clip_g` | STRING | 여러 줄 텍스트 | - | - | CLIP-G 모델 처리를 위한 텍스트 입력 |
| `t5xxl` | STRING | 여러 줄 텍스트 | - | - | T5-XXL 모델 처리를 위한 텍스트 입력 |
| `llama` | STRING | 여러 줄 텍스트 | - | - | LLaMA 모델 처리를 위한 텍스트 입력 |
