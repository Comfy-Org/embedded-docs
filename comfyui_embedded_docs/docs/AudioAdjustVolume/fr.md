...
|-----------|-----------------|--------|-------|-------------|
| `audio` | AUDIO | Oui | - | L'entrée audio à traiter |
| `volume` | INT | Oui | -100 à 100 | Ajustement du volume en décibels (dB). 0 = aucun changement, +6 = double, -6 = moitié, etc. (valeur par défaut : 1) |
