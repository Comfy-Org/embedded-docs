...
| `longer_edge` | INT | Sí | 1 - 8192 | Longitud objetivo para el borde más largo. El borde más corto se escalará proporcionalmente. (valor predeterminado: 1024) |

## Salidas

| Nombre de salida | Tipo de dato | Descripción |
|------------------|--------------|-------------|
| `image` | IMAGE | La imagen o lote de imágenes redimensionadas. La salida tendrá la misma cantidad de imágenes que la entrada, y el borde más largo de cada una coincidirá con la longitud especificada en `longer_edge`. |
