...
|-----------|-----------|---------|--------|-----------|
| `conditioning` | CONDITIONING | Evet | - | Kancaların ekleneceği koşullandırma verileri |
| `hooks` | HOOKS | Evet | - | Koşullandırma verilerine uygulanacak kanca tanımları |

## Çıkışlar

| Çıkış Adı | Veri Türü | Açıklama |
|-----------|-----------|-----------|
| `conditioning` | CONDITIONING | Kancalar eklenmiş değiştirilmiş koşullandırma verileri |
