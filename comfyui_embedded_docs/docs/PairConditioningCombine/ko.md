...
|-----------|-----------|----------|-------|-------------|
| `positive_A` | CONDITIONING | 예 | - | 첫 번째 양성 컨디셔닝 입력 |
| `negative_A` | CONDITIONING | 예 | - | 첫 번째 음성 컨디셔닝 입력 |
| `positive_B` | CONDITIONING | 예 | - | 두 번째 양성 컨디셔닝 입력 |
| `negative_B` | CONDITIONING | 예 | - | 두 번째 음성 컨디셔닝 입력 |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `positive` | CONDITIONING | 결합된 양성 컨디셔닝 출력 |
