...
Agrandit rapidement une image via un appel API Stability, jusqu'à 4 fois sa taille d'origine. Ce nœud est spécifiquement conçu pour agrandir des images de faible qualité ou compressées en les envoyant au service de mise à l'échelle rapide de Stability AI.
