...
Este nodo utiliza la API Tencent Hunyuan3D para identificar y generar automáticamente los componentes de un modelo 3D según su estructura. Acepta un modelo FBX, lo procesa y devuelve un nuevo archivo FBX.
...
|------------------|-------------|---------------|
| `FBX` | El modelo 3D procesado, devuelto como archivo FBX. | FILE3DFBX |
