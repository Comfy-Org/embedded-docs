...
This node uses the Tencent Hunyuan3D API to automatically analyze a 3D model and identify or generate its components based on the model structure. It processes the model and returns a new FBX file.
