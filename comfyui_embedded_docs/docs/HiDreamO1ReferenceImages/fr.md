...
|-----------|-----------------|--------|-------|-------------|
| `positif` | CONDITIONING | Oui | - | Le conditionnement positif auquel attacher les images de référence. |
| `négatif` | CONDITIONING | Oui | - | Le conditionnement négatif auquel attacher les images de référence. |
| `images` | IMAGE | Oui | 1 à 10 images | Images de référence. 1 image permet l'édition basée sur une instruction ; 2 à 10 images permettent la personnalisation multi-référence pilotée par un sujet. |
...
|---------------|-----------------|-------------|
| `négatif` | CONDITIONING | Le conditionnement positif avec les images de référence attachées. |
| `négatif` | CONDITIONING | Le conditionnement négatif avec les images de référence attachées. |
