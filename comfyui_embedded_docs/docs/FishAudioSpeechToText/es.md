# Voz a texto de Fish Audio

Este nodo transcribe audio a texto mediante el servicio de reconocimiento de voz a texto de Fish Audio. Detecta automáticamente el idioma del audio y, opcionalmente, puede devolver segmentos con marcas de tiempo a nivel de palabra como JSON.
