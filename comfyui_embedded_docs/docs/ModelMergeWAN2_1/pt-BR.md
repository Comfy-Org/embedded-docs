...
| `time_embedding.` | Peso para o componente de embedding de tempo (padrão: 1.0) | FLOAT | Sim | 0.0 - 1.0 |
| `time_projection.` | Peso para o componente de projeção de tempo (padrão: 1.0) | FLOAT | Sim | 0.0 - 1.0 |
...
| --- | --- | --- |
| `model` | O modelo mesclado que combina componentes dos dois modelos de entrada de acordo com os pesos especificados | MODEL |
