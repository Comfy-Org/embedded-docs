...
| `denoise` | `FLOAT` | Le paramètre denoise ajuste le point de départ de la séquence sigma, permettant un contrôle plus précis du niveau de débruitage appliqué lors de la génération d'images. |
