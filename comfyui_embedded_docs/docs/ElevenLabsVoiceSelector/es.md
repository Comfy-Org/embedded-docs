...
|-----------|--------------|-------------|-------|-------------|
| `voz` | STRING | Sí | `"Adam"`<br>`"Antoni"`<br>`"Arnold"`<br>`"Bella"`<br>`"Domi"`<br>`"Elli"`<br>`"Josh"`<br>`"Rachel"`<br>`"Sam"` | Elige una voz de la lista predefinida de voces de ElevenLabs. |

## Salidas

| Nombre de salida | Tipo de dato | Descripción |
|------------------|--------------|-------------|
| `voz` | STRING | El identificador único de la voz seleccionada de ElevenLabs, que puede pasarse a otros nodos para la generación de texto a voz. |
