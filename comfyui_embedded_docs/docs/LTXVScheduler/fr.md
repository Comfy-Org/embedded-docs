...
|-----------|-----------------|--------|-------|-------------|
| `steps` | INT | Oui | 1-10000 | Nombre d'étapes d'échantillonnage (par défaut : 20) |
| `max_shift` | FLOAT | Oui | 0.0-100.0 | Valeur de décalage maximale pour le calcul sigma (par défaut : 2.05) |
| `base_shift` | FLOAT | Oui | 0.0-100.0 | Valeur de décalage de base pour le calcul sigma (par défaut : 0.95) |
| `stretch` | BOOLEAN | Oui | Vrai/Faux | Étirer les sigmas pour qu'ils soient dans la plage [terminal, 1] (par défaut : Vrai) |
