...
| `늘이기` | BOOLEAN | 예 | True/False | 시그마를 [terminal, 1] 범위로 늘리기 (기본값: True) |
| `종료값` | FLOAT | 예 | 0.0-0.99 | 늘린 후 시그마의 종료 값 (기본값: 0.1) |
| `잠재 비디오` | LATENT | 아니요 | - | 시그마 조정을 위한 토큰 수 계산에 사용되는 선택적 잠재 입력 |
