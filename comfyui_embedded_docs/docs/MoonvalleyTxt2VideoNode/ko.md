...
|-----------|-----------|----------|-------|-------------|
| `prompt` | STRING | 예 | - | 생성할 비디오 콘텐츠의 텍스트 설명 |
| `negative_prompt` | STRING | 아니요 | - | 네거티브 프롬프트 텍스트 (기본값: 합성, 장면 전환, 아티팩트, 노이즈 등 제외 요소의 광범위한 목록) |
| `resolution` | STRING | 아니요 | "16:9 (1920 x 1080)"<br>"9:16 (1080 x 1920)"<br>"1:1 (1152 x 1152)"<br>"4:3 (1536 x 1152)"<br>"3:4 (1152 x 1536)"<br>"21:9 (2560 x 1080)" | 출력 비디오의 해상도 (기본값: "16:9 (1920 x 1080)") |
| `prompt_adherence` | FLOAT | 아니요 | 1.0-20.0 | 생성 제어를 위한 가이던스 스케일 (기본값: 4.0) |
| `seed` | INT | 아니요 | 0-4294967295 | 무작위 시드 값 (기본값: 9) |
| `steps` | INT | 아니요 | 1-100 | 추론 단계 (기본값: 33) |
