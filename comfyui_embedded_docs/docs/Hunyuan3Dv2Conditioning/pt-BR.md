...
|-------------|-------------|-----------|
| `positivo` | Dados de condicionamento positivo contendo os embeddings do CLIP vision | CONDITIONING |
| `negativo` | Dados de condicionamento negativo contendo embeddings com valor zero que correspondem à forma dos embeddings positivos | CONDITIONING |
