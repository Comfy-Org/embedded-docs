...
|-----------|-----------------|--------|-------|-------------|
| `sortie_vision_clip` | CLIP_VISION_OUTPUT | Oui | - | La sortie d'un modèle de vision CLIP contenant des embeddings visuels |

## Sorties

| Nom de sortie | Type de données | Description |
|---------------|-----------------|-------------|
| `negative` | CONDITIONING | Données de conditionnement positives contenant les embeddings de la vision CLIP |
