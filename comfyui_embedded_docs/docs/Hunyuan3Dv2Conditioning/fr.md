...
|-----------|-----------|----------|-------|-------------|
| `clip_vision_output` | CLIP_VISION_OUTPUT | Oui | - | La sortie d'un modèle vision CLIP contenant les embeddings visuels |

## Sorties

| Nom de sortie | Type de données | Description |
|-------------|-----------|-------------|
| `positive` | CONDITIONING | Données de conditionnement positives contenant les embeddings vision CLIP |
