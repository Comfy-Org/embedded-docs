...
| Parámetro | Descripción | Tipo de dato | Python dtype |
| --- | --- | --- | --- |
| `model` | El modelo modificado con la estrategia de muestreo discreto aplicada. Este modelo ahora está preparado para generar muestras utilizando el método y los ajustes especificados. | MODEL | `torch.nn.Module` |
