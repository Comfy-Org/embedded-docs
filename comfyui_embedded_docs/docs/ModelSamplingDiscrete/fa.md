...
| پارامتر | توضیحات | نوع داده | نوع پایتون |
| --- | --- | --- | --- |
| `model` | مدل تغییر یافته با استراتژی نمونه‌گیری گسسته اعمال‌شده. این مدل اکنون قادر است با استفاده از روش و تنظیمات مشخص‌شده، نمونه تولید کند. | MODEL | `torch.nn.Module` |
