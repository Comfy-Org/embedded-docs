...
| `sampling`| COMBO[STRING] | `str`           | Modele uygulanacak ayrık örnekleme yöntemini belirtir. Yöntem seçimi, modelin örnekleri nasıl ürettiğini etkileyerek örnekleme için farklı stratejiler sunar. |
