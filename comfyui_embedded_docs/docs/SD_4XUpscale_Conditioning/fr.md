...
| `ratio_d'échelle` | Facteur de mise à l'échelle appliqué aux images d'entrée (par défaut : 4.0) | FLOAT | Oui | 0.0 - 10.0 |
| `augmentation_du_bruit` | Quantité de bruit à ajouter pendant le processus d'agrandissement (par défaut : 0.0) | FLOAT | Oui | 0.0 - 1.0 |
