...
|-----------|-------------|-------------|
| `image`   | `IMAGE`     | O parâmetro 'image' representa o tensor da imagem de entrada do qual os canais RGB e alfa serão separados. Ele é essencial para a operação, pois fornece os dados de origem para a divisão. |
