...
|------------------|--------------|-------------|
| `output_1` | COMBO | Genera el valor seleccionado del primer cuadro combinado (`combo`). |
| `output_2` | COMBO | Genera el valor seleccionado del segundo cuadro combinado (`combo2`). |
