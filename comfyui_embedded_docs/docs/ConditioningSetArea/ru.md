...
| `width`   | `INT`      | Определяет ширину области, задаваемой в контексте кондиционирования, влияя на горизонтальный охват корректировки. |
| `height`  | `INT`      | Определяет высоту задаваемой области, влияя на вертикальный охват модификации кондиционирования. |
...
| `strength`| `FLOAT`    | Определяет интенсивность модификации кондиционирования в пределах указанной области, позволяя тонко контролировать влияние корректировки. |
