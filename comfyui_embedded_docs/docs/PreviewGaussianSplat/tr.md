...
| `width` | Önizleme görüntüsünün piksel cinsinden genişliği (varsayılan: 1024). | INT | Evet | 1 ile 4096 |
| `height` | Önizleme görüntüsünün piksel cinsinden yüksekliği (varsayılan: 1024). | INT | Evet | 1 ile 4096 |
