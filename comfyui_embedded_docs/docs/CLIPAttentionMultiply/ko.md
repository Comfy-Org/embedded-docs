...
| `q` | FLOAT | 예 | 0.0 - 10.0 | 쿼리 투영 가중치 및 편향에 대한 곱셈 계수 (기본값: 1.0) |
| `k` | FLOAT | 예 | 0.0 - 10.0 | 키 투영 가중치 및 편향에 대한 곱셈 계수 (기본값: 1.0) |
| `v` | FLOAT | 예 | 0.0 - 10.0 | 값 투영 가중치 및 편향에 대한 곱셈 계수 (기본값: 1.0) |
| `out` | FLOAT | 예 | 0.0 - 10.0 | 출력 투영 가중치 및 편향에 대한 곱셈 계수 (기본값: 1.0) |
