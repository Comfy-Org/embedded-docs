...
|-----------|-----------|----------|-------|-------------|
| `clip` | CLIP | بله | - | مدل CLIP برای اصلاح |
| `q` | FLOAT | بله | 0.0 - 10.0 | ضریب ضرب برای وزن‌ها و بایاس‌های بردار پرس‌وجو (پیش‌فرض: 1.0) |
| `k` | FLOAT | بله | 0.0 - 10.0 | ضریب ضرب برای وزن‌ها و بایاس‌های بردار کلید (پیش‌فرض: 1.0) |
| `v` | FLOAT | بله | 0.0 - 10.0 | ضریب ضرب برای وزن‌ها و بایاس‌های بردار مقدار (پیش‌فرض: 1.0) |
| `out` | FLOAT | بله | 0.0 - 10.0 | ضریب ضرب برای وزن‌ها و بایاس‌های بردار خروجی (پیش‌فرض: 1.0) |

## خروجی‌ها

| نام خروجی | نوع داده | توضیحات |
|-------------|-----------|-------------|
| `CLIP` | CLIP | یک مدل CLIP اصلاح‌شده با اعمال ضرایب مقیاس‌دهی توجه مشخص شده را برمی‌گرداند |
