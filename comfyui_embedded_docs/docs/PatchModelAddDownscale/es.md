...
| `factor_de_reducción` | FLOAT | No | 0.1-9.0 | El factor de reducción de escala para las características (predeterminado: 2.0) |
...
| `reducción_después_de_omitir` | BOOLEAN | No | - | Si se aplica la reducción de escala después de las conexiones de salto (predeterminado: True) |
