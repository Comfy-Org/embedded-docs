...
| `downscale_factor` | FLOAT | No | 0.1-9.0 | El factor de reducción de escala para las características (predeterminado: 2.0) |
...
| `downscale_after_skip` | BOOLEAN | No | - | Si se aplica la reducción de escala después de las conexiones de salto (predeterminado: True) |
