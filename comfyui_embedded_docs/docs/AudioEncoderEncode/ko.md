...
|-----------|-----------|------------|---------|-------|-------------|
| `audio_encoder` | AUDIO_ENCODER | 필수 | - | - | 오디오 입력을 처리하는 데 사용되는 오디오 인코더 모델입니다 |
| `audio` | AUDIO | 필수 | - | - | 파형 및 샘플 속도 정보를 포함하는 오디오 데이터입니다 |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `output` | AUDIO_ENCODER_OUTPUT | 오디오 인코더에 의해 생성된 인코딩된 오디오 표현입니다 |
