...
| --- | --- | --- |
| `ancho` | El ancho de la imagen de entrada en píxeles | INT |
| `alto` | El alto de la imagen de entrada en píxeles | INT |
| `tamaño_de_lote` | El número de imágenes en el lote | INT |
