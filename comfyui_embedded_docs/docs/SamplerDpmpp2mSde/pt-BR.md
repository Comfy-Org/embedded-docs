...
| `eta`           | `FLOAT`      | Determina o tamanho do passo na integração numérica, afetando a granularidade do processo de amostragem. Um valor maior indica um tamanho de passo maior. |
...
| `noise_device`  | COMBO[STRING] | Indica o dispositivo computacional ('gpu' ou 'cpu') no qual o processo de geração de ruído é executado, afetando o desempenho e a eficiência. |
