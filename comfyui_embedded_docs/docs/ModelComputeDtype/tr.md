...
ModelComputeDtype düğümü, bir modelin işleme sırasında kullandığı hesaplama veri türünü (hassasiyet) değiştirir. Girdi modelinin bir kopyasını oluşturur ve seçilen hassasiyet ayarını uygular; bu, donanımınıza bağlı olarak bellek kullanımını ve performansı optimize etmeye yardımcı olabilir. Farklı hassasiyet yapılandırmalarını hata ayıklamak ve test etmek için kullanışlıdır.

## Girdiler

| Parametre | Açıklama | Veri Türü | Gerekli | Aralık |
| --- | --- | --- | --- | --- |
| `model` | Yeni bir hesaplama veri türüyle değiştirilecek girdi modeli | MODEL | Evet | - |
| `veri_türü` | Modele uygulanacak hesaplama veri türü (varsayılan: "default"). Bu parametre gelişmiş bir seçenek olarak işaretlenmiştir. | COMBO | Evet | "default"<br>"fp32"<br>"fp16"<br>"bf16" |
