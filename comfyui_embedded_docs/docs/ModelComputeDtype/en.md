...
| `dtype` | The computational data type to apply to the model (default: "default"). This parameter is marked as an advanced setting in the UI. | COMBO | Yes | "default"<br>"fp32"<br>"fp16"<br>"bf16" |
