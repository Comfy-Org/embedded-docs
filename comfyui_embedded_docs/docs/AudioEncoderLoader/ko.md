...
|-----------|-----------|----------|-------|-------------|
| `audio_encoder_name` | STRING | 예 | audio_encoders 폴더에 있는 사용 가능한 오디오 인코더 파일 목록 | 로드할 오디오 인코더 모델 파일을 선택합니다 |

## 출력

| 출력 이름 | 데이터 타입 | 설명 |
|-------------|-----------|-------------|
| `audio_encoder` | AUDIO_ENCODER | 로드된 오디오 인코더 모델로, 오디오 처리 워크플로우에서 사용할 준비가 되었습니다 |
