...
Bu düğüm, her örnekleme adımında fazladan bir geçiş çalıştırarak LTXV video oluşturmanın uzamsal ayrıntısını ve hareket tutarlılığını iyileştirir. Bu geçiş sırasında, seçilen transformer bloklarının öz-dikkati bir değer geçişine indirgenir ve oluşturma bu indirgenmiş sonuçtan uzağa yönlendirilir.
...
|-------------|-------------|-----------|
| `MODEL` | Uzamsal-zamansal yönlendirme işlevi eklenmiş klonlanmış model. | MODEL |
