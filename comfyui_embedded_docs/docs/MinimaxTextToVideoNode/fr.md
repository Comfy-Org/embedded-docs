...
|-----------|-----------------|--------|-------|-------------|
| `texte d'invite` | STRING | Oui | - | Prompt textuel pour guider la génération vidéo |
| `modèle` | COMBO | Non | "T2V-01"<br>"T2V-01-Director" | Modèle à utiliser pour la génération vidéo (par défaut : "T2V-01") |
