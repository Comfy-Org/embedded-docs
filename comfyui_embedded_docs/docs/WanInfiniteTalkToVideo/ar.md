...
| --- | --- | --- |
| `model` | النموذج المُصحّح مع تطبيق التكييف الصوتي. | MODEL |
| `positive` | التكييف الإيجابي، وربما تم تعديله بسياق إضافي (مثل صورة البداية، رؤية CLIP). | CONDITIONING |
| `negative` | التكييف السلبي، وربما تم تعديله بسياق إضافي. | CONDITIONING |
| `latent` | تسلسل الفيديو المُولّد في الفضاء الكامن. | LATENT |
