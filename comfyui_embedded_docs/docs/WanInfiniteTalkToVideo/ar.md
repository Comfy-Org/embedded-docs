...
| --- | --- | --- |
| `النموذج` | النموذج المُصحّح مع تطبيق التكييف الصوتي. | MODEL |
| `إيجابي` | التكييف الإيجابي، وربما تم تعديله بسياق إضافي (مثل صورة البداية، رؤية CLIP). | CONDITIONING |
| `سلبي` | التكييف السلبي، وربما تم تعديله بسياق إضافي. | CONDITIONING |
| `الفضاء الكامن` | تسلسل الفيديو المُولّد في الفضاء الكامن. | LATENT |
| `قص الصورة` | عدد الإطارات من بداية سياق الحركة التي يجب قصها عند تمديد تسلسل. | INT |
