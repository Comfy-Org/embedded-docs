...
Este nó fornece um amostrador configurável para geração de imagens. Ele é baseado em um solucionador de equação diferencial estocástica (SDE) e pode se comportar como vários amostradores específicos dependendo de suas configurações, incluindo `seeds_2`, `exp_heun_2_x0` e `exp_heun_2_x0_sde`.
...
**Nota:** A descrição do nó define as seguintes predefinições de amostrador:
