...
|-----------|-----------------|--------|-------|-------------|
| `solver_type` | COMBO | Oui | `"phi_1"`<br>`"phi_2"` | Sélectionne l'algorithme de solveur sous-jacent pour l'échantillonneur. |
...
|---------------|-----------------|-------------|
| `sampler` | SAMPLER | Un objet échantillonneur configuré pouvant être transmis à d'autres nœuds d'échantillonnage. |
