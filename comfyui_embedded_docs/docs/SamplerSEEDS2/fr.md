...
Selon les paramètres définis, cet échantillonneur peut représenter :
...
| --- | --- | --- |
| `sampler` | Un objet échantillonneur configuré qui peut être passé à d'autres nœuds d'échantillonnage. | SAMPLER |
