...
Gera tokens de música e condicionamento acústico a partir de um estilo, letra e notação ABC. Retorna o condicionamento e a duração gerada em segundos, que devem ser fornecidos ao nó Empty YuE2 Latent Audio. Se a entrada ABC for deixada vazia, o modo selecionado é ignorado e o modo off é usado automaticamente.

## Entradas

| Parâmetro | Descrição | Tipo de Dados | Obrigatório | Intervalo |
|-----------|-------------|-----------|----------|-------|
| `clip` | O modelo CLIP usado para tokenizar e codificar as entradas de música. | CLIP | Sim | - |
| `style` | Texto que descreve o estilo musical. Suporta entrada multilinha e prompts dinâmicos. | STRING | Sim | Texto multilinha |
| `lyrics` | Letra da música gerada. Suporta entrada multilinha e prompts dinâmicos. | STRING | Sim | Texto multilinha |
...
| `top_p` | Limite de probabilidade da amostragem por núcleo. padrão: 0.95 (avançado) | FLOAT | Sim | 0.01 a 1.0 |
...
Observação: Se `abc` estiver vazio ou contiver apenas espaços em branco, a seleção de `mode` é ignorada e o modo off é usado automaticamente.
