...
| `duration` | INT | Sí | 5 a 10 | La duración del video generado en segundos. El valor debe ser un múltiplo de 5 (predeterminado: 5). |
| `seed` | INT | No | 0 a 2147483647 | Un valor de semilla aleatoria para obtener resultados reproducibles. Un valor de 0 generará una semilla aleatoria. |
...
| `watermark` | BOOLEAN | No | - | Cuando está habilitado, se agrega una marca de agua generada por IA al video final (predeterminado: False). |
