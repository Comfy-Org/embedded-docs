...
| `النموذج` | النموذج المستخدم لتحويل الكلام إلى كلام. يوفر كل خيار مجموعة محددة من إعدادات الصوت (تعزيز التشابه، الأسلوب، استخدام تعزيز المتحدث، السرعة). | DYNAMIC_COMBO | لا | `eleven_multilingual_sts_v2`<br>`eleven_english_sts_v2` |
