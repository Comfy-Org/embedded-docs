...
| Campo   | Tipo de Dado | Descrição                                                                                     |
|---------|---------------|-----------------------------------------------------------------------------------------------|
| `image` | `IMAGE`       | A saída consiste em uma lista de lotes de imagens, reorganizados de acordo com o tamanho de lote especificado. Isso permite o processamento flexível e eficiente de dados de imagem em operações em lote. |