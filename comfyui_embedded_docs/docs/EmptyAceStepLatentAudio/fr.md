...
|-----------|-----------------|--------|-------|-------------|
| `secondes` | FLOAT | Oui | 1.0 - 1000.0 | La durée de l'audio en secondes (par défaut : 120.0) |
...
|---------------|-----------------|-------------|
| `output` | LATENT | Renvoie des échantillons audio latents vides avec des zéros. La sortie contient un tenseur `samples` et un champ `type` défini sur "audio". |
