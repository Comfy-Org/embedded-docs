...
from lib.node_source_extract import (
...
- Do NOT include the AI disclaimer blockquote (it is appended automatically at the bottom of the file)
- Do NOT include a level-one heading (# title) — the node display name is prepended automatically from frontend translations
- Start directly with the overview paragraph (1-3 sentences), then ## Inputs and ## Outputs
...
def main():
    ...
    all_nodes_info_file = ALL_NODES_INFO
    all_nodes_info = {}
