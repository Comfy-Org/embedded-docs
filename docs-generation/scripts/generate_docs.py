...
from lib.paths import MISSING_NODES_REPORT, embedded_docs_dir, load_dotenv
...
class DocumentGenerator:
    ...
    def _generate_inputs_table(self) -> str:
        ...
        for inp in self.info['inputs']:
            ...
            lines.append(f"| {param_name} | {description} | {data_type} | {input_type} | {default} | {range_str} |")
    ...
    def _generate_outputs_table(self) -> str:
        ...
        for idx, out in enumerate(self.info['outputs'], 1):
            ...
            lines.append(f"| {output_name} | {description} | {data_type} |")
